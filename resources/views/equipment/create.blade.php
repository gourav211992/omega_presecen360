                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="mb-1">
                                                    ...
                                                    <textarea type="text" name="final_remarks" rows="4" class="form-control"
    ...
    <script>
        ...
        function getMaintenanceRow() {
            ...
            let row = `<tr data-row-id="${rowId}">
                                ...
                                <td class="poprod-decpt">
                                    <input type="date" name="maintenance[${rowId}][date]" class="form-control mw-100 mb-25 date-field" />
                                </td>
                                <td class="poprod-decpt">
                                    <input type="time" name="maintenance[${rowId}][time]" placeholder="Enter Time" class="form-control mw-100 mb-25 time-field" />
                                </td>
                                 <td class="poprod-decpt">
