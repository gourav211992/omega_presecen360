...
@section('content')
    <!-- BEGIN: Content-->
    <form class="ajax-input-form" method="POST" action="{{ route('gov-relation-management.store') }}" data-redirect="{{ url('/gov-relation-management') }}">
        @csrf
                    ...
                    <div class="row">
                        <div class="content-header-left col-md-6 col-6 mb-2">
                            <div class="row breadcrumbs-top">
                                <div class="col-12">
                                    <h2 class="content-header-title float-start mb-0">Government Relation Management</h2>
                                    <div class="breadcrumb-wrapper">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="{{ route('gov-relation-management.index') }}">Home</a></li>
                                            <li class="breadcrumb-item active">Gov Relation Management</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
