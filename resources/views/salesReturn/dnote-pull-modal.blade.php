<div class="modal fade text-start" id="rescedulednote" tabindex="-1" aria-labelledby="header_pull_label" aria-hidden="true">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="mb-1">
                            ...
                            <input type="text" id="customer_code_input_qt_d" placeholder="Select"
                                class="form-control mw-100 ledgerselecct ui-autocomplete-input" autocomplete="off" value="">
                            <input type="hidden" id="customer_id_qt_d_val">
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="mb-1">
                            ...
                            <input type="text" id="book_code_input_qt_d" placeholder="Select"
                                class="form-control mw-100 ledgerselecct ui-autocomplete-input" autocomplete="off" value="">
                            <input type="hidden" id="book_id_qt_d_val">
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="mb-1">
                            ...
                            <input type="text" id="document_no_input_qt_d" placeholder="Select"
                                class="form-control mw-100 ledgerselecct ui-autocomplete-input" autocomplete="off" value="">
                            <input type="hidden" id="document_id_qt_d_val">
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="mb-1">
                            ...
                            <input type="text" id="item_name_input_qt_d" placeholder="Select"
                                class="form-control mw-100 ledgerselecct ui-autocomplete-input" autocomplete="off" value="">
                            <input type="hidden" id="item_id_qt_d_val">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="dataTables_scroll datatables-basic table-sm table-bordered table myrequesttablecbox po-order-detail" id="dnote_table">
                                <input type = "hidden" id = "dnote_table_value" value = "{{App\Helpers\ConstantHelper::DELIVERY_CHALLAN_SERVICE_ALIAS}}">
                                <thead>
                                    <tr>
                                        <th>
