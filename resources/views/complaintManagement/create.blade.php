...
@section('content')
    <!-- BEGIN: Content-->
    <form class="ajax-input-form" method="POST" action="{{ route('complaint.store') }}" data-redirect="{{ url('/complaint') }}">
        @csrf
...
{{--                                            <div class="col-md-3">--}}
{{--                                                <label class="form-label">Complaint ID. <span--}}
{{--                                                        class="text-danger">*</span></label>--}}
{{--                                            </div>--}}
{{--                                            <div class="col-md-5">--}}
{{--                                                <input type="text" class="form-control" id="complaint_id" name="complaint_id" value="{{ $next_complaint_id }}" readonly>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
                                        <div class="row align-items-center mb-1">
                                            <div class="col-md-3">
