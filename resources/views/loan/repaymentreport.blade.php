                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-1 mb-sm-0">
                                                ...
                                                <select class="form-select select2" id="f-customer">
                                                    <option value="">Select</option>
                                                    @foreach ($loans->unique('homeLoan') as $customer)
                                                        <option value="{{ $customer->homeLoan->id }}">{{ $customer->homeLoan->name }}
                                                        </option>
                                                    @endforeach
                                                 </select>
                                            </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="mb-1 mb-sm-0">
                                                ...
                                                <select class="form-select" id="f-status">
                                                    ...
                                                    @foreach ($loans->unique('approvalStatus') as $status)
                                                        <option value="{{ $status->approvalStatus }}">{{ $status->approvalStatus }}
                                                        </option>
                                                    @endforeach
                                ...
                                <div class="row sortable">
                                    <div class="col-md-4">
                                        <div class="form-check form-check-secondary">
                                            <input type="checkbox" class="form-check-input" id="application-no"
                                                checked="">
                                            <label class="form-check-label" for="application-no">Application No</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check form-check-secondary">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check form-check-secondary">
                                            <input type="checkbox" class="form-check-input" id="disbursement-amount"
                                                checked="">
                                            <label class="form-check-label" for="disbursement-amount">Disbursement Amount</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check form-check-secondary">
                                            <input type="checkbox" class="form-check-input" id="recovery-amount"
                                                checked="">
                                            <label class="form-check-label" for="recovery-amount">Recovery Amount</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check form-check-secondary">
                                            <input type="checkbox" class="form-check-input" id="total-interest-amount"
                                                checked="">
                                            <label class="form-check-label" for="total-interest-amount">Total Interest Amount</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check form-check-secondary">
                                            <input type="checkbox" class="form-check-input" id="balance-amount"
                                                checked="">
                                            <label class="form-check-label" for="balance-amount">Balance Amount</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/custom/pages/loan/loan-repaymentreport.js') }}"></script>
    ...
    <script>
        window.routes = {
            loanReport: @json(route('loanrepayment.report.filter')),
            addScheduler: @json(route('loanrepayment.add.scheduler')),
            reportSendMail: @json(route('loanrepayment.send.report')),
