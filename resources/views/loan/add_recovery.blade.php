                        ...
                        success: function(data) {
                            ...
                            if (data.customer_record.loan_settlement.length > 0) {
                                ...
                                totalSettled = data.customer_record.loan_settlement
                                    .reduce(
                                        function(sum, settle) {
                                            return sum + parseFloat(removeCommas(settle
                                                .settle_amnnt)
                                            ); // Convert to float and accumulate
                                        }, 0);
                            }
                            ...
                            $("#loan_amount").val((data.customer_record
                                .loan_appraisal
                                .term_loan));
                            $("#rec_intrst").val((totalIntrestReceived).toFixed(2));
                            $("#rec_intrst_in").val(totalIntrestReceived.toFixed(2));
                            ...
                            $.each(data.customer_record.loan_disbursements, function(ky, dis) {
                                ...
                                <td>  <input type="hidden" name="dis_id[]" value="${dis.id}" id="dis_id_${key+1}">
                                    <input type="hidden" id="pri_set_${key+1}" value="${(parseFloat(removeCommas(dis.settled_principal)) || 0).toFixed(2)}">
                                    <input type="hidden" id="int_set_${key+1}" value="${(parseFloat(removeCommas(dis.settled_interest)) || 0).toFixed(2)}">
                                    <input type="hidden" id="recover_set_${key+1}" value="${(parseFloat(removeCommas(dis.recovered)) || 0).toFixed(2)}">
                                    <input type="hidden" id="remain_set_${key+1}" value="${(parseFloat(removeCommas(dis.remainig)) || 0).toFixed(2)}">
                                ...
                                <td  id="rec_dis_amnt_${key+1}" class="fw-bolder text-dark text-end">${(parseFloat(removeCommas(dis.actual_dis ?? dis.dis_amount) ) || 0).toFixed(2)}</td>
                                <td  id="rec_rec_amnt_${key+1}" class="text-end">${(parseFloat(removeCommas(dis.recovered)) || 0).toFixed(2)}</td>
                                ...
                                <td  id="rec_rec_amnt2_${key+1}" class="text-end">${(parseFloat(removeCommas(dis.recovered)) || 0)}</td>
                                <td  id="rec_blnc_amnt2_${key+1}" class="text-end">${(parseFloat(removeCommas(value)))}</td>
            ...
            if (amount > 0) {
                ...
                rows.forEach(row => {
                    ...
                    if (recovery_remaining > 0) {
                        ...
                        balanceCell.textContent = parseFloat(removeCommas(principalCell.textContent)).toFixed(2) - parseFloat(
                            removeCommas(settledPrincipalCell.textContent)).toFixed(2) || 0;
