...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="content-header-right text-sm-end col-md-6 mb-2 mb-sm-0">
                        <div class="form-group breadcrumb-right">
                            ...
                            @php
                                $disabled = '';
                                if (isset($homeLoan) && $homeLoan->status >= 4) {
                                    $disabled = 'disabled';
                                }
                            @endphp
                            @if (isset($page) && $page == 'edit')
                                ...
                                @if ($buttons['delete'])
                                    <a type="button" class="btn btn-danger btn-sm mb-50 mb-sm-0 delete-btn"
                                        data-url="{{ route('loan.destroy', $homeLoan->id) }}"
                                ...
                                @if (!isset($view_detail))
                                    ...
                                    <button data-bs-toggle="modal" data-bs-target="#disclaimer" data-val="submitted"
                                        class="btn btn-primary btn-sm submission_val" form="home-loan-createUpdate"><i
                                            data-feather="check-circle"></i> Proceed</button>
                                @endif
                                @if (isset($homeLoan) && $homeLoan->status == 1)
                                    <button class="btn btn-danger btn-sm" data-bs-target="#reject" data-bs-toggle="modal"><i
                                            data-feather="x-circle"></i> Reject</button>
                                    <button data-bs-toggle="modal" data-bs-target="#approved"
                                        class="btn btn-success btn-sm"><i data-feather="check-circle"></i> Approve</button>
                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    <div class="card-body customernewsection-form">
                                        @if (isset($homeLoan) && !isset($editData))
                                            <div class="text-center new-applicayion-help-txt  mb-1 pb-25">
                                                ...
                                                <h6 class="mt-2">({{ $homeLoan->name ?? 'N/A' }} |
                                                    {{ $homeLoan->loan_amount ?? 'N/A' }} |
                                                    {{ $homeLoan->created_at ? $homeLoan->created_at->format('d-m-Y') : 'N/A' }})
                                                </h6>
                                                <h4 class="mt-1 fw-bolder text-dark">CIBIL Score =
                                                    {{ $homeLoan->ass_cibil ?? 'N/A' }}</h4>
                                            </div>
                                            {{-- <div class="row mt-1 mb-2 border-bottom pb-1">
                                                @if ($homeLoan && $logsGroupedByStatus && $logsGroupedByStatus->count() > 0)
                                                ...
                                                @php
                                                    ...
                                                    $mainBadgeClass = match ($homeLoan->approvalStatus) {
                                                    ...
                                                    $statusText = str_replace('_', ' ', $homeLoan->approvalStatus);
                                                @endphp
                                                            ...
                                                            <div class="step-custhomapp bg-light mb-0">
                                                                @php
                                                                    ...
                                                                    if ($homeLoan->approvalStatus == 'submitted') {
                                                                        ...
                                                                        $activeStatuses =
                                                                            $specialStatuses[$homeLoan->approvalStatus];
                                                                    } else {
                                                                        $currentStatusIndex =
                                        ...
                                        @else
                                            <div class="text-center new-applicayion-help-txt border-bottom mb-2 pb-25">
                                                ...
                                                <p class="text-dark">Please complete all sections and tick <i
                                                        data-feather='check-square'></i> options where applicable</p>
                                                <p class="text-dark"><strong>Note:-</strong> The field marked with <span
                                                        class="text-danger">*</span> is mandatory.<br />Wherever
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9 order-2 order-sm-1">
                                                <!-- <div class="row align-items-center mb-1">
                                                                                                            ...
                                                                                                            <div class="col-md-5">
                                                                                                                <select class="form-select book_typeSelect" name="book_type" id="book_type" onchange="fetchLoanSeries(this.value, 'series');">
                                                                                                                    <option value="">Select</option>
                                                                                                                    @if (isset($book_type))
    @foreach ($book_type as $key => $val)
    <option value="{{ $val->id }}" {{ isset($homeLoan) && $homeLoan->book_type_id == $val->id ? 'selected' : '' }}>{{ $val->name }}</option>
    @endforeach
    @endif
                                                                                                                </select>
                                                                                                            </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    <div class="col-md-3">
                                                        <label class="form-label mb-sm-1">Series <span
                                                                class="text-danger">*</span></label>
                                                    </div>

                                                    <input type="hidden" name="status_val" id="status_val" required>
                                                    <div class="col-md-5">
                                                        <select class="form-select" name="series" id="series"
                                                            @if (isset($page) && $page == 'edit') disabled @endif>
                                                            <option value="">Select</option>
                                                            @if (isset($book_type))
                                                                @foreach ($book_type as $key => $val)
                                                                    <option value="{{ $val->id }}"
                                                                        {{ isset($homeLoan) && $homeLoan->series == $val->id ? 'selected' : '' }}>
                                                        ...
                                                        @if (isset($page) && $page == 'edit')
                                                            <input type="hidden" name="series"
                                                                value="{{ isset($homeLoan) ? $homeLoan->series : '' }}">
                                                        @endif
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    <div class="col-md-3">
                                                        <label class="form-label mb-sm-1">Application No. <span
                                                                class="text-danger">*</span></label>
                                                    </div>

                                                    <div class="col-md-5">
                                                        <input type="text" name="appli_no"
                                                            value="{{ $homeLoan->appli_no ?? '' }}" id="appli_no"
                                                            class="form-control" readonly />
                                                        <span id="appli_no_error_message" class="text-danger"></span>
                                                        <span id="appli_span">
                                                            @error('appli_no')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    <div class="col-md-3">
                                                        <label class="form-label mb-sm-1">Reference No. <span
                                                                class="text-danger">*</span></label>
                                                    </div>

                                                    <div class="col-md-5">
                                                        <input type="number" name="ref_no"
                                                            value="{{ old('ref_no', $homeLoan->ref_no ?? '') }}"
                                                            id="ref_no" class="form-control" min="0" />
                                                        @error('ref_no')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="text" name="loan_amount"
                                                            ...
                                                            class="form-control number-format" min="0" />
                                                        @error('loan_amount')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="text" name="gir_no"
                                                            ...
                                                            class="form-control validate-pan-name" min="0" />
                                                            ...
                                                            <div class="row align-items-center mb-1 hid_g_field">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="text"
                                                                        ...
                                                                        class="form-control validate-pan-name" />
                                                                </div>
                                                        ...
                                                        <table
                                                            ...
                                                            <tbody id="table-body">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <input type="text" name="BankAcc[ac_no][]"
                                                                            class="form-control mw-100">
                                                                    </td>
                                                                    <td>
                                                                        <input type="number" min="0"
                                                                            name="BankAcc[ac_balance][]"
                                                                            class="form-control mw-100 number-format">
                                                                    </td>
                                                                    <td>
    ...
    <div class="modal fade text-start alertbackdropdisabled" id="deleteModal" tabindex="-1"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body alertmsg text-center danger">
                    <form action="{{ route('loan.delete') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="app_id" value="{{ @$homeLoan->id }}">
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-1">
                                            @if (isset($homeLoan->id))
                                                ...
                                                <input type="hidden" name="appr_rej_loan_id"
                                                    value="{{ $homeLoan->id }}">
                                            @endif
                                            <label class="form-label">Loan Amount <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" disabled value="{{ $homeLoan->loan_amount ?? '' }}"
                                                class="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-1">
                                            <label class="form-label">Recommended Loan Amt. <span
                                                    class="text-danger">*</span></label>
                                            @if (isset($homeLoan) && $homeLoan->status == 2)
                                                <input type="number" name="appr_rej_recommended_amnt"
                                                    value="{{ $homeLoan->appr_rej_recom_amnt ?? '' }}"
                                                    class="form-control" />
                                            @else
                                                <input type="number" name="appr_rej_recommended_amnt"
                                                    class="form-control" />
                                ...
                                <div class="mb-1">
                                    ...
                                    @if (isset($homeLoan) && $homeLoan->status == 2)
                                        <textarea class="form-control" name="appr_rej_remarks">{{ $homeLoan->appr_rej_recom_remark ?? '' }}</textarea>
                                    @else
                                    ...
                                    @if (isset($homeLoan) && $homeLoan->status == 2)
                                        @if (isset($homeLoan->id))
                                            <input type="hidden" name="stored_appr_rej_doc"
                                                value="{{ $homeLoan->appr_rej_doc ?? '' }}">
                                        @endif
                                        <label class="form-label">Upload Document</label>
                                        <input type="file" name="appr_rej_doc" class="form-control" />
                                        @if (isset($homeLoan) && !empty($homeLoan->appr_rej_doc))
                                            <div class="col-md-3 mt-1">
                                                <p><i data-feather='folder' class="me-50"></i><a
                                                        href="{{ asset('storage/' . $homeLoan->appr_rej_doc) }}"
                                ...
                                @php
                                    if (isset($homeLoan)) {
                                        $selectedValues = $homeLoan->appr_rej_behalf_of
                                            ? json_decode($homeLoan->appr_rej_behalf_of, true)
                                            : [];
                                    }
                                @endphp
                                <div class="mb-1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-1">
                                            <label class="form-label">Recommended Loan Amt. <span
                                                    class="text-danger">*</span></label>
                                            @if (isset($homeLoan) && $homeLoan->status == 3)
                                                <input type="number" name="appr_rej_recommended_amnt"
                                                    value="{{ $homeLoan->appr_rej_recom_amnt ?? '' }}"
                                                    class="form-control" />
                                            @else
    ...
    <script>
        ...
        function validateLength(inputSelector, errorSelector, maxLength) {
            ...
            // Check for uniqueness among all mobile number fields
            var mobileNumbers = [];
            var isDuplicate = false;

            // Loop through all mobile fields
            $('#mobile_no, #guar_phn_fax_oth, #co_phn_fax_guar').each(function() {
                var mobileValue = $(this).val().trim();
                if (mobileValue) {
                    if (mobileNumbers.includes(mobileValue)) {
                        isDuplicate = true;
                    }
                    mobileNumbers.push(mobileValue);
                }
            });

            // If duplicate is found, show an error message
            if (isDuplicate) {
                $(errorSelector).text('Mobile numbers must be unique.');
                return false;
            }
        ...
        $(document).ready(function() {
            ...
            var approvalStatus = @json(@$homeLoan->approvalStatus);
        ...
        $('#home-loan-createUpdate').on('submit', function(e) {
            var isValid = true;
// Validate PAN/GIR numbers
if ($('#gir_no').val() !== "" && !validatePanGir('#gir_no', '.gir_no_js')) {
    isValid = false;
    Swal.fire({
        title: 'Error!',
        text: 'Invalid PAN/GIR number for Gir No.',
        icon: 'error',
    });
}

if ($('#guar_pan_gir_no').val() !== "" && !validatePanGir('#guar_pan_gir_no', '.guar_pan_gir_no_js')) {
    isValid = false;
    Swal.fire({
        title: 'Error!',
        text: 'Invalid PAN/GIR number for Guarantor PAN/GIR No.',
        icon: 'error',
    });
}

if ($('#co_pan_gir_no').val() !== "" && !validatePanGir('#co_pan_gir_no', '.co_pan_gir_no_js')) {
    isValid = false;
    Swal.fire({
        title: 'Error!',
        text: 'Invalid PAN/GIR number for Co-applicant PAN/GIR No.',
        icon: 'error',
    });
}

// Validate Mobile Numbers (Length and Uniqueness)
if ($('#mobile_no').val() !== "" && !validateLength('#mobile_no', '.mobile_no_error', 10)) {
    isValid = false;
    Swal.fire({
        title: 'Error!',
...
if ($('#guar_phn_fax_oth').val() !== "" && !validateLength('#guar_phn_fax_oth', '.guar_phn_fax_oth_error', 10)) {
    isValid = false;
    Swal.fire({
        title: 'Error!',
        text: 'Guarantor phone/fax number must be 10 digits.',
        icon: 'error',
    });
}

if ($('#co_phn_fax_guar').val() !== "" && !validateLength('#co_phn_fax_guar', '.co_phn_fax_guar_error', 10)) {
    isValid = false;
    Swal.fire({
        title: 'Error!',
        text: 'Co-applicant phone/fax number must be 10 digits.',
        icon: 'error',
    });
}
