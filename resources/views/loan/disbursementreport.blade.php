                        ...
                        <div class="row">
                            <div class="col-md-12 bg-light border-bottom mb-1 po-reportfileterBox">
                                <div class="row pofilterhead action-button align-items-center">
                                    <div class="col-md-4">
                                        <h3>Loan DisburseMent Report</h3>
                        ...
                        <div class="tab-pane active" id="Employee">
                            <div class="compoenentboxreport">
                                ...
                                <div class="row sortable">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check form-check-secondary">
                                            <input type="checkbox" class="form-check-input" id="approved-amount"
                                                checked="">
                                            <label class="form-check-label" for="approved-amount">Approved Amount</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check form-check-secondary">
                                            <input type="checkbox" class="form-check-input" id="disbursed-amount"
                                                checked="">
                                            <label class="form-check-label" for="disbursed-amount">Disbursed Amount</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check form-check-secondary">
                                            <input type="checkbox" class="form-check-input" id="disbursed-date"
                                                checked="">
                                            <label class="form-check-label" for="disbursed-date">Disbursement Date</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check form-check-secondary">
                                            <input type="checkbox" class="form-check-input" id="pending-disbursement"
                                                checked="">
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/custom/pages/loan/loan-disreport.js') }}"></script>
    ...
    <script>
        window.routes = {
            loanReport: @json(route('loandisbursement.report.filter')),
            addScheduler: @json(route('loandisbursement.add.scheduler')),
            reportSendMail: @json(route('loandisbursement.send.report')),
