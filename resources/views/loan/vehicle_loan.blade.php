...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="content-header-right text-sm-end col-md-6 mb-2 mb-sm-0">
                        <div class="form-group breadcrumb-right">
                            ...
                            {{-- @endif --}}
                            {{-- @if (isset($vehicleLoan) && $vehicleLoan->status == 1)
                            ...
                            @if (!isset($view_detail))
                                <button class="btn btn-outline-primary btn-sm submission_val" data-val="draft"
                                    form="vehicle-loan-createUpdate"><i data-feather="save"></i> Save as Draft</button>

                                <button data-bs-toggle="modal" data-bs-target="#disclaimer" data-val="proceed"
                                    class="btn btn-primary btn-sm submission_val" form="vehicle-loan-createUpdate"><i
                            ...
                            {{-- @if ($page != 'edit' && isset($vehicleLoan) && $vehicleLoan->approvalStatus == 'rejected')
                                <a class="btn btn-primary btn-sm mb-50 mb-sm-0" href="{{ route('loan.edit_vehicle_detail', ['id'=>$vehicleLoan->id]) }}">Edit</a>
                            ...
                            @if (isset($page) && $page == 'edit')
                                @if ($buttons['save_draft'])
                                    <button class="btn btn-outline-primary btn-sm submission_val" data-val="draft"
                                        form="vehicle-loan-createUpdate"><i data-feather="save"></i> Save as
                                        Draft</button>
                                ...
                                {{-- @if ($buttons['approve'])
                                    ...
                                    <button data-bs-toggle="modal" data-bs-target="#approved"
                                        class="btn btn-success btn-sm"><i data-feather="check-circle"></i>
                                        Approve</button>
                                @endif --}}
                                {{-- @if ($vehicleLoan->approvalStatus == 'rejected')
                                    <button class="btn btn-danger btn-sm" data-bs-target="#reject" data-bs-toggle="modal"><i
                                            data-feather="x-circle"></i> Edit</button>
                                    <button class="btn btn-danger btn-sm mb-50 mb-sm-0" data-bs-toggle="modal" data-bs-target="#deleteModal"><i data-feather="trash-2"></i> Delete</button>
                                @endif --}}
                            @else
                                @if (!isset($view_detail))
                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    <div class="card-body customernewsection-form">
                                        @if (isset($vehicleLoan) && !isset($editData))
                                            <div class="text-center new-applicayion-help-txt  mb-1 pb-25">
                                                ...
                                                <h6 class="mt-2">({{ $vehicleLoan->name ?? 'N/A' }} |
                                                    {{ $vehicleLoan->loan_amount ?? 'N/A' }} |
                                                    {{ $vehicleLoan->created_at ? $vehicleLoan->created_at->format('d-m-Y') : 'N/A' }})
                                                </h6>
                                                <h4 class="mt-1 fw-bolder text-dark">CIBIL Score =
                                                    {{ $vehicleLoan->ass_cibil ?? 'N/A' }}</h4>
                                            </div>
                                            {{-- <div class="row mt-1 mb-2 border-bottom pb-1">
                                                @if ($vehicleLoan && $logsGroupedByStatus && $logsGroupedByStatus->count() > 0)
                                                ...
                                                @php
                                                    ...
                                                    $mainBadgeClass = match ($vehicleLoan->approvalStatus) {
                                                    ...
                                                    $badgeClass =
                                                        $statusClassMap[$mainBadgeClass] ?? 'badge-light-secondary';
                                                    $statusText = str_replace('_', ' ', $vehicleLoan->approvalStatus);
                                                @endphp

                                                <div class="col text-right d-flex justify-content-end">
                                                    <span
                                                        class="badge rounded-pill {{ $badgeClass }} badgeborder-radius mt-1">
                                                        {{ $statusText }}
                                                    </span>
                                                </div>
                                            </div> --}}
                                                            ...
                                                            @if ($vehicleLoan->approvalStatus != 'draft')
                                                                <div class="step-custhomapp bg-light mb-0">
                                                                    @php
                                                                        ...
                                                                        if (
                                                                            $vehicleLoan->approvalStatus == 'submitted'
                                                                        ) {
                                                                                                ...
                                                                                                <table
                                                                                                    ...
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td>1</td>
                                                                                                            <td>Date</td>
                                                                                                            <td>{{ $overview ? explode(' ', $overview->created_at)[0] : 'N/A' }}
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        <tr>
                                                                                                            <td>2</td>
    ...
    <option value="{{ $val->id }}" {{ isset($vehicleLoan) && $vehicleLoan->book_type_id == $val->id ? 'selected' : '' }}>{{ $val->name }}</option>
    @endforeach
    @endif
                                                                                                                                    </select>
                                                                                                                                </div>
                                                    ...
                                                    <div class="col-md-5">
                                                        <select class="form-select" name="series" id="series"
                                                            ...
                                                            @if (isset($book_type))
                                                                @foreach ($book_type as $key => $val)
                                                                    <option value="{{ $val->id }}"
                                                                        {{ isset($vehicleLoan) && $vehicleLoan->series == $val->id ? 'selected' : '' }}>
                                                        ...
                                                        @if (isset($page) && $page == 'edit')
                                                            <input type="hidden" name="series"
                                                                value="{{ isset($vehicleLoan) ? $vehicleLoan->series : '' }}">
                                                        @endif
                                                        @error('series')
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="text" name="appli_no"
                                                            value="{{ $vehicleLoan->appli_no ?? '' }}" id="appli_no"
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="number" name="ref_no"
                                                            value="{{ old('ref_no', $vehicleLoan->ref_no ?? '') }}"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body alertmsg text-center danger">
                    <form action="{{ route('loan.delete') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="app_id" value="{{ @$vehicleLoan->id }}">
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-md-12">
                                        ...
                                        <div class="mb-1">
                                            @if (isset($vehicleLoan->id))
                                                ...
                                                <input type="hidden" name="appr_rej_loan_id"
                                                    value="{{ $vehicleLoan->id }}">
                                            @endif
                                            <label class="form-label">Loan Amount <span
                                                    class="text-danger">*</span></label>
                                            <input type="number" disabled
                                                value="{{ $vehicleLoan->loan_amount ?? '' }}" class="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-1">
                                            <label class="form-label">Recommended Loan Amt. <span
                                                    class="text-danger">*</span></label>
                                            @if (isset($vehicleLoan) && $vehicleLoan->status == 2)
                                                <input type="number" name="appr_rej_recommended_amnt"
                                                    value="{{ $vehicleLoan->appr_rej_recom_amnt ?? '' }}"
                                                    class="form-control" />
                                            @else
                                                <input type="number" name="appr_rej_recommended_amnt"
                                                    class="form-control" />
                                ...
                                <div class="mb-1">
                                    ...
                                    @if (isset($vehicleLoan) && $vehicleLoan->status == 2)
                                        <textarea class="form-control" name="appr_rej_remarks">{{ $vehicleLoan->appr_rej_recom_remark ?? '' }}</textarea>
                                    @else
                                    ...
                                    @if (isset($vehicleLoan) && $vehicleLoan->status == 2)
                                        @if (isset($vehicleLoan->id))
                                            <input type="hidden" name="stored_appr_rej_doc"
                                                value="{{ $vehicleLoan->appr_rej_doc ?? '' }}">
                                        @endif
                                        <label class="form-label">Upload Document</label>
                                        <input type="file" name="appr_rej_doc" class="form-control" />
                                        @if (isset($vehicleLoan) && !empty($vehicleLoan->appr_rej_doc))
                                            <div class="col-md-3 mt-1">
                                                <p><i data-feather='folder' class="me-50"></i><a
                                                        href="{{ asset('storage/' . $vehicleLoan->appr_rej_doc) }}"
                                ...
                                @php
                                    if (isset($vehicleLoan)) {
                                        $selectedValues = $vehicleLoan->appr_rej_behalf_of
                                            ? json_decode($vehicleLoan->appr_rej_behalf_of, true)
                                            : [];
                                    }
                                @endphp
                                <div class="mb-1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-1">
                                            <label class="form-label">Recommended Loan Amt. <span
                                                    class="text-danger">*</span></label>
                                            @if (isset($vehicleLoan) && $vehicleLoan->status == 3)
                                                <input type="number" name="appr_rej_recommended_amnt"
                                                    value="{{ $vehicleLoan->appr_rej_recom_amnt ?? '' }}"
                                                    class="form-control" />
                                            @else
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var approvalStatus = @json(@$vehicleLoan->approvalStatus);
                ...
                fetch(actionUrl).then(response => {
                    return response.json().then(data => {
                        if (data.status == 200) {
                            ...
                            console.log(!data.data.doc.document_number, data.data.doc
                                .document_number)
