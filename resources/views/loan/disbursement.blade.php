            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-end col-md-7 mb-2 mb-sm-0">
                    <div class="form-group breadcrumb-right"> 
                            ...
                            <a class="btn btn-dark btn-sm mb-50 mb-sm-0" href="{{ route('loan.add-disbursement') }}"><i data-feather="file-text"></i> Add Disbursal</a>  
                    </div>
                </div>
            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="table-responsive">
                                        <table class="datatables-basic table myrequesttablecbox loanapplicationlist">
                                            <thead>
                                                <tr>
                                                  <th class="pe-0"> <div class="form-check form-check-inline">
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header">
					<div>
                        <h4 class="modal-title fw-bolder text-dark namefont-sizenewmodal" id="myModalLabel17">Approve Disbursal</h4>
						   ...
						   <div class="col-md-12">
                                    ...
                                    <div class="row">
									 ...
									 <div class="mb-1"> 
										...
										<input type="file" class="form-control" name="dis_appr_doc[]" id="fileInput" multiple onchange="handleFileInput(event)" />
	  ...
	  <div class="modal fade" id="reject" tabindex="-1" aria-labelledby="shareProjectTitle" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header">
					<div>
                        <h4 class="modal-title fw-bolder text-dark namefont-sizenewmodal" id="myModalLabel17">Reject Disbursal</h4>
					...
					<div class="row mt-1"> 
						   ...
						   <div class="col-md-12">
                                    ...
                                    <div class="row">
									 ...
									 <div class="mb-1"> 
										<label class="form-label">Upload Document</label>  
										<input type="file" class="form-control" name="dis_appr_doc[]" id="fileInput" multiple onchange="handleFileInputRej(event)" />
										<progress id="uploadProgress" value="0" max="100" style="display:none;"></progress>
										<div id="uploadStatus"></div>
		...
		if (dt_basic_table.length) {
			var dt_basic = dt_basic_table.DataTable({
                ...
                columns: [
					...
					{ data: 'disbursal_no', name: 'disbursal_no' },
