...
@section('content')
                    ...
                    <div class="col-md-12 col-12">
                        <div class="card  new-cardbox">
                            ...
                            <ul class="nav nav-tabs border-bottom" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-bs-toggle="tab" href="#under-processing">Under
                                        Processing
                                        &nbsp;<span>({{ $underProcessingCount }})</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#active">Active
                                        &nbsp;<span>({{ $activeCount }})</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#under-settlement">Under Settlement
                                        &nbsp;<span>({{ $underSettlementCount }})</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#closed">Closed
                                        &nbsp;<span>({{ $closeCount }})</span></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#rejected">Rejected
                                        &nbsp;<span>({{ $rejectedCount }})</span></a>
                                </li>
                            </ul>

                            <div class="tab-content">

                                <div class="tab-pane active" id="under-processing">
                                    <div class="table-responsive">
                                        <table class="datatables-basic-1 table myrequesttablecbox loanapplicationlist">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                ...
                                <div class="tab-pane" id="active">
                                    <div class="table-responsive">
                                        <table class="datatables-basic-2 table myrequesttablecbox loanapplicationlist">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Application No.</th>
                                ...
                                <div class="tab-pane" id="under-settlement">
                                    <div class="table-responsive">
                                        <table class="datatables-basic-3 table myrequesttablecbox loanapplicationlist">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Application No.</th>
                                ...
                                <div class="tab-pane" id="closed">
                                    <div class="table-responsive">
                                        <table class="datatables-basic-4 table myrequesttablecbox loanapplicationlist">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Application No.</th>
                                ...
                                <div class="tab-pane" id="rejected">
                                    <div class="table-responsive">
                                        <table class="datatables-basic-5 table myrequesttablecbox loanapplicationlist">
                                            <thead>
                                                <tr>
                                                    <th>#</th>
                                                    <th>Application No.</th>
    ...
    <script>
                ...
                success: function(data) {
                    if (data.assess) {
                        ...
                        if (data.assess.ass_doc) {
                            ...
                            var docUrl = "{{ asset('storage') }}" + '/' + data.assess
                                .ass_doc;
        ...
        $(window).on('load', function() {
            ...
            $(function() {
                var dt_basic_1 = $('.datatables-basic-1'),
                    dt_basic_2 = $('.datatables-basic-2'),
                    dt_basic_3 = $('.datatables-basic-3'),
                    dt_basic_4 = $('.datatables-basic-4');
                dt_basic_5 = $('.datatables-basic-5');

                // Function to initialize DataTables
                function initDataTable(dt_element, status) {
                    if (dt_element.length) {
                        dt_element.DataTable({
                            processing: true,
                            serverSide: true,
                            ajax: {
                                ...
                                data: function(d) {
                                    d.status =
                                    status; // Pass status parameter for different tables
                                    d.date = $("#fp-range").val(),
                ...
                function initData2(dt_element, status) {
                    if (dt_element.length) {
                        dt_element.DataTable({
                            processing: true,
                            serverSide: true,
                ...
                function initData(dt_element, status) {
                    if (dt_element.length) {
                        dt_element.DataTable({
                            processing: true,
                            serverSide: true,
                ...
                function initData1(dt_element, status) {
                    if (dt_element.length) {
                        dt_element.DataTable({
                            processing: true,
                            serverSide: true,
                ...
                // Initialize all DataTables with their respective statuses
                initDataTable(dt_basic_1, 'under processing');
                initData(dt_basic_2, 'active');
                initData1(dt_basic_3, 'under settlement');
                initData1(dt_basic_4, 'closed');
                initData2(dt_basic_5, 'rejected');

                // Filter record on button click
                $(".apply-filter").on("click", function() {
                    dt_basic_1.DataTable().draw();
                    dt_basic_2.DataTable().draw();
                    dt_basic_3.DataTable().draw();
                    dt_basic_4.DataTable().draw();
                    dt_basic_5.DataTable().draw();
                    $(".modal").modal("hide");
                });
