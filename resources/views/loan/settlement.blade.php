            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-end col-md-7 mb-2 mb-sm-0">
                    <div class="form-group breadcrumb-right"> 
							...
							<a class="btn btn-dark btn-sm mb-50 mb-sm-0" href="{{route('loan.add-settlement')}}"><i data-feather="file-text"></i> Add Settlement</a> 
                    </div>
                </div>
            </div>
	...
	<div class="modal fade" id="approved" tabindex="-1" aria-labelledby="shareProjectTitle" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<form action="{{ route('loan.settle_appr_rej') }}" method="POST" enctype="multipart/form-data">
                    @csrf
	...
	$(function () {
		...
		if (dt_basic_table.length) {
          ...
          columns: [
					...
					{ data: 'settle_document_no', name: 'settle_document_no' },
					{ data: 'created_at', name: 'created_at' },
          { data: 'name', name: 'name' },
          { data: 'mobile', name: 'mobile' },
          { data: 'type', name: 'type' },
					{ data: 'loan_amount', name: 'loan_amount' },
          { data: 'settle_amnnt', name: 'settle_amnnt' },
