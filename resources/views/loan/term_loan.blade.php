        ...
        <div class="content-wrapper container-xxl p-0">
                ...
                <div class="row">
                    <div class="content-header-left col-md-6 mb-2">
                        <div class="row breadcrumbs-top">
                            <div class="col-12">
                                @if (isset($editData))
                                    <h2 class="content-header-title float-start mb-0">Edit Applicant</h2>
                                @elseif(isset($termLoan))
                                    <h2 class="content-header-title float-start mb-0">View Applicant</h2>
                                @else
                                    <h2 class="content-header-title float-start mb-0">New Applicant</h2>
                                @endif
                    ...
                    <!-- <div class="content-header-right text-sm-end col-md-6 mb-2 mb-sm-0">
                          <div class="form-group breadcrumb-right">
                           ...
                           <button  class="btn btn-outline-primary btn-sm" data-val="draft" form="term-loan-createUpdate"><i data-feather="save"></i> Save as Draft</button>
                           <button data-bs-toggle="modal" data-bs-target="#disclaimer" class="btn btn-primary btn-sm"><i data-feather="check-circle"></i> Proceed</button>
                          </div>
                         </div> -->
                         <div class="content-header-right text-sm-end col-md-6 mb-2 mb-sm-0">
                            <div class="form-group breadcrumb-right">
                                ...
                                @php
                                    $disabled = '';
                                    if (isset($termLoan) && $termLoan->status >= 4) {
                                        $disabled = 'disabled';
                                    }
                                @endphp
                                @if (isset($page) && $page == 'edit')
                                    @if ($buttons['save_draft'])
                                        <button class="btn btn-outline-primary btn-sm submission_val" data-val="draft"
                                            form="term-loan-createUpdate"><i data-feather="save"></i>
                                            Save as
                                    </button>
                                    ...
                                    @if ($buttons['delete'])
                                    <a type="button" class="btn btn-danger btn-sm mb-50 mb-sm-0 delete-btn"
                                    data-url="{{ route('loan.destroy',$termLoan->id) }}"
                                    data-redirect="{{ route('loan.index') }}"
                                    data-message="Are you sure you want to delete this Loan Application?">
                                <i data-feather="trash-2" class="me-50"></i> Delete
                            </a>
                                    @endif
                                    @if ($buttons['submit'])
                                        <button data-bs-toggle="modal" data-bs-target="#disclaimer" data-val="submitted"
                                            class="btn btn-primary btn-sm submission_val" form="term-loan-createUpdate"><i
                                ...
                                @else
                                    @if (!isset($view_detail))
                                        <button class="btn btn-outline-primary btn-sm submission_val" data-val="draft"
                                            form="term-loan-createUpdate"><i data-feather="save"></i> Save as Draft</button>
                                        <button data-bs-toggle="modal" data-bs-target="#disclaimer" data-val="submitted"
                                            class="btn btn-primary btn-sm submission_val" form="term-loan-createUpdate"><i
                                                data-feather="check-circle"></i> Proceed</button>
                                    @endif
                                    @if (isset($termLoan) && $termLoan->status == 1)
                                        <button class="btn btn-danger btn-sm" data-bs-target="#reject" data-bs-toggle="modal"><i
                                                data-feather="x-circle"></i> Reject</button>
                                        <button data-bs-toggle="modal" data-bs-target="#approved"
                                            class="btn btn-success btn-sm"><i data-feather="check-circle"></i> Approve</button>
            ...
            <div class="content-body">
                ...
                <section id="basic-datatable">
                    <form id="term-loan-createUpdate" method="POST" action="{{ route('loan.term-loan-createUpdate') }}" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    <div class="card-body customernewsection-form">
                                        @if (isset($termLoan) && !isset($editData))
                                            <div class="text-center new-applicayion-help-txt  mb-1 pb-25">
                                                ...
                                                <h6 class="mt-2">({{ $termLoan->name ?? 'N/A' }} |
                                                    {{ $termLoan->loan_amount ?? 'N/A' }} |
                                                    {{ $termLoan->created_at ? $termLoan->created_at->format('d-m-Y') : 'N/A' }})
                                                </h6>
                                                <h4 class="mt-1 fw-bolder text-dark">CIBIL Score =
                                                    {{ $termLoan->ass_cibil ?? 'N/A' }}</h4>
                                            </div>
                                            {{-- <div class="row mt-1 mb-2 border-bottom pb-1">
                                                @if ($termLoan && $logsGroupedByStatus && $logsGroupedByStatus->count() > 0)
                                                    <div class="col text-left">
                                                        <h5 class="mt-1 text-dark">
                                                            <strong><i data-feather='arrow-right-circle'></i>
                                                                Application History
                                                            </strong>
                                                        </h5>
                                                    </div>
                                                ...
                                                @php
                                                    ...
                                                    $mainBadgeClass = match ($termLoan->approvalStatus) {
                                                    ...
                                                    $badgeClass = $statusClassMap[$mainBadgeClass] ?? 'badge-light-secondary';
                                                    $statusText = str_replace('_', ' ', $termLoan->approvalStatus);
                                                @endphp

                                                <div class="col text-right d-flex justify-content-end">
                                                    <span class="badge rounded-pill {{ $badgeClass }} badgeborder-radius mt-1">
                                                        {{ $statusText }}
                                                    </span>
                                                </div>
                                            </div> --}}
                                                    ...
                                                    @if ($termLoan->approvalStatus != 'draft')
                                                                <div class="step-custhomapp bg-light mb-0">
                                                                    @php
                                                                        ...
                                                                        if (
                                                                            $termLoan->approvalStatus == 'submitted'
                                                                        ) {
                                                                    ...
                                                                    <ul class="nav nav-tabs mb-0 mt-25 custapploannav customrapplicationstatus"
                                                                        ...
                                                                        @foreach ($statuses as $status => $index)
                                                                            <li class="nav-item">
                                                                                <p
                                                                                    class="{{ in_array($status, $activeStatuses) ? 'statusactive' : '' }}">
                                                                                        ...
                                                                                        @if (isset($overview))
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td>1</td>
                                                                                                    <td>Date</td>
                                                                                                    <td>{{ $overview ? date('d-m-Y', strtotime(explode(' ', $overview->created_at)[0])) : 'N/A' }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>2</td>
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td>Rs. {{ \App\Helpers\Helper::formatIndianNumber($overview->project_cost) }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>7</td>
                                                                                                    <td>Term Loan</td>
                                                                                                    <td>Rs. {{ \App\Helpers\Helper::formatIndianNumber($overview->term_loan) }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>8</td>
                                                                                                    ...
                                                                                                    <td> Rs. {{ \App\Helpers\Helper::formatIndianNumber($overview->promotor_contribution) }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>9</td>
                                                                                            ...
                                                                                            <tbody>
                                                                                                @foreach ($overview->disbursal as $key => $disbursal_list)
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td>{{ \App\Helpers\Helper::formatIndianNumber($overview->loan->loan_amount) }}
                                                                                                        </td>
                                                                                                        <td>{{ $disbursal_list->milestone }}
                                                                                                        </td>
                                                                                                        <td>{{ \App\Helpers\Helper::formatIndianNumber($disbursal_list->amount) }}
                                                                                                        </td>
...
<tr>
    ...
    <td>{{ \App\Helpers\Helper::formatIndianNumber($recovery_list->start_amount) }}
    </td>
    <td>{{ \App\Helpers\Helper::formatIndianNumber($recovery_list->interest_amount) }}
    </td>
    <td>{{ \App\Helpers\Helper::formatIndianNumber($recovery_list->repayment_amount) }}
    </td>
    <td>{{ \App\Helpers\Helper::formatIndianNumber($recovery_list->end_amount) }}
    </td>
</tr>
                                                                                                @endforeach
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td
                                                                                                        class="fw-bolder text-dark">
                                                                                                        {{ \App\Helpers\Helper::formatIndianNumber($total_int_amount) }}
                                                                                                    </td>
                                                                                                    <td
                                                                                                        class="fw-bolder text-dark">
                                                                                                        {{ \App\Helpers\Helper::formatIndianNumber($total_rep_amount) }}
                                                                                                    </td>
                                                                                                    <td>&nbsp;</td>
                                                                                                </tr>
                                                                                ...
                                                                                @if (isset($loan_disbursement))
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                ...
                                                                                                @php
                                                                                                $disMilestone = $loan_disbursement_list->dis_milestone;
                                                                                                @endphp

                                                                                                @if (is_string($disMilestone) && is_array(json_decode($disMilestone, true)) && json_last_error() === JSON_ERROR_NONE)
                                                                                                    @foreach (json_decode($disMilestone, true) as $loan_disbursement_dis_milestone)
                                                                                            ...
                                                                                            <td>{{ \App\Helpers\Helper::formatIndianNumber($loan_disbursement_list->dis_amount) }}
                                                                                            </td>
                                                                                            <td>{{ \App\Helpers\Helper::formatIndianNumber($loan_disbursement_list->customer_contri) }}
                                                                                            </td>
                                                                                            <td>{{ date('d-m-Y', strtotime(explode(' ', $loan_disbursement_list->created_at)[0]))  }}
                                                                                            </td>
                                                                                            <td>{{ \App\Helpers\Helper::formatIndianNumber($loan_disbursement_list->actual_dis) }}
                                                                                            </td>
                                                                                        </tr>
                                                                                        @endforeach
                                                                                        @endif
                                                                        ...
                                                                        <table
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>{{ date('d-m-Y', strtotime(explode(' ', $recovery_loan_list->created_at)[0]))  }}
                                                                                    </td>
                                                                                    <td>{{ \App\Helpers\Helper::formatIndianNumber($recovery_loan_list->homeLoan->loan_amount) }}
                                                                                    </td>
                                                                                    <td>{{ \App\Helpers\Helper::formatIndianNumber($recovery_loan_list->recovery_amnnt) }}
                                                                                    </td>
                                                                                    <td>{{ \App\Helpers\Helper::formatIndianNumber($recovery_loan_list->rec_principal_amnt) }}
                                                                                    </td>
                                                                                    <td>{{ \App\Helpers\Helper::formatIndianNumber($recovery_loan_list->rec_interest_amnt) }}
                                                                                    </td>
                                                                                    <td>{{ \App\Helpers\Helper::formatIndianNumber($recovery_loan_list->balance_amount) }}
                                                                                    </td>
                                                                                </tr>
                                                                                @endforeach
                                                                                @endif
...
@endif
                                            ...
                                            <hr />
                                        @else
                                            <div class="text-center new-applicayion-help-txt border-bottom mb-2 pb-25">
                                                <h4 class="purchase-head"><span>Application for Term Loan</span></h4>
                                                <h6 class="mt-2">(For Govt. Employees only)</h6>
                                                <p class="text-dark">Please complete all sections and tick <i data-feather='check-square'></i> options where applicable</p>
                                                <p class="text-dark"><strong>Note:-</strong> The field marked with <span class="text-danger">*</span> is mandatory.<br />Wherever
                                                    information is NOT available please keep it blank, in case of NOT
                                                    applicable ‘NA’ to be mentioned.</p>
                                            </div>
                                        @endif
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="row align-items-center mb-1">
                                                    <div class="col-md-3">
                                                        <label class="form-label mb-sm-1">Series <span class="text-danger">*</span></label>
                                                    </div>
                                                    <input type="hidden" name="status_val" id="status_val">
                                                    <div class="col-md-5">
                                                        <select class="form-select" name="series" id="series" @if (isset($page) && $page == 'edit') disabled @endif>
                                                            <option value="">Select</option>
                                                            @if (isset($book_type))
                                                                @foreach ($book_type as $key => $val)
                                                                    <option value="{{ $val->id }}" {{ isset($termLoan) && $termLoan->series==$val->id ? 'selected' : '' }}>
                                                                        {{ $val->book_name }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                                        @if (isset($page) && $page == 'edit')
                                                            <input type="hidden" name="series" value="{{ isset($termLoan) ? $termLoan->series : '' }}">
                                                        @endif
                                                        @error('series')
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    <div class="col-md-3">
                                                        <label class="form-label mb-sm-1">Application No. <span class="text-danger">*</span></label>
                                                    </div>

                                                    <div class="col-md-5">
                                                        <input type="text" name="appli_no" value="{{ $termLoan->appli_no ?? '' }}" id="appli_no" class="form-control" readonly />
                                                        @error('appli_no')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    <div class="col-md-3">
                                                        <label class="form-label mb-sm-1">Reference No. <span class="text-danger">*</span></label>
                                                    </div>

                                                    <div class="col-md-5">
                                                        <input type="number" name="ref_no" value="{{ old('ref_no', $termLoan->ref_no ?? '') }}" id="ref_no" class="form-control" />
                                                        @error('ref_no')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    <div class="col-md-3">
                                                        <label class="form-label">Name of the Concern <span class="text-danger">*</span></label>
                                                    </div>

                                                    <div class="col-md-3 pe-sm-0 mb-1 mb-sm-0">
                                                        <input type="text" name="f_name" value="{{ old('f_name', $f_name) }}" class="form-control" placeholder="First Name" />
                                                        @error('f_name')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-3 pe-sm-0 mb-1 mb-sm-0">
                                                        <input type="text" name="m_name" value="{{ old('m_name', $m_name) }}" class="form-control" placeholder="Middle Name" />
                                                    </div>
                                                    <div class="col-md-3">
                                                        <input type="text" name="l_name" value="{{ old('l_name', $l_name) }}" class="form-control" placeholder="Last Name" />
                                                        @error('l_name')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    <div class="col-md-3">
                                                        <label class="form-label">Name of the Promoter(s)<span class="text-danger">*</span></label>
                                                    </div>

                                                    <div class="col-md-3 pe-sm-0 mb-1 mb-sm-0">
                                                        <input type="text" name="f_name_pro" value="{{ old('f_name_pro', $f_name_pro) }}" class="form-control" placeholder="First Name" />
                                                        @error('f_name_pro')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                    <div class="col-md-3 pe-sm-0 mb-1 mb-sm-0">
                                                        <input type="text" name="m_name_pro" value="{{ old('m_name_pro', $m_name_pro) }}" class="form-control" placeholder="Middle Name" />
                                                    </div>
                                                    <div class="col-md-3">
                                                        <input type="text" name="l_name_pro" value="{{ old('l_name_pro', $l_name_pro) }}" class="form-control" placeholder="Last Name" />
                                                        @error('l_name_pro')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="input-group input-group-merge">
                                                            ...
                                                            <input type="email" name="tr_email" id="email_no" value="{{ old('tr_email', $termLoan->email ?? '') }}" class="form-control"
                                                                placeholder="">
                                                            @error('tr_email')
                                                                <span class="text-danger">{{ $message }}</span>
                                                            @enderror
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="text" name="loan_amount" value="{{ old('loan_amount', \App\Helpers\Helper::formatIndianNumber(@$termLoan->loan_amount) ?? '') }}" class="form-control number-format"/>
                                                        @error('loan_amount')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="text" name="scheme_for" value="{{ old('scheme_for', $termLoan->scheme_for ?? '') }}" class="form-control" />
                                                        @error('scheme_for')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="text" name="activity_line" value="{{ old('activity_line', $termLoan->activity_line ?? '') }}" class="form-control" />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="mt-3">
                                            <div class="step-custhomapp bg-light">
                                                <ul class="nav nav-tabs my-25 custapploannav" role="tablist">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-bs-toggle="tab" href="#Promoters">Promoters</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-bs-toggle="tab" href="#Constitution">Constitution</a>
                                                    </li>
                                                    <li class="nav-item">
                                            ...
                                            <div class="tab-content pb-1 px-1">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="text" name="Address[co_term]" value="{{ old('Address.co_term', $termLoan->termLoanAddress->co_term ?? '') }}"
                                                                        class="form-control" />
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="text" name="Address[street_road]"
                                                                        value="{{ old('Address.street_road', $termLoan->termLoanAddress->street_road ?? '') }}" class="form-control" />
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="text" name="Address[house_land_mark]"
                                                                        value="{{ old('Address.house_land_mark', $termLoan->termLoanAddress->house_land_mark ?? '') }}" class="form-control" />
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="text" name="Address[city_town_village]"
                                                                        value="{{ old('Address.city_town_village', $termLoan->termLoanAddress->city_town_village ?? '') }}" class="form-control" />
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="number" name="Address[pin_code]" value="{{ old('Address.pin_code', $termLoan->termLoanAddress->pin_code ?? '') }}"
                                                                        class="form-control" />
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="number" name="Address[registered_offc_tele]"
                                                                        value="{{ old('Address.registered_offc_tele', $termLoan->termLoanAddress->registered_offc_tele ?? '') }}" class="form-control registered-offc-tele" />
                                                                        <span class="text-danger registered-offc-tele-error"></span>
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="number" name="Address[registered_offc_mobile]"
                                                                        value="{{ old('Address.registered_offc_mobile', $termLoan->termLoanAddress->registered_offc_mobile ?? '') }}"
                                                                        class="form-control registered-offc-mobile" />
                                                                        <span class="text-danger registered-offc-mobile-error"></span>
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="text" name="Address[registered_offc_email_id]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="number" name="Address[registered_offc_fax_num]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="number" name="Address[factory_tele]"
                                                                        value="{{ old('Address.factory_tele', $termLoan->termLoanAddress->factory_tele ?? '') }}" class="form-control factory-tele" />
                                                                        <span class="text-danger factory-tele-error"></span>
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="number" name="Address[factory_mobile]"
                                                                        value="{{ old('Address.factory_mobile', $termLoan->termLoanAddress->factory_mobile ?? '') }}" class="form-control factory-number" />
                                                                        <span class="text-danger factory-number-error"></span>
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="text" name="Address[factory_email_id]"
                                                                        value="{{ old('Address.factory_email_id', $termLoan->termLoanAddress->factory_email_id ?? '') }}" class="form-control" />
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="number" name="Address[factory_fax_num]"
                                                                        value="{{ old('Address.factory_fax_num', $termLoan->termLoanAddress->factory_fax_num ?? '') }}" class="form-control" />
                                                        ...
                                                        <table class="table myrequesttablecbox table-striped po-order-detail custnewpo-detail border">
                                                            ...
                                                            <tbody id="table-body-term-loan">
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" name="TermPromotor[promoter_name][]" class="form-control mw-100"></td>
                                                                    <td><input type="text" name="TermPromotor[domicile][]" class="form-control mw-100"></td>
                                                                    <td><input type="file" name="TermPromotor[domicile_photo][]" class="form-control mw-100"></td>
                                                                    <td><a href="#" class="text-primary add-row-term-loan" id="add-row-term-loan" data-class="add-row-term-loan"><i
                                                                                data-feather="plus-square" class="me-50"></i></a></td>
                                                                </tr>
                                                                ...
                                                                @if (isset($termLoan) && $termLoan->termLoanPromoter && $termLoan->termLoanPromoter->count() > 0)
                                                                    @foreach ($termLoan->termLoanPromoter as $key => $val)
                                                                        <tr>
                                                                            <td>{{ $key + 2 }}</td>
                                                                            <td><input type="text" name="TermPromotor[promoter_name][]"
                                                                                    value="{{ old('TermPromotor.promoter_name' . $key, $val->promoter_name ?? '') }}" class="form-control mw-100"></td>
                                                                            <td><input type="text" name="TermPromotor[domicile][]"
                                                                                    value="{{ old('TermPromotor.domicile' . $key, $val->domicile ?? '') }}" class="form-control mw-100"></td>
                                                                            <td>
                                                                                @if ($key == 0)
                                                                                    <input type="hidden" name="TermPromotor[stored_domicile_photo][]" value="">
                                                                                @endif
                                                                                <input type="hidden" name="TermPromotor[stored_domicile_photo][]" value="{{ $val->domicile_photo ?? '' }}">
                                                                                <div class="d-flex align-items-center" style="gap:5px;">
                                                                                    <input type="file" name="TermPromotor[domicile_photo][]" class="form-control mw-100">
                                                                                    <span>
                                                                                        @if (isset($val->domicile_photo))
                                                                                            <a href="{{ asset('storage/' . $val->domicile_photo) }}" target="_blank"
                                                                            ...
                                                                            <td><a href="#" class="text-danger @if (isset($termLoan) && isset($editData)) delete-item @endif"><i data-feather="trash-2"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <select class="form-select" name="Constitution[common_data][cons_business_type]" id="cons_business_type">
                                                                        <option value="">Select</option>
                                                                        <option value="huf"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="date" name="Constitution[common_data][prc]"
                                                                        value="{{ old('Constitution.common_data.prc', $termLoan->constitutions->prc ?? '') }}" class="form-control past-date" />
                                                                </div>
                                                            </div>
                                                        ...
                                                        <table class="table myrequesttablecbox table-striped po-order-detail custnewpo-detail border">
                                                            ...
                                                            <tbody id="table-body-promoters">
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" name="Constitution[sister_concern][]" class="form-control mw-100"></td>
                                                                    <td><input type="text" name="Constitution[banker_name][]" class="form-control mw-100"></td>
                                                                    <td><input type="text" name="Constitution[nature_facility_address][]" class="form-control mw-100"></td>
                                                                    <td><input type="number" name="Constitution[outstanding][]" class="form-control mw-100"></td>
                                                                    <td><input type="number" name="Constitution[any_default][]" class="form-control mw-100"></td>
                                                                    <td><a href="#" class="text-primary add-row-promoters" id="add-row-promoters" data-class="add-row-promoters"><i
                                                                                data-feather="plus-square" class="me-50"></i></a></td>
                                                                </tr>
                                                                @if (isset($termLoan) && $termLoan->constitutions && $termLoan->constitutions->Promoters->count() > 0)
                                                                    @foreach ($termLoan->constitutions->Promoters as $key => $val)
                                                                        <tr>
                                                                            <td>{{ $key + 2 }}</td>
                                                                            <td><input type="text" name="Constitution[sister_concern][]"
                                                                                    value="{{ old('Constitution.sister_concern' . $key, $val->sister_concern ?? '') }}" class="form-control mw-100">
                                                                            </td>
                                                                            <td><input type="date" name="Constitution[banker_name][]"
                                                                                    value="{{ old('Constitution.banker_name' . $key, $val->banker_name ?? '') }}" class="form-control mw-100"></td>
                                                                            <td><input type="text" name="Constitution[nature_facility_address][]"
                                                                                    value="{{ old('Constitution.nature_facility_address' . $key, $val->nature_facility_address ?? '') }}"
                                                                                    class="form-control mw-100"></td>
                                                                            <td><input type="text" name="Constitution[outstanding][]"
                                                                                    value="{{ old('Constitution.outstanding' . $key, $val->outstanding ?? '') }}" class="form-control mw-100"></td>
                                                                            <td><input type="text" name="Constitution[any_default][]"
                                                                                    value="{{ old('Constitution.any_default' . $key, $val->any_default ?? '') }}" class="form-control mw-100"></td>
                                                                            <td><a href="#" class="text-danger @if (isset($termLoan) && isset($editData)) delete-item @endif"><i data-feather="trash-2"
                                                                                        style="cursor: @if (isset($termLoan) && isset($editData)) pointer @else not-allowed @endif;"></i></a>
                                                                            </td>
                                                                        </tr>
                                                    ...
                                                    <div class="row mt-1">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="date" name="Constitution[common_data][esclation]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" name="Constitution[common_data][sia_no]"
                                                                        value="{{ old('Constitution.common_data.sia_no', $termLoan->constitutions->sia_no ?? '') }}" class="form-control" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="date" name="Constitution[common_data][sia_date]"
                                                        ...
                                                        <table class="table myrequesttablecbox table-striped po-order-detail custnewpo-detail border">
                                                            ...
                                                            <tbody id="table-body-partner">
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" name="Constitution[par_name][]" class="form-control mw-100"></td>
                                                                    <td><input type="number" name="Constitution[par_age][]" class="form-control mw-100"></td>
                                                                    <td><input type="text" name="Constitution[par_position][]" class="form-control mw-100"></td>
                                                                    <td><input type="number" name="Constitution[par_shareholding][]" class="form-control mw-100"></td>
                                                                    <td><input type="number" name="Constitution[par_percentage][]" class="form-control mw-100"></td>
                                                                    <td><a href="#" class="text-primary add-row-partner" id="add-row-partner" data-class="add-row-partner"><i
                                                                                data-feather="plus-square" class="me-50"></i></a></td>
                                                                </tr>

                                                                @if (isset($termLoan) && $termLoan->constitutions && $termLoan->constitutions->Partner && $termLoan->constitutions->Partner->count() > 0)
                                                                    @foreach ($termLoan->constitutions->Partner as $key => $val)
                                                                        <tr>
                                                                            <td>{{ $key + 2 }}</td>
                                                                            <td><input type="text" name="Constitution[par_name][]"
                                                                                    value="{{ old('Constitution.par_name' . $key, $val->name ?? '') }}" class="form-control mw-100"></td>
                                                                            <td><input type="date" name="Constitution[par_age][]" value="{{ old('Constitution.par_age' . $key, $val->age ?? '') }}"
                                                                                    class="form-control mw-100"></td>
                                                                            <td><input type="text" name="Constitution[par_position][]"
                                                                                    value="{{ old('Constitution.par_position' . $key, $val->position ?? '') }}" class="form-control mw-100"></td>
                                                                            <td><input type="number" name="Constitution[par_shareholding][]"
                                                                                    value="{{ old('Constitution.par_shareholding' . $key, $val->shareholding ?? '') }}" class="form-control mw-100">
                                                                            </td>
                                                                            <td><input type="text" name="Constitution[par_percentage][]"
                                                                                    value="{{ old('Constitution.par_percentage' . $key, $val->percentage ?? '') }}" class="form-control mw-100"></td>
                                                                            <td><a href="#" class="text-danger @if (isset($termLoan) && isset($editData)) delete-item @endif"><i data-feather="trash-2"
                                                                                        style="cursor: @if (isset($termLoan) && isset($editData)) pointer @else not-allowed @endif;"></i></a>
                                                                            </td>
                                                                        </tr>
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" name="Constitution[common_data][director_name]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" name="Constitution[common_data][working_capital]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="date" name="Constitution[common_data][capital_facilities]"
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="Constitution[common_data][site_dev]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="Constitution[common_data][civil_works]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="Constitution[common_data][plant_install]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="Constitution[common_data][technical_fee]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="Constitution[common_data][fixed_asset]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="Constitution[common_data][pre_operative]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="Constitution[common_data][provision]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="Constitution[common_data][startup_expense]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="Constitution[common_data][margin_money]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="Constitution[common_data][cons_total]"
                                                                        value="{{ old('LoanIncIdividual.common_data.total', $termLoan->constitutions->total ?? '') }}" id="project_total"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="MeanFinance[promoters_cont]" id="promoters_contribution"
                                                                        value="{{ old('MeanFinance.promoters_cont', $termLoan->meanFinance->promoters_cont ?? '') }}" class="form-control" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" name="MeanFinance[equity_total]" id="promoters_total"
                                                                        value="{{ old('MeanFinance.equity_total', $termLoan->meanFinance->equity_total ?? '') }}" readonly class="form-control" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="MeanFinance[midc_ltd]" id="debt_midc"
                                                                        value="{{ old('MeanFinance.midc_ltd', $termLoan->meanFinance->midc_ltd ?? '') }}" class="form-control" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="MeanFinance[others]" id="debt_other"
                                                                        value="{{ old('MeanFinance.others', $termLoan->meanFinance->others ?? '') }}" class="form-control" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="MeanFinance[debt_total]" id="debt_total"
                                                                        value="{{ old('MeanFinance.debt_total', $termLoan->meanFinance->debt_total ?? '') }}" readonly class="form-control" />
                                                                </div>
                                                            </div>

                                                            <div class="row align-items-center mb-1">
                                                                <div class="col-md-2">
                                                                    <label class="form-label" style="font-weight: 700 !important; color: #000">GRAND
                                                                        TOTAL (A+B)</label>
                                                                </div>

                                                                <div class="col-md-3">
                                                                    <input type="number" name="MeanFinance[grand_total]" id="both_grand"
                                                                        value="{{ old('MeanFinance.grand_total', $termLoan->meanFinance->grand_total ?? '') }}" readonly class="form-control" />
                                                                </div>
                                                            </div>
                                                        ...
                                                        <table class="table myrequesttablecbox table-striped po-order-detail custnewpo-detail border">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td>2</td>
                                                                    <td>Building</td>
                                                                    <td><input type="number" name="MeanFinance[primary_building]"
                                                                            value="{{ old('MeanFinance.primary_building', $termLoan->meanFinance->primary_building ?? '') }}"
                                                                            class="form-control mw-100 primary_focus"></td>
                                                                    <td><input type="number" name="MeanFinance[collateral_building]"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><input type="number" name="MeanFinance[primary_machinery]"
                                                                            value="{{ old('MeanFinance.primary_machinery', $termLoan->meanFinance->primary_machinery ?? '') }}"
                                                                            class="form-control mw-100 primary_focus"></td>
                                                                    <td><input type="number" name="MeanFinance[collateral_machinery]"
                                                                ...
                                                                <tr>
                                                                    <td>4</td>
                                                                    <td>Others</td>
                                                                    <td><input type="number" name="MeanFinance[primary_other]"
                                                                            value="{{ old('MeanFinance.primary_other', $termLoan->meanFinance->primary_other ?? '') }}"
                                                                            class="form-control mw-100 primary_focus"></td>
                                                                    <td><input type="number" name="MeanFinance[collateral_other]"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><strong id="primary_focus_total">{{ !empty($primary_total) ? $primary_total : 0 }}</strong>
                                                                    </td>
                                                                    <td><strong id="collateral_focus_total">{{ !empty($collateral_total) ? $collateral_total : 0 }}</strong>
                                                                    </td>
                                                                </tr>
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" name="MeanFinance[guarantee_detail]"
                                                                        value="{{ old('MeanFinance.guarantee_detail', $termLoan->meanFinance->guarantee_detail ?? '') }}" class="form-control" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" name="MeanFinance[period_state]"
                                                                        value="{{ old('MeanFinance.period_state', $termLoan->meanFinance->period_state ?? '') }}" class="form-control" />
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="tab-pane" id="worth">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" name="TermNetWorth[common_data][nw_name]"
                                                                        value="{{ old('TermNetWorth.common_data.nw_name', $termLoan->termLoanNetWorth->name ?? '') }}" class="form-control" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" name="TermNetWorth[common_data][nw_father_name]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="date" name="TermNetWorth[common_data][nw_dob]"
                                                                        value="{{ old('TermNetWorth.common_data.nw_dob', $termLoan->termLoanNetWorth->dob ?? '') }}" class="form-control past-date" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="number" name="TermNetWorth[common_data][nw_unit_phone]" id="presentUnitPhone"
                                                                        value="{{ old('TermNetWorth.common_data.nw_unit_phone', $termLoan->termLoanNetWorth->unit_phone ?? '') }}" class="form-control">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="number" id="permanentUnitPhone" value="{{ $termLoan->termLoanNetWorth->unit_phone ?? '' }}"
                                                                        class="form-control">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="number" name="TermNetWorth[common_data][nw_resi_mobile]" id="presentResiMobile"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="number" name="TermNetWorth[common_data][nw_resi_phone]" id="presentResiPhone"
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="mb-2 d-flex flex-column">
                                                                ...
                                                                <div class="form-check form-check-primary mt-25 custom-checkbox">
                                                                    <input type="checkbox" class="form-check-input" id="res" checked="">
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="number" id="permanentResiMobile" value="{{ $termLoan->termLoanNetWorth->resi_mobile ?? '' }}"
                                                                        class="form-control">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="number" id="permanentResiPhone" value="{{ $termLoan->termLoanNetWorth->resi_phone ?? '' }}"
                                                                        class="form-control">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row align-items-center mb-1">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" name="TermNetWorth[common_data][nw_qualification]"
                                                                value="{{ old('TermNetWorth.common_data.nw_qualification', $termLoan->termLoanNetWorth->qualification ?? '') }}" class="form-control">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <table class="table myrequesttablecbox table-striped po-order-detail custnewpo-detail border">
                                                            ...
                                                            <tbody id="table-body-term-experience">
                                                                <tr>
                                                                    ...
                                                                    <td><input type="number" name="TermNetWorth[nw_no_of_years][]" class="form-control mw-100"></td>
                                                                    <td><input type="text" name="TermNetWorth[nw_employer][]" class="form-control mw-100"></td>
                                                                    <td><input type="text" name="TermNetWorth[nw_designation][]" class="form-control mw-100"></td>
                                                                    <td><input type="number" name="TermNetWorth[nw_last_salary_drawn][]" class="form-control mw-100"></td>
                                                                    <td><input type="file" name="TermNetWorth[nw_doc][]" class="form-control mw-100"></td>
                                                                    <td><a href="#" class="text-primary add-row-term-experience" id="add-row-term-experience"
                                                                            data-class="add-row-term-experience"><i data-feather="plus-square" class="me-50"></i></a></td>
                                                                </tr>

                                                                @if (isset($termLoan) && $termLoan->termLoanNetWorth && $termLoan->termLoanNetWorth->termLoanNetWorthExperience && $termLoan->termLoanNetWorth->termLoanNetWorthExperience->count() > 0)
                                                                    @foreach ($termLoan->termLoanNetWorth->termLoanNetWorthExperience as $key => $val)
                                                                        <tr>
                                                                            <td>{{ $key + 2 }}</td>
                                                                            <td><input type="text" name="TermNetWorth[nw_no_of_years][]" value="{{ $val->no_of_years ?? '' }}"
                                                                                    class="form-control mw-100"></td>
                                                                            <td><input type="text" name="TermNetWorth[nw_employer][]" value="{{ $val->employer ?? '' }}"
                                                                                    class="form-control mw-100"></td>
                                                                            <td><input type="text" name="TermNetWorth[nw_designation][]" value="{{ $val->designation ?? '' }}"
                                                                                    class="form-control mw-100"></td>
                                                                            <td><input type="number" name="TermNetWorth[nw_last_salary_drawn][]" value="{{ $val->last_salary_drawn ?? '' }}"
                                                                                    class="form-control mw-100"></td>
                                                                            <td>
                                                                                @if ($key == 0)
                                                                                    <input type="hidden" name="TermNetWorth[stored_nw_doc][]" value="">
                                                                                @endif
                                                                                <input type="hidden" name="TermNetWorth[stored_nw_doc][]" value="{{ $val->doc ?? '' }}">
                                                                                <div class="d-flex align-items-center" style="gap:5px;">
                                                                                    <input type="file" name="TermNetWorth[nw_doc][]" class="form-control mw-100">
                                                                                    <span>
                                                                                        @if (isset($val->doc))
                                                                                            <a href="{{ asset('storage/' . $val->doc) }}" target="_blank"
                                                    ...
                                                    <div class="row mt-2">
                                                        <div class="col-md-12">
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" name="TermNetWorth[common_data][nw_present_profession]"
                                                            ...
                                                            <hr />
                                                            @php
                                                                $selectedPassportHolder = old('TermNetWorth.common_data.nw_passport_holder', $termLoan->termLoanNetWorth->passport_holder ?? '0');
                                                                $selectedClubMember = old('TermNetWorth.common_data.nw_club_member', $termLoan->termLoanNetWorth->club_member ?? '0');
                                                            @endphp
                                                            <div class="row align-items-center mb-1">
                                                                <div class="col-md-12">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="demo-inline-spacing">
                                                                        <div class="form-check form-check-primary mt-25">
                                                                            <input type="radio" id="Guarantor" name="TermNetWorth[common_data][nw_passport_holder]" value="1"
                                                                                class="form-check-input" {{ $selectedPassportHolder == '1' ? 'checked' : '' }}>
                                                                            <label class="form-check-label fw-bolder" for="Guarantor">Yes</label>
                                                                        </div>
                                                                        <div class="form-check form-check-primary mt-25">
                                                                            <input type="radio" id="applicant" name="TermNetWorth[common_data][nw_passport_holder]" value="0"
                                                                                class="form-check-input" {{ $selectedPassportHolder == '0' ? 'checked' : '' }}>
                                                            ...
                                                            <div class="row align-items-center mb-1 pass_holder">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" name="TermNetWorth[common_data][nw_permanent_acc]"
                                                            ...
                                                            <div class="row align-items-center mb-1 pass_holder">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" name="TermNetWorth[common_data][nw_income_declare]"
                                                            ...
                                                            <div class="row align-items-center mb-1 pass_holder">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="date" name="TermNetWorth[common_data][nw_opening_bank_date]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="demo-inline-spacing">
                                                                        <div class="form-check form-check-primary mt-25">
                                                                            <input type="radio" id="Guarantor" name="TermNetWorth[common_data][nw_club_member]" value="1"
                                                                                class="form-check-input" {{ $selectedClubMember == '1' ? 'checked' : '' }}>
                                                                            <label class="form-check-label fw-bolder" for="Guarantor">Yes</label>
                                                                        </div>
                                                                        <div class="form-check form-check-primary mt-25">
                                                                            <input type="radio" id="applicant" name="TermNetWorth[common_data][nw_club_member]" value="0"
                                                                                class="form-check-input" {{ $selectedClubMember == '0' ? 'checked' : '' }}>
                                                                            <label class="form-check-label fw-bolder" for="applicant">No</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row align-items-center mb-1 club_mem">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" name="TermNetWorth[common_data][nw_club_name]"
                                                                        value="{{ old('TermNetWorth.common_data.nw_club_name', $termLoan->termLoanNetWorth->club_name ?? '') }}" class="form-control">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row align-items-center mb-1 club_mem">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" name="TermNetWorth[common_data][nw_paid_membership_fee]"
                                                        ...
                                                        <table class="table myrequesttablecbox table-striped po-order-detail custnewpo-detail border">
                                                            ...
                                                            <tbody id="table-body-term-property">
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" name="TermNetWorth[nw_property_desc][]" class="form-control mw-100"></td>
                                                                    <td><input type="number" name="TermNetWorth[nw_property_value][]" class="form-control mw-100 class_property_value">
                                                                    </td>
                                                                    <td>
                                                                        <select class="form-select" name="TermNetWorth[nw_acquired][]">
                                                                            <option value="">Select</option>
                                                                    ...
                                                                    <td><a href="#" class="text-primary add-row-term-property" id="add-row-term-property"
                                                                            data-class="add-row-term-property"><i data-feather="plus-square" class="me-50"></i></a></td>
                                                                </tr>

                                                                @if (isset($termLoan) && $termLoan->termLoanNetWorth && $termLoan->termLoanNetWorth->termLoanNetWorthProperty && $termLoan->termLoanNetWorth->termLoanNetWorthProperty->count() > 0)
                                                                    @foreach ($termLoan->termLoanNetWorth->termLoanNetWorthProperty as $key => $val)
                                                                        <tr>
                                                                            <td>{{ $key + 2 }}</td>
                                                                            <td><input type="text" name="TermNetWorth[nw_property_desc][]" value="{{ $val->property_desc ?? '' }}"
                                                                                    class="form-control mw-100"></td>
                                                                            <td><input type="number" name="TermNetWorth[nw_property_value][]" value="{{ $val->property_value ?? '' }}"
                                                                                    class="form-control mw-100 class_property_value">
                                                                            </td>
                                                                            <td>
                                                                                <select class="form-select" name="TermNetWorth[nw_acquired][]">
                                                                                    <option value="">Select</option>
                                                                                    <option value="self" {{ (isset($val->acquired) ? $val->acquired : '') == 'self' ? 'selected' : '' }}>
                                                                                        Self</option>
                                                                                    <option value="ancestral" {{ (isset($val->acquired) ? $val->acquired : '') == 'ancestral' ? 'selected' : '' }}>
                                                                                        Ancestral</option>
                                                                                    <option value="gifted" {{ (isset($val->acquired) ? $val->acquired : '') == 'gifted' ? 'selected' : '' }}>
                                                                                        Gifted</option>
                                                                                </select>
                                                                            </td>
                                                                            <td><a href="#" class="text-danger @if (isset($termLoan) && isset($editData)) delete-item @endif"><i data-feather="trash-2"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="TermNetWorth[common_data][nw_cash_on_hold]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="TermNetWorth[common_data][nw_bank_cash]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="TermNetWorth[common_data][nw_bank_investment]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="TermNetWorth[common_data][nw_bank_deposit]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                <div class="col-md-2">
                                                                    <label class="form-label">Shares/Debentures/Others</label>
                                                                </div>

                                                                <div class="col-md-3">
                                                                    <input type="number" name="TermNetWorth[common_data][nw_bank_shares]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="TermNetWorth[common_data][nw_jewelery]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="TermNetWorth[common_data][nw_moveable_asset]"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="number" name="TermNetWorth[common_data][nw_moveable_sub_total]" id="moveable_total"
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                <div class="col-md-2">
                                                                    <label class="form-label" style="font-weight: 700 !important; color: #000">TOTAL
                                                                        Assets (A+B)</label>
                                                                </div>

                                                                <div class="col-md-3">
                                                                    <input type="number" id="total_asset_AB" name="TermNetWorth[common_data][nw_moveable_total]"
                                                                        value="{{ old('TermNetWorth.common_data.nw_moveable_total', $termLoan->termLoanNetWorth->moveable_total ?? '') }}" readonly
                                                                        class="form-control" placeholder="Total Value of Assets" />
                                                                </div>
                                                            </div>
                                                        ...
                                                        <table class="table myrequesttablecbox table-striped po-order-detail custnewpo-detail border">
                                                            ...
                                                            <tbody id="table-body-term-lia">
                                                                <tr>
                                                                    ...
                                                                    <td><input type="text" name="TermNetWorth[nw_net_worth_desc][]" class="form-control mw-100"></td>
                                                                    <td><input type="number" name="TermNetWorth[nw_net_worth_value][]" class="form-control mw-100 nw_nt_wrth"></td>
                                                                    <td><a href="#" class="text-primary add-row-term-lia" id="add-row-term-lia" data-class="add-row-term-lia"><i
                                                                                data-feather="plus-square" class="me-50"></i></a></td>
                                                                </tr>
                                                                @if (isset($termLoan) && $termLoan->termLoanNetWorth && $termLoan->termLoanNetWorth->termLoanNetWorthLiability && $termLoan->termLoanNetWorth->termLoanNetWorthLiability->count() > 0)
                                                                    @foreach ($termLoan->termLoanNetWorth->termLoanNetWorthLiability as $key => $val)
                                                                        <tr>
                                                                            <td>{{ $key + 2 }}</td>
                                                                            <td><input type="text" name="TermNetWorth[nw_net_worth_desc][]" value="{{ $val->net_worth_desc ?? '' }}"
                                                                                    class="form-control mw-100"></td>
                                                                            <td><input type="text" name="TermNetWorth[nw_net_worth_value][]" value="{{ $val->net_worth_value ?? '' }}"
                                                                                    class="form-control mw-100"></td>
                                                                            <td><a href="#" class="text-danger @if (isset($termLoan) && isset($editData)) delete-item @endif"><i data-feather="trash-2"
                                                                                        style="cursor: @if (isset($termLoan) && isset($editData)) pointer @else not-allowed @endif;"></i></a>
                                                                            </td>
                                                    ...
                                                    <div class="row mt-2 align-items-center mb-1">
                                                        <div class="col-md-2">
                                                            <label class="form-label" style="font-weight: 700 !important; color: #000">Total Net
                                                                Worth<br />(Assets-Liabilities)</label>
                                                        </div>

                                                        <div class="col-md-3">
                                                            <input type="number" name="TermNetWorth[common_data][nw_total_net_worth]"
                                                                value="{{ old('TermNetWorth.common_data.nw_total_net_worth', $termLoan->termLoanNetWorth->total_net_worth ?? '') }}" readonly
                                                                class="form-control" id="nw_total_net_worth" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="bg-light p-1 rounded">
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-3">
                                                                <input type="hidden" name="TermNetWorth[common_data][stored_asset_proof2]"
                                                                    value="{{ old('TermNetWorth.common_data.stored_asset_proof2', $termLoan->termLoanNetWorth->asset_proof ?? '') }}"
                                                                    class="form-control" />
                                                                <input type="file" name="TermNetWorth[common_data][asset_proof]" value="{{ old('TermNetWorth.common_data.asset_proof') }}"
                                                                    class="form-control" />
                                                            </div>
                                                            @if (isset($termLoan) && $termLoan->termLoanNetWorth && $termLoan->termLoanNetWorth->asset_proof)
                                                                <div class="col-md-3 mt-1">
                                                                    <p><i data-feather='folder' class="me-50"></i><a href="{{ asset('storage/' . $termLoan->termLoanNetWorth->asset_proof) }}"
                                                                            style="color:green; font-size:12px;" target="_blank" download>Asset Proof</a></p>
                                                                </div>
                                                            @endif
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-5">
                                                                    <input type="hidden" name="TermLoanDocument[common_data][stored_adhar_card]"
                                                                        value="{{ old('TermLoanDocument.common_data.stored_adhar_card', $termLoan->termLoanDocument->adhar_card ?? '') }}"
                                                                        class="form-control" />
                                                                    <input type="file" name="TermLoanDocument[common_data][adhar_card][]"
                                                                        value="{{ old('TermLoanDocument.common_data.adhar_card') }}" class="form-control" onchange="checkFileTypeandSize(event)"
                                                                        multiple />
                                                                </div>

                                                                @if (isset($termLoan) && $termLoan->termLoanDocument && $termLoan->termLoanDocument->adhar_card)
                                                                    @php
                                                                        $adhar_doc_json = $termLoan->termLoanDocument->adhar_card;
                                                                        $adhar_docs = json_decode($adhar_doc_json, true);
                                                                    @endphp
                                                                    @if (!empty($adhar_docs) && is_array($adhar_docs))
                                                                        @foreach ($adhar_docs as $key => $doc)
                                                                            <div class="col-md-3 mt-1">
                                                                                <p><i data-feather='folder' class="me-50"></i><a href="{{ asset('storage/' . $doc) }}"
                                                                                        style="color:green; font-size:12px;" target="_blank" download>Aadhar
                                                                                        Doc</a></p>
                                                                            </div>
                                                                        @endforeach
                                                                    @endif
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-5">
                                                                    <input type="hidden" name="TermLoanDocument[common_data][stored_gir_no]"
                                                                        value="{{ old('TermLoanDocument.common_data.stored_gir_no', $termLoan->termLoanDocument->gir_no ?? '') }}"
                                                                        class="form-control" />
                                                                    <input type="file" name="TermLoanDocument[common_data][gir_no][]" value="{{ old('TermLoanDocument.common_data.gir_no') }}"
                                                                        class="form-control" onchange="checkFileTypeandSize(event)" multiple />
                                                                </div>
                                                                @if (isset($termLoan) && $termLoan->termLoanDocument && $termLoan->termLoanDocument->gir_no)

                                                                    @php
                                                                        $term_doc_json = $termLoan->termLoanDocument->gir_no;
                                                                    ...
                                                                    @if (!empty($term_docs) && is_array($term_docs))
                                                                        @foreach ($term_docs as $key => $doc)
                                                                            <div class="col-md-3 mt-1">
                                                                                <p><i data-feather='folder' class="me-50"></i><a href="{{ asset('storage/' . $doc) }}"
                                                                                        style="color:green; font-size:12px;" target="_blank" download>GIR
                                                                                        Doc</a></p>
                                                                            </div>
                                                                        @endforeach
                                                                    @endif
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-5">
                                                                    <input type="hidden" name="TermLoanDocument[common_data][stored_asset_proof]"
                                                                        value="{{ $termLoan->termLoanDocument->asset_proof ?? '' }}" class="form-control" />
                                                                    <input type="file" name="TermLoanDocument[common_data][asset_proof][]"
                                                                        value="{{ old('TermLoanDocument.common_data.asset_proof') }}" class="form-control" onchange="checkFileTypeandSize(event)"
                                                                        multiple />
                                                                </div>
                                                                @if (isset($termLoan) && $termLoan->termLoanDocument && $termLoan->termLoanDocument->asset_proof)

                                                                    @php
                                                                        $asset_doc_json = $termLoan->termLoanDocument->asset_proof;
                                                                        $asset_docs = json_decode($asset_doc_json, true);
                                                                    @endphp
                                                                    @if (!empty($asset_docs) && is_array($asset_docs))
                                                                        @foreach ($asset_docs as $key => $doc)
                                                                            <div class="col-md-3 mt-1">
                                                                                <p><i data-feather='folder' class="me-50"></i><a href="{{ asset('storage/' . $doc) }}"
                                                                                        style="color:green; font-size:12px;" target="_blank" download>Asset
                                                                                        Proof</a></p>
                                                                            </div>
                                                                        @endforeach
                                                                    @endif
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-5">
                                                                    <input type="hidden" name="TermLoanDocument[common_data][stored_application]"
                                                                        value="{{ old('TermLoanDocument.common_data.stored_application', $termLoan->termLoanDocument->application ?? '') }}"
                                                                        class="form-control" />
                                                                    <input type="file" name="TermLoanDocument[common_data][application][]"
                                                                        value="{{ old('TermLoanDocument.common_data.application') }}" class="form-control" onchange="checkFileTypeandSize(event)"
                                                                        multiple />
                                                                </div>
                                                                @if (isset($termLoan) && $termLoan->termLoanDocument && $termLoan->termLoanDocument->application)

                                                                    @php
                                                                        $application_doc_json = $termLoan->termLoanDocument->application;
                                                                        $application_docs = json_decode($application_doc_json, true);
                                                                    @endphp
                                                                    @if (!empty($application_docs) && is_array($application_docs))
                                                                        @foreach ($application_docs as $key => $doc)
                                                                            <div class="col-md-3 mt-1">
                                                                                <p><i data-feather='folder' class="me-50"></i><a href="{{ asset('storage/' . $doc) }}"
                                                                                        style="color:green; font-size:12px;" target="_blank" download>Application</a></p>
                                                                            </div>
                                                                        @endforeach
                                                                    @endif
                                                                @endif
                                                ...
                                                <input type="hidden" id="doc_number_type" name="doc_number_type">
                                                <input type="hidden" id="doc_reset_pattern" name="doc_reset_pattern">
                                                <input type="hidden" id="doc_prefix" name="doc_prefix">
                                                <input type="hidden" id="doc_suffix" name="doc_suffix">
    ...
    <div class="modal fade text-start alertbackdropdisabled" id="deleteModal" tabindex="-1" aria-labelledby="myModalLabel1" aria-hidden="true" data-bs-backdrop="false">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header p-0 bg-transparent">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body alertmsg text-center danger">
                    <form action="{{ route('loan.delete') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                    <i data-feather='x-circle'></i>
                    <h2>Confimation Message</h2>
                    <p>Are you sure to delete this application !!!</p>
                    <input type="hidden" name="app_id" value="{{ @$termLoan->id }}">
                ...
                <div class="modal-header">
                    <div>
                        <h4 class="modal-title fw-bolder text-dark namefont-sizenewmodal" id="myModalLabel17">Approve
                            Term Loan Application</h4>
                        <p class="mb-0 fw-bold voucehrinvocetxt mt-0">Nishu Garg | 20 Lkh | 29-07-2024</p>
                    </div>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('loan.appr_rej') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-1">
                                            @if (isset($termLoan->id))
                                                <input type="hidden" name="appr_rej_status" value="2">
                                                <input type="hidden" name="appr_rej_loan_id" value="{{ $termLoan->id }}">
                                            @endif
                                            <label class="form-label">Loan Amount <span class="text-danger">*</span></label>
                                            <input type="number" disabled value="{{ $termLoan->loan_amount ?? '' }}" class="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-1">
                                            ...
                                            @if (isset($termLoan) && $termLoan->status == 2)
                                                <input type="number" name="appr_rej_recommended_amnt" value="{{ $termLoan->appr_rej_recom_amnt ?? '' }}" class="form-control" />
                                            @else
                                                <input type="number" name="appr_rej_recommended_amnt" class="form-control" />
                                            @endif
                                        </div>
                                    </div>
                                ...
                                <div class="mb-1">
                                    ...
                                    @if (isset($termLoan) && $termLoan->status == 2)
                                        <textarea class="form-control" name="appr_rej_remarks">{{ $termLoan->appr_rej_recom_remark ?? '' }}</textarea>
                                    @else
                                ...
                                <div class="mb-1">
                                    @if (isset($termLoan) && $termLoan->status == 2)
                                        @if (isset($termLoan->id))
                                            <input type="hidden" name="stored_appr_rej_doc" value="{{ $termLoan->appr_rej_doc ?? '' }}">
                                        @endif
                                        <label class="form-label">Upload Document</label>
                                        <input type="file" name="appr_rej_doc" class="form-control" />
                                        @if (isset($termLoan) && !empty($termLoan->appr_rej_doc))
                                            <div class="col-md-3 mt-1">
                                                <p><i data-feather='folder' class="me-50"></i><a href="{{ asset('storage/' . $termLoan->appr_rej_doc) }}" style="color:green; font-size:12px;"
                                                        target="_blank" download>Approved
                                                        Doc</a></p>
                                            </div>
                                        @endif
                                    @else
                                ...
                                @php
                                    if (isset($termLoan)) {
                                        $selectedValues = $termLoan->appr_rej_behalf_of ? json_decode($termLoan->appr_rej_behalf_of, true) : [];
                                    }
                                @endphp
                                <div class="mb-1">
                                    ...
                                    @if (isset($termLoan) && $termLoan->status == 2)
                                        <select class="form-select select2" multiple name="appr_rej_behalf_of[]">
                                            <option value="">Select</option>
                                            <option value="nishu" {{ in_array('nishu', $selectedValues) ? 'selected' : '' }}>Nishu Garg
                                            </option>
                                            <option value="mahesh" {{ in_array('mahesh', $selectedValues) ? 'selected' : '' }}>Mahesh Bhatt
                                            </option>
                                            <option value="inder" {{ in_array('inder', $selectedValues) ? 'selected' : '' }}>Inder Singh
                                            </option>
                                            <option value="shivangi" {{ in_array('shivangi', $selectedValues) ? 'selected' : '' }}>Shivangi
                                            </option>
                                        </select>
                                    @else
                                        <select class="form-select select2" multiple name="appr_rej_behalf_of[]">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-1">
                                            @if (isset($termLoan->id))
                                                <input type="hidden" name="appr_rej_status" value="3">
                                                <input type="hidden" name="appr_rej_loan_id" value="{{ $termLoan->id }}">
                                            @endif
                                            <label class="form-label">Loan Amount <span class="text-danger">*</span></label>
                                            <input type="number" disabled value="{{ $termLoan->loan_amount ?? '' }}" class="form-control" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-1">
                                            <label class="form-label">Recommended Loan Amt. <span class="text-danger">*</span></label>
                                            @if (isset($termLoan) && $termLoan->status == 3)
                                                <input type="number" name="appr_rej_recommended_amnt" value="{{ $termLoan->appr_rej_recom_amnt ?? '' }}" class="form-control" />
                                            @else
                                                <input type="number" name="appr_rej_recommended_amnt" class="form-control" />
                                            @endif
    ...
    <script>
        ...
        $(document).ready(function() {
            // Check if the approval status is 'draft' (passed from Laravel Blade)
            var approvalStatus = @json(@$termLoan->approvalStatus);
            ...
            if (approvalStatus === 'draft') {
                ...
                $("input").each(function() {
                    // Skip the specific fields with IDs 'id-1', 'id-2', 'id-3'
                    if (this.id !== 'series' && this.id !== 'appli_no' && this.id !== 'ref_no') {
            ...
            fetch(actionUrl).then(response => {
                return response.json().then(data => {
                    if (data.status == 200) {
                        //$("#appli_no").val(data.data.book_code);
                        console.log(!data.data.doc.document_number, data.data.doc.document_number)
                        ...
                        $("#appli_no").val(data.data.doc.document_number);
       ...
       // Function to check if the telephone and mobile numbers are unique
function checkUniqueNumbers() {
    var isValid = true;

    // Get the values of all inputs
    var factoryTele = $('.factory-tele').val().trim();
    var registeredOffcTele = $('.registered-offc-tele').val().trim();
    var factoryMobile = $('.factory-number').val().trim();
    var registeredOffcMobile = $('.registered-offc-mobile').val().trim();

    // Validate Telephone Numbers: Ensure they are not the same
    if (factoryTele && registeredOffcTele && factoryTele === registeredOffcTele) {
        $('.factory-tele-error').text('Factory telephone and registered office telephone must be different.');
        isValid = false;
    } else {
        $('.factory-tele-error').text('');
    }

    // Validate Mobile Numbers: Ensure they are not the same
    if (factoryMobile && registeredOffcMobile && factoryMobile === registeredOffcMobile) {
        $('.factory-number-error').text('Factory mobile and registered office mobile must be different.');
        isValid = false;
    } else {
        $('.factory-number-error').text('');
    }

    return isValid;
}

// Check on keyup event for each input field
$('.factory-tele, .registered-offc-tele, .factory-number, .registered-offc-mobile').on('keyup', function () {
    checkUniqueNumbers(); // Re-check on each keyup
});

// Check on form submit
$('#term-loan-createUpdate').on('submit', function (e) {
    var isValid = checkUniqueNumbers(); // Check uniqueness when form is submitted
