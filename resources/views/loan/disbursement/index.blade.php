...
@section('content')
            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-end col-md-7 mb-2 mb-sm-0">
                    <div class="form-group breadcrumb-right">
                        ...
                        <a class="btn btn-dark btn-sm mb-50 mb-sm-0" href="{{ route('loan.add-disbursement') }}"><i
                                data-feather="file-text"></i> Add Disbursal</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12 col-12">
                            <div class="card  new-cardbox">
                                ...
                                <ul class="nav nav-tabs border-bottom" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#under">Under Processing
                                            &nbsp;<span id="under_span"></span></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#Pending">Disburse
                                            &nbsp;<span id="pending_span"></span></a>
                                    </li>
                                </ul>

                                <div class="tab-content">
                                    <div class="tab-pane active" id="under">
                                        <div class="table-responsive">
                                            <table
                                                class="datatables-basic table myrequesttablecbox loanapplicationlistv request">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                    ...
                                    <div class="tab-pane" id="Pending">
                                        <div class="table-responsive">
                                            <table
                                                class="datatables-basic table myrequesttablecbox loanapplicationlist disburse">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Application No.</th>
    ...
    <script>
        ...
        $(function() {
            ...
            if (dt_basic_table.length) {
                var dt_basic = dt_basic_table.DataTable({
                    ...
                    drawCallback: function() {
                        feather.replace();
                        var json = dt_basic.ajax.json(); // Get current JSON data
                var count = json.recordsFiltered; // Get the filtered count
                $('#under_span').text(`(${count})`);
            ...
            // Delete Record
            $('.request tbody').on('click', '.delete-record', function() {
                dt_basic.row($(this).parents('tr')).remove().draw();
            });
        });
        $(function() {
            var dt_basic_table = $('.disburse'),
                dt_date_table = $('.dt-date'),
                assetPath = '../../../app-assets/';
            ...
            $('.disburse tbody').on('click', '.delete-record', function() {
                dt_basic.row($(this).parents('tr')).remove().draw();
            });
        });
