...
@section('content')
        ...
        <div class="content-wrapper container-xxl p-0">
                ...
                <div class="row">
                    <div class="content-header-left col-md-6 mb-2">
                        <div class="row breadcrumbs-top">
                            <div class="col-12">
                                <h2 class="content-header-title float-start mb-0">Disbursement Entry</h2>
                    ...
                    <div class="content-header-right text-sm-end col-md-6 mb-50 mb-sm-0">
                        <div class="form-group breadcrumb-right">
                            ...
                            <a class="btn btn-primary btn-sm mb-50 mb-sm-0"
                                href="{{ route($view_route, ['id' => $loan->id]) }}"><i data-feather="check-circle"></i> View
                                Application</a>
                            @if ($buttons['submit'])
                                
                                    @if($isPostingRequired)
                                        <button  id="submitButton" type="button" class="btn btn-success btn-sm mb-50 mb-sm-0"><i
                                            data-feather="check-circle"></i>
                                        Submit</button>
                                    @else
                                        <button form="disbursement-payment" class="btn btn-success btn-sm mb-50 mb-sm-0"><i
                                            data-feather="check-circle"></i>
                                        Submit</button>
                                    @endif
                            @endif
            ...
            <div class="content-body">
                ...
                <section id="basic-datatable">
                    <div id="disbursement-add-update">
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="dis_amount" readonly
                                                            value="{{ \App\Helpers\Helper::formatIndianNumber($data->dis_amount) }}" required id="dis_amnt"
                                                            class="form-control" oninput="calculate_disbursal()">
                                                        @error('dis_amount')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                        ...
                                                        <ul class="nav nav-tabs my-25 custapploannav" role="tablist">
                                                            <li class="nav-item">
                                                                <a class="nav-link active" data-bs-toggle="tab"
                                                                    href="#Pattern">Disbursement Detail</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <form id="disbursement-payment" method="POST"
                                                        action="{{ route('disbursement.payment') }}">
                                                        @csrf
                                                            ...
                                                            <div class="tab-pane active" id="Pattern">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <h5 class="mt-1 mb-2 text-dark"><strong>Payment
                                                                                Details</strong></h5>
                                                                        ...
                                                                        <div class="row align-items-center mb-1">
                                                                            <div class="col-md-4">
                                                                                <label class="form-label">Payment Type
                                                                                    <span
                                                                                        class="text-danger">*</span></label>
                                                                            </div>

                                                                            <div class="col-md-3">
                                                                                <input type="radio" id="Bank" value="Bank" name="payment_type" class="remove-disable form-check-input" checked>
                                                                                <label class="form-check-label fw-bolder" for="Bank">Bank</label>
                                                                            </div>

                                                                            <div class="col-md-3">
                                                                                <input type="radio" id="Cash" value="Cash" name="payment_type" class="form-check-input remove-disable">
                                                                        ...
                                                                        <div class="row align-items-center mb-1 bankfield">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <select class="form-control select2 bankInput"
                                                                                    name="bank_name" id="bank"
                                                                                    required onchange="get_account()">
                                                                                    <option value="">Select</option>
                                                                        ...
                                                                        <div class="row align-items-center mb-1 bankfield">
                                                                            <div class="col-md-4">
                                                                                <label class="form-label">Payment Mode
                                                                                    <span
                                                                                        class="text-danger">*</span></label>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <select class="form-control select2 bankInput"
                                                                                    required name="payment_mode">
                                                                                    <option value="">Select</option>
                                                                                    <option value="imps_rtgs">IMPS/RTGS
                                                                                    </option>
                                                                                    <option value="neft">NEFT</option>
                                                                                    <option value="cheque">By Cheque
                                                                                    </option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row align-items-center mb-1">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <input type="text" class="form-control"
                                                                                    required name="customer_bank_name">
    ...
    <div class="modal fade" id="reject" tabindex="-1" aria-labelledby="shareProjectTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <form id="reject_disbursement" enctype="multipart/form-data" method="POST"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#submitButton').on('click', function (e) {
                ...
                let formData = new FormData($('#disbursement-payment')[0]);

                // Send AJAX request
                $.ajax({
                    url: $('#disbursement-payment').attr('action'), // Get form action URL
                    type: 'POST',
                    data: formData,
                    ...
                    success: function (response) {
                        ...
                        $('#disbursement-payment')[0].reset(); // Reset the form
                        $('#submitButton').prop('disabled', false).text('Submit');
                        
                        
                        $('#ldata').val(response.requestdata);
        ...
        $(document).ready(function() {
            ...
            $('#disbursement-payment').find('input, select,textarea').prop('readonly', false);
            $('#disbursement-payment').find('input, select,textarea').prop('disabled', false);
        ...
        function onPostVoucherOpen(type = "not_posted")
        {
            ...
            const apiURL = "{{route('loan.disbursement.getPostingDetails')}}";
            const remakrs = $("#remakrs").val();
            $.ajax({
                url: apiURL + "?book_id=" + "{{$data->book_id}}" + "&document_id=" + "{{$data->id}}"+"&remakrs="+remakrs,
                type: "GET",
                dataType: "json",
                success: function(data) {
                    if (!data.data.status) {
...
function postVoucher(element)
{
    ...
    const postingApiUrl = "{{route('loan.disbursement.post')}}";
    const data1 = $("#ldata").val();
    console.log(bookId);
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (response.status) {
                    ...
                    location.href = '/loan/disbursement-submission';;
                } else {
                    Swal.fire({
                        title: 'Error!',
                        text: response.message,
