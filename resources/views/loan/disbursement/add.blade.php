...
@section('content')
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <!-- <div class="row align-items-center mb-1">
                                                                                                        ...
                                                                                                        <div class="col-md-4">
                                                                                                            <select class="form-select book_typeSelect" name="book_type" required onchange="fetchLoanSeries(this.value, 'book_id');">
    ...
    @endif
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" id="loan_amnt" name="loan_amount" readonly
            ...
            $(document).on('change', '#customers', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        console.log(data.customer_record.loan_appraisal.loan.type);
                        let loanData = '';
                ...
                return response.json().then(data => {
                    if (data.status == 200) {
                        ...
                        if (!data.data.doc.document_number) {
                            ...
                            $("#disbursal_no").val(data.data.doc.document_number);
                        ...
                        if (data.data.doc.type == 'Manually') {
                            $("#disbursal_no").attr('readonly', false);
                        } else {
                            $("#disbursal_no").attr('readonly', true);
                        }
