            ...
            <div class="row">
                <div class="content-header-left col-md-6 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Approve Request</h2>
                ...
                <div class="content-header-right text-sm-end col-md-6 mb-50 mb-sm-0">
                    <div class="form-group breadcrumb-right">
                        ...
                        @endif
                        @if ($buttons['approve'])
                        <button data-bs-toggle="modal" data-bs-target="#viewassesgive" class="btn btn-success btn-sm mb-50 mb-sm-0"><i data-feather="check-circle"></i>
                        Approve</button>
                        @endif

                        <a class="btn btn-primary btn-sm mb-50 mb-sm-0" href="{{route($view_route,['id'=>$loan->id])}}"><i
                            data-feather="check-circle"></i> View Application</a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="card-body customernewsection-form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-select" name="book_id" id="book_id" required>
                                                        ...
                                                        <option value="{{ $val->id }}" {{ $val->id == $data->book_id ? 'selected' : '' }}>
                                                            {{ $val->book_name }}
                                                        </option>
                                                        @endforeach
                                                        @endif
                                            ...
                                            <div class="row align-items-center mb-1">
                                                <div class="col-md-2">
                                                    <label class="form-label">Disbursal No. <span class="text-danger">*</span></label>
                                                </div>

                                                <div class="col-md-4">
                                                    <input type="text" name="disbursal_no" id="disbursal_no" value="{{ $data->disbursal_no ?? '' }}" class="form-control" required>
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-select select2" id="customers" name="customer_id" required>
                                                        <option value="">Select</option>
                                                        @if (isset($customers))
                                                        @foreach ($customers as $key => $val)
                                                        <option value="{{ $val->loanAppraisal->loan->id }}" {{ $data->home_loan_id == $val->loanAppraisal->loan->id ? 'selected' : '' }}>
                                                ...
                                                <div class="col-md-4" hidden>
                                                    <div class="action-button mt-50">
                                                        <button data-bs-toggle="modal" type="button" data-bs-target="#rescdule" class="btn btn-outline-primary btn-sm"><i data-feather="plus-square"></i> Pending
                                                            Disbursal</button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" readonly class="form-control" value="" id="appli_no" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" readonly value="" name="loan_type" id="loan_type" class="form-control" required>
                                                </div>
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" value="" id="loan_amnt" readonly class="form-control" required>
                                                </div>
                                            ...
                                            <div class="row align-items-center mb-1">
                                                <div class="col-md-2">
                                                    <label class="form-label">Select Disbursal Milestone <span class="text-danger">*</span></label>
                                                </div>

                                                <div class="col-md-4">

                                                    <select name="dis_milestone[]" id="milestone" onchange="disbursalchange()" class="form-select select2" multiple required>
                                                    </select>
                                            ...
                                            <div class="row align-items-center mb-1">
                                                <div class="col-md-2">
                                                    <label class="form-label">Disbursal Amount <span class="text-danger">*</span></label>
                                                </div>

                                                <div class="col-md-4">
                                                    <input type="text" name="dis_amount" readonly value="{{ \App\Helpers\Helper::formatIndianNumber($data->dis_amount) }}" required id="dis_amnt" class="form-control" oninput="calculate_disbursal()">
                                                    @error('dis_amount')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row align-items-center mb-1">
                                                <div class="col-md-2">
                                                    <label class="form-label">Customer Contribution <span class="text-danger">*</span></label>
                                                </div>

                                                <div class="col-md-4">
                                                    <input type="text" name="customer_contri" id="customer_contri" required oninput="calculate_disbursal()" value="{{ old('customer_contri', \App\Helpers\Helper::formatIndianNumber($data->customer_contri) ?? '') }}" class="form-control set-commas">
                                            ...
                                            <div class="row align-items-center mb-1">
                                                <div class="col-md-2">
                                                    <label class="form-label">Actual Disbursal Amt. <span class="text-danger">*</span></label>
                                                </div>

                                                <div class="col-md-4">
                                                    <input type="text" required name="actual_dis" id="actual_dis" required value="{{ old('actual_dis', \App\Helpers\Helper::formatIndianNumber($data->actual_dis) ?? '') }}" class="form-control" readonly />
                                                    @error('actual_dis')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row align-items-center mb-1" hidden>
                                                ...
                                                <div class="col-md-4">
                                                    <input type="file" class="form-control" name="disbursement_docs[]" id="fileInput" onchange="checkFileTypeandSize(event)" multiple />

                                                    @if (!empty($data->loanDisbursementDoc))
                                                    @foreach ($data->loanDisbursementDoc as $doc)
                                                    <div class="image-uplodasection expenseadd-sign">
                                                        <a href="{{ $doc->doc }}"><i data-feather="file-text" class="fileuploadicon"></i></a>
                                            ...
                                            <div class="row  mb-1" hidden>
                                                ...
                                                <div class="col-md-4">
                                                    <textarea type="text" rows="4" class="form-control" placeholder="Enter Remarks here..." name="dis_remarks">{{ $data->dis_remarks }}</textarea>
                                                </div>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-3  mb-1">
                        ...
                        <button type="button" id="search" class="btn btn-warning btn-sm"><i data-feather="search"></i>
                            Search</button>
                    </div>
...
<div class="modal fade" id="viewassesgive" tabindex="-1" aria-labelledby="shareProjectTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="proceed_disbursement" method="POST" enctype="multipart/form-data" action="{{route('loan.proceed.disbursement')}}">
                @csrf
            <div class="modal-body pb-2">
                ...
                <div class="row mt-1">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="hidden" name="customer_contribution" id="customer_contribution">
                        <input type="hidden" name="disbursal_amount" id="disbursal_amount">
...
<div class="modal fade" id="reject" tabindex="-1" aria-labelledby="shareProjectTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <form id="reject_disbursement" enctype="multipart/form-data" method="POST" action="{{route('loan.reject.disbursement')}}">
        @csrf
            <div class="modal-content">
            ...
            if (customerID != "") {
                ...
                $.ajax({
                    ...
                    , success: function(data) {
                        ...
                        $("#loan_amnt").val(formatIndianNumber(data.customer_record.loan_appraisal.term_loan));
