                            ...
                            <div class="col-12">
                                ...
                                <div class="card">
                                    <div class="card-body customernewsection-form">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 text-sm-end">
                                                    <span class="badge rounded-pill badge-light-secondary forminnerstatus">
                                                        Status: <span
                                                            class="@if ($data->approvalStatus === 'Approved') text-success
                                                                             @elseif($data->approvalStatus === 'Requested') text-info
                                                                             @elseif($data->approvalStatus === 'Rejected') text-danger
                                                                             @elseif($data->approvalStatus === 'Accessed') text-warning
                                                                             @elseif($data->approvalStatus === 'Disbursed') text-success
                                        ...
                                        <div class="row"
                                            @if ($data->approvalStatus != 'Disbursed') style="display: none;" @endif>
                                                                ...
                                                                <div class="row">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <select class="form-control select2"
                                                                                    ...
                                                                                    @foreach ($banks as $bank)
                                                                                        <option
                                                                                            value="{{ $bank->id }}"
                                                                                            @isset($data->bank_details_id)
                                                                                            {{ $bank->id == $data->payment->bank_id ? 'selected' : '' }}>
                                                                                            @endisset
                                                                        ...
                                                                        <div class="row align-items-center mb-1">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <select class="form-control select2"
                                                                                    ...
                                                                                    <option value="">Select</option>
                                                                                    <option value="imps_rtgs"
                                                                                        {{ $data->payment_mode == 'imps_rtgs' ? 'selected' : '' }}>
                                                                                        IMPS/RTGS</option>
                                                                                    <option value="neft"
                                                                                        {{ $data->payment_mode == 'neft' ? 'selected' : '' }}>
                                                                                        NEFT</option>
                                                                                    <option value="cheque"
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="row align-items-center mb-1">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <input type="text" class="form-control"
                                                                                    required name="customer_account_number"
                                                                                    value="{{ $data->customer_account_number }}">
                                                                            </div>
                                                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="mb-1">
                                ...
                                <select class="form-select" name="filter-ledger-type" id="filter-ledger-type">
                                    <option value="">Select</option>
    ...
    <script>
        ...
        function appendmilestone() {
            ...
            $('input[name="customColorRadio3"]').each(function() {
                ...
                if ($(this).is(':checked')) {
                    ...
                    $('#dis_amnt').val(formatIndianNumber(totalValue));
            ...
            var milestones =  @json($data->dis_milestone)
            ...
            $('#milestone option').each(function() {
                ...
                milestones.forEach(function(milestone) {
                    console.log(milestone.id, optionId);
        ...
        $("#process_disbursal").click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $("#loan_type").val(loanData);
                    $("#loan_amnt").val(formatIndianNumber(data.customer_record.loan_appraisal
                        .term_loan));
                    // $("#milestone").val(data.milestone);
                    // $("#dis_amnt").val(data.dis_amnt);
        ...
        function calculate_disbursal() {
            if (customercontri > disbursal_amnt) {
                ...
                $('#actual_dis').val(disbursal_amnt - customercontri + "");
        ...
        function disbursalchange() {
            ...
            $('#dis_amnt').val(formatIndianNumber(totalDisburseValue)); // Format to 2 decimal places
            $('#actual_dis').val(totalDisburseValue.toFixed(2));
        }

        $(document).ready(function() {
            // Disable all input and select fields within the form
            @if ($data->approvalStatus == 'Disbursed')
                get_account();
            @endif
                            ...
                            if (response) {
                                ...
                                $.each(response, function(index, account) {
                                    $('#account').append('<option value="' + account.id + '" ' +
                                        (account.id == "{{ $data->bank_details_id }}" ?
                                            'selected' : '') + '>' +
