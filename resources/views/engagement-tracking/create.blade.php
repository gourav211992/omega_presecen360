...
@section('content')
    <!-- BEGIN: Content-->
    <form class="ajax-input-form" method="POST" action="{{ route('engagement-tracking.store') }}" data-redirect="{{ url('/engagement-tracking') }}">
        @csrf
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="breadcrumb-wrapper">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active">Engagement Tracking</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
