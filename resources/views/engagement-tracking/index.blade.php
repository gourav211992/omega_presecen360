                ...
                <div class="row">
                    <div class="content-header-left col-md-6 col-6 mb-2">
                        <div class="row breadcrumbs-top">
                            <div class="col-12">
                                <h2 class="content-header-title float-start mb-0">Stakeholder Engagement Tracking</h2>
                                <div class="breadcrumb-wrapper">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="{{ route('engagement-tracking.index') }}">Home</a></li>
                                        <li class="breadcrumb-item active">Engagement Tracking List</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="content-header-right text-end col-md-6 col-6 mb-2 mb-sm-0">
                        ...
                        <a class="btn btn-primary btn-sm" href="{{ route('engagement-tracking.create') }}"><i data-feather="plus-circle"></i> Add New</a>
                    </div>
                </div>
            </div>
        ...
        $(document).ready(function() {
            ...
            if (dt_basic_table.length) {
                var dt_basic = dt_basic_table.DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('engagement-tracking.index') }}",  // Ajax route to fetch data
                    columns: [
            ...
            $(".apply-filter").on("click", function () {
                ...
                dt_basic.ajax.url("{{ route('engagement-tracking.index') }}?date_range=" + dateRange + "&customer_name=" + customerName + "&interaction_type=" + interactionType).load();
                $(".modal").modal("hide");
            });
        });
    </script>
