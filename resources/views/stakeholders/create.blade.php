...
@section('content')
    <!-- BEGIN: Content-->
    <form class="ajax-input-form" method="POST" action="{{ route('stakeholder.store') }}" data-redirect="{{ url('/stakeholder') }}">
        @csrf
                    ...
                    <div class="row">
                        <div class="content-header-left col-md-6 col-6 mb-2">
                            <div class="row breadcrumbs-top">
                                <div class="col-12">
                                    <h2 class="content-header-title float-start mb-0">StakeHolder Interaction Capturing</h2>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center mb-1">
                                            ...
                                            <div class="col-md-5">
                                                <textarea class="form-control" name="followup_actions" placeholder=""></textarea>
                                            </div>
