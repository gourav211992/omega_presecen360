...
@section('content')
    <!-- BEGIN: Content-->
    <form class="ajax-input-form" method="POST" action="{{ route('relation-management.store') }}" data-redirect="{{ url('/relation-management') }}">
        @csrf
                    ...
                    <div class="row">
                        <div class="content-header-left col-md-6 col-6 mb-2">
                            <div class="row breadcrumbs-top">
                                <div class="col-12">
                                    <h2 class="content-header-title float-start mb-0">Investor Relation Management</h2>
                                    <div class="breadcrumb-wrapper">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="{{ route('relation-management.index') }}">Home</a></li>
                                            <li class="breadcrumb-item active">Relation Management</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-5">
                                                <select class="form-select" name="book_id" id="series" required>
                                                    ...
                                                    @foreach ($series as $ser)
                                                        <option value="{{ $ser->id }}">{{ $ser->book_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row align-items-center mb-1">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" class="form-control" name="document_number" readonly id="requestno" value="{{ old('requestno') }}">
                                        ...
                                        <div class="row align-items-center mb-1">
                                            ...
                                            <div class="col-md-5">
                                                <input type="date" onchange="getDocNumberByBookId()" class="form-control" name="document_date" id="document_date" value="{{ old('document_date', date('Y-m-d')) }}">
                                                @error('document_date')
                                        ...
                                        <div class="row align-items-center mb-1">
                                            ...
                                            <div class="col-md-5">
                                                <textarea class="form-control" name="followup" placeholder=""></textarea>
                                            </div>
                                            @error('followup')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
