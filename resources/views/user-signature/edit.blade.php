                ...
                <div class="row">
                    ...
                    <div class="content-header-right text-end col-md-6 col-6 mb-2 mb-sm-0">
                        <div class="form-group breadcrumb-right">
                            ...
                            <button type="submit" form="user-signature-form" class="btn btn-primary btn-sm" id="submit-btn">
                ...
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <form id="user-signature-form" method="POST" action="{{ route('user-signature.update',$data->id) }}"
                                        ...
                                        <div class="border-bottom mb-2 pb-25">
                                            <div class="row">
                                               ...
                                               <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="file" class="form-control" name="sign_upload_file"
                                                            id="fileInput" accept=".jpg,.jpeg,.png">

                                                        <div id="appenddata">
                                                            <div class="image-uplodasection"><div class="filepreview"><a href="{{ route('user-signature.showFile',[$data->id]) }}" target="_blank"><img src="{{ route('user-signature.showFile',[$data->id]) }}"></a></div>
