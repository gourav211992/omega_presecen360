                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="mb-1">
                            ...
                            <input type="text" id = "vendor_code_input" placeholder="Select" class="form-control mw-100 ledgerselecct ui-autocomplete-input except_draft disable_on_edit" autocomplete="off" value = "{{isset($order) ? $order -> vendor -> company_name : ''}}" onblur = "onChangeVendor('vendor_code_input', true);">
