...
@section('content')
    <!-- BEGIN: Content-->
    <form class="ajax-input-form" method="POST" action="{{ route('exchange-rates.update', $exchangeRate->id) }}" data-redirect="{{ url('/exchange-rates') }}">
        @csrf
        @method('PUT')
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="breadcrumb-wrapper">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active">Edit Exchange Rate</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                    ...
                                                    <div class="col-md-5">
                                                        <select name="from_currency_id" class="form-select mw-100 select2" required>
                                                            ...
                                                            @foreach($currencies as $currency)
                                                                <option value="{{ $currency->id }}" {{ $currency->id == $exchangeRate->from_currency_id ? 'selected' : '' }}>
                                                                    {{ $currency->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <select name="upto_currency_id" class="form-select mw-100 select2" required>
                                                            <option value="">Select Currency</option>
                                                            @foreach($currencies as $currency)
                                                                <option value="{{ $currency->id }}" {{ $currency->id == $exchangeRate->upto_currency_id ? 'selected' : '' }}>
                                                                    {{ $currency->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="number" step="0.000001" name="exchange_rate" class="form-control" value="{{ $exchangeRate->exchange_rate ?? '' }}" required />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="date" name="from_date" class="form-control" value="{{ $exchangeRate->from_date ??''}}" required />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="date" name="upto_date" class="form-control" value="{{ $exchangeRate->upto_date ?? '' }}" />
                                                    </div>
                                                </div>
                                                            ...
                                                            @foreach ($status as $statusOption)
                                                                <div class="form-check form-check-primary mt-25">
                                                                    <input
                                                                        ...
                                                                        {{ $statusOption == old('status', $exchangeRate->status) ? 'checked' : '' }}
                                                                    >
