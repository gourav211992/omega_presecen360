...
@section('content')
    ...
    <div class="app-content content">
        ...
        <form class="ajax-input-form" method="POST" action="{{ route('warehouse-item-mapping.store') }}"
            data-redirect="/warehouse-item-mappings" enctype="multipart/form-data">
            @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="position-relative">
                                                            <select class="form-select select2" name="store_id"
                                                                onchange="getSubStores(this.value)">
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="position-relative">
                                                            <select class="form-select select2 sub_store_id sub_store"
                                                                name="sub_store_id" onchange="getDetails(this.value)">
