            ...
            <div class="modal-body px-sm-2 mx-50 pb-2">
                ...
                <div class="table-responsive-md customernewsection-form">
                    <table id="summaryExpTable" class="mt-1 table myrequesttablecbox table-striped po-order-detail custnewpo-detail">
                        ...
                        <tbody>
                            @if(isset($mr->expenses) && $mr->expenses->count())
                                @foreach($mr->expenses as $expKey => $headerExpense)
                            ...
                            <tr id="expSummaryFooter">
                                ...
                                <td class="text-dark text-end"><strong id="total" amount="{{@$mr->expense_amount}}">{{number_format(@$mr->expense_amount,2)}}</strong></td>
                                <td></td>
                            </tr>
                        </tbody>
                    </table>
