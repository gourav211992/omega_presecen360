<div class="modal fade" id="amendementModal" tabindex="-1" aria-labelledby="shareProjectTitle" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <form class="ajax-input-form" method="POST" action="{{ route('document.amendement.material-receipt') }}" data-redirect="{{ route('material-receipt.index') }}" enctype='multipart/form-data'>
          @csrf
