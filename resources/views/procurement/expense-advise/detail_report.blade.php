                        ...
                        <div class="col-md-12 bg-light border-bottom mb-1 po-reportfileterBox">
                            <div class="row pofilterhead action-button align-items-center">
                                ...
                                <div
                                    ...
                                    <span> </span>
                                    <a class="btn btn-warning btn-sm mb-0 mx-1 waves-effect" href="/purchase-bills/report">
                            ...
                            <div class="row sortable">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
                                        ...
                                        <label class="form-check-label" for="mrn-no">Expense Advise NO</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
                                        <input type="checkbox" class="form-check-input" id="mrn-date" checked="">
                                        <label class="form-check-label" for="mrn-date">Expense Advise Date</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-check form-check-secondary">
...
<script src="{{ asset('assets/js/custom/expense-advise.js') }}"></script>
...
<script>
    window.routes = {
        poReport: @json(route('expense-adv.report.filter')),
        addScheduler: @json(route('expense-adv.add.scheduler')),
    };
