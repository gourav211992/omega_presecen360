                                                    ...
                                                    <tbody id="priceVarianceAccountsTable">
                                                        @if($priceVarianceAccounts->isEmpty())
                                                            <tr data-index="0" data-id="">
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <input type="text" class="form-control mw-100 autocomplete sub_category_name" name="price_variance_accounts[0][sub_category_name]" placeholder="Enter Group">
                                                        ...
                                                        @else
                                                            @foreach($priceVarianceAccounts as $index => $item)
                                                                <tr data-index="{{ $index }}" data-id="{{ $item->id }}">
                                                                    ...
                                                                    <td>
                                                                        <div class="setup-td-width">
                                                                            <input type="text" class="form-control mw-100 autocomplete sub_category_name" name="price_variance_accounts[{{ $index }}][sub_category_name]" value="{{ $item->subCategory->name ?? '' }}" placeholder="Enter Group">
 ...
 document.addEventListener("DOMContentLoaded", function () {
   ...
   function addRow(clickedRow) {
        ...
        newRow.innerHTML = `
            ...
            <td>
                <div class="setup-td-width">
                    <input type="text" class="form-control mw-100 autocomplete sub_category_name" name="price_variance_accounts[${rowIndex}][sub_category_name]" placeholder="Enter Group">
