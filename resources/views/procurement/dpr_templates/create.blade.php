...
@section('content')
    <!-- BEGIN: Content-->
    <form method="POST" action="{{ route('dpr-template.store') }}">
        @csrf
                    ...
                    <div class="row">
                        <div class="content-header-left col-md-6 col-6 mb-2">
                            <div class="row breadcrumbs-top">
                                <div class="col-12">
                                    <h2 class="content-header-title float-start mb-0">DRP Templates</h2>
                        ...
                        <div class="content-header-right text-end col-md-6 col-6 mb-2 mb-sm-0">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm"><i data-feather="check-circle"></i>
                                Create</button>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="text" name="name" class="form-control"
                                                            placeholder="Enter Name" value="{{ old('name') }}" autocomplete="off" required/>
                                                        @error('name')
