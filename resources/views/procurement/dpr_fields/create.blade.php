...
@section('content')
    <!-- BEGIN: Content-->
    <form method="POST" action="{{ route('dpr-master.store') }}">
        @csrf
                    ...
                    <div class="row">
                        <div class="content-header-left col-md-6 col-6 mb-2">
                            <div class="row breadcrumbs-top">
                                <div class="col-12">
                                    <h2 class="content-header-title float-start mb-0">DRP Fields</h2>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="text" name="field_name" class="form-control"
                                                            placeholder="Enter Name" value="{{ old('field_name') }}"
