                                                            ...
                                                            <tr valign="top">
                                                                ...
                                                                <td colspan="3">
                                                                    <table class="table border mrnsummarynewsty">
                                                                        ...
                                                                        <input type="hidden" name="total_item_amt_aftr_disc" id="total_item_amt_aftr_disc" class="total_item_amt_aftr_disc">
                                                                        <tr class="totalsubheadpodetail">
...
@section('scripts')
    ...
    <script>
            ...
            fetch(actionUrl).then(response => {
                return response.json().then(data => {
                    if (data.status == 200) {
                        ...
                        $("#tax_required").val(parameters?.tax_required);
                    }
                    if(data.status == 404) {
                        $("#book_code").val('');
                        $("#document_number").val('');
        ...
        function getItemDetail(currentTr) {
            ...
            // console.log('itemitemId','jfgrejrrgre', itemId);
            if (itemId) {
                let selectedAttr = [];
