...
@section('content')
    ...
    @endphp
    <form class="ajax-input-form" data-module="mrn" method="POST" action="{{ route('material-receipt.store') }}"
        data-redirect="/{{ $routeRedirect }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="content-header-right text-sm-end col-md-6 mb-50 mb-sm-0">
                            <div class="form-group breadcrumb-right">
                                ...
                                <button type="button" class="btn btn-info btn-sm mb-50 mb-sm-0 scanQR d-none"
                                            ...
                                            <div class="col-md-8">
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <input type="hidden" class="book_code" name="book_code"
                                                            id="book_code">
                                                    </div>
                                                </div>
                                                <div class="row align-items-center mb-1">
                                                ...
                                                <div class="row align-items-center mb-1 d-none reference_from"
                                                    id="reference_from">
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-8 action-button">
                                                        <div class="d-flex flex-wrap gap-2">
                                                            <button type="button"
                                                                class="btn btn-outline-primary btn-sm mb-0 poSelect  d-none">
                                                                <i data-feather="plus-square"></i>
                                                                Outstanding PO
                                                            </button>
                                                            <button type="button"
                                                                class="btn btn-outline-primary btn-sm mb-0 joSelect  d-none">
                                                                <i data-feather="plus-square"></i>
                                                                Outstanding JO
                                                            </button>
                                                            {{-- <button type="button"
                                                                class="btn btn-outline-primary btn-sm mb-0 soSelect  d-none">
                                                                <i data-feather="plus-square"></i>
                                                                Work Order
                                                            </button> --}}
                                                            <button type="button"
                                                                class="btn btn-outline-primary btn-sm mb-0 dnoteSelect  d-none">
                                                                <i data-feather="plus-square"></i>
                                                                D note
                                                            </button>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="mb-1">
                                                            ...
                                                            <select class="form-select payment_term_id"
                ...
                <div class="modal-body px-4 pb-3">
                    ...
                    <div class="d-flex justify-content-center mb-3">
                        <div class="form-check form-check-inline me-3">
                            <input class="form-check-input process-type-radio" type="radio" name="process_type"
                                id="radio_asn" value="suppl-inv" checked>
                            <label class="form-check-label fw-semibold" for="radio_asn">ASN</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input process-type-radio" type="radio" name="process_type"
                                id="radio_ge" value="gate-entry">
                    ...
                    <div class="row align-items-center mb-3 asn-container">
                        ...
                        <div class="col-md-8">
                            <input type="text" name="process_number" class="form-control process_number"
    ...
    <script>
        ...
        function setServiceParameters(parameters) {
            ...
            if (reference_from_service.length) {
                let dnoteTypes = [dnote, siDnote];
                if (
                    reference_from_service.includes(po) ||
                    reference_from_service.includes(jo) ||
                    reference_from_service.includes(so) ||
                    reference_from_service.includes(dnote) ||
                    reference_from_service.includes(siDnote)
                ) {
                    ...
                    if (dnoteTypes.some(type => reference_from_service.includes(type))) {
                        $(".dnoteSelect").removeClass('d-none');
                    }
                } else {
        ...
        function getDynamicParams() {
            ...
            if ((currentProcessType === dnote) || (currentProcessType === siDnote)) {
        ...
        function getDNoteOrders() {
            const ajaxUrl = '{{ route('material-receipt.get.dnote', ['type' => 'create']) }}';
            var columns = [];
            columns = [{
                    data: 'id',
                    visible: false,
