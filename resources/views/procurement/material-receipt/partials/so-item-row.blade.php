    ...
    <tr data-group-item="{{ json_encode($item) }}" id="row_{{ $rowCount }}" data-index="{{ $rowCount }}"
        ...
        <td>
            <input type="number" class="form-control mw-100 po_qty text-end checkNegativeVal"
                value="{{ $item->qty }}" step="any" readonly />
        </td>
        <td>
        ...
        <td>
            <input type="number" name="components[{{ $rowCount }}][basic_value]"
                value="{{ ($item->qty - $item->grn_qty) * $item->rate }}"
        ...
        <td>
            <input type="text" id="item_total_cost_{{ $rowCount }}"
                name="components[{{ $rowCount }}][item_total_cost]" value="{{ $item->qty * $item->rate }}"
                readonly class="form-control mw-100 text-end item_total_cost" step="any" />
        </td>
        <td>
            <div class="d-flex">
                @if ($hasAssetDetail === 1)
        ...
        <input type="hidden" name="components[{{ $rowCount }}][so_item_hidden_ids]"
            value="{{ $item->id }}">
        <input type="hidden" name="components[{{ $rowCount }}][so_hidden_ids]"
