             ...
             <div class="row mt-1">
                <div class="col-md-12">
                   <div class="mb-2">
                      ...
                      <textarea maxlength="250" name="amend_remark" class="form-control"></textarea>
                   ...
                   <div class="mb-2">
                      ...
                      <input type="file" onchange="addFiles(this, 'po_popup_file_preview')" name="amend_attachment[]" multiple class="form-control" />
