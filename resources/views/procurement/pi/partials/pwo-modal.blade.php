<div class="modal fade text-start" id="pwoModal" tabindex="-1" aria-labelledby="pwoModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 1200px">
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="modal-title fw-bolder text-dark namefont-sizenewmodal" id="pwoModal">Select PWO</h4>
            ...
            <div class="modal-footer text-end">
                ...
                <button type = "button" class="btn btn-primary btn-sm pwoProcess"><i data-feather="check-circle"></i> Process</button>
            </div>
        </div>
    </div>
</div>
