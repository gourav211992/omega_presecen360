                ...
                <div class="content-header-right text-sm-end col-md-7 mb-50 mb-sm-0">
                    <div class="form-group breadcrumb-right">
                        <div class="btn-group new-btn-group my-1 my-sm-0 ps-0">
                            ...
                            <input type="date" class="bg-white form-control flatpickr-range flatpickr-input" name="Period" id="document_date_filter" />
                        </div>
...
function applyColumnSelection() {
    ...
    for (let index = 0; index < allColumns.length; index++) {
        let colIndex = allColumns[index].getAttribute('data-column');
