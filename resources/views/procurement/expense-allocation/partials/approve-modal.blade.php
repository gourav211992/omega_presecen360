<div class="modal fade" id="approveModal" tabindex="-1" aria-labelledby="shareProjectTitle" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
         <form class="ajax-input-form" method="POST" action="{{ route('document.approval.expense-adv') }}" data-redirect="{{ route('expense-adv.index') }}" enctype='multipart/form-data'>
            @csrf
               ...
               <div class="row mt-1">
                  <div class="col-md-12">
                     ...
                     <div class="mb-2">
                        ...
                        <input id="attachments" type="file" name="attachment[]" class="form-control" onchange="addFiles(this, 'expense_popup_file_preview')" multiple>
