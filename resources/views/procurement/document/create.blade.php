...
@section('content')
    <!-- BEGIN: Content-->
<form class="ajax-input-form" method="POST" action="{{ route('documents.store') }}" data-redirect="{{ url('/erp-document') }}">
    @csrf
                                        ...
                                        <div class="row align-items-center mb-1">
                                            ...
                                            <div class="col-md-5">
                                                <select name="service" class="form-control">
                                                    ...
                                                    <option value="land" {{ old('service') == 'land' ? 'selected' : '' }}>Land</option>
                                                    <option value="loan" {{ old('service') == 'loan' ? 'selected' : '' }}>Loan</option>
                                                </select>
                                            </div>
                                        </div>
