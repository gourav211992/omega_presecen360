@extends('layouts.app')
@section('content')
    <form id="pbEditForm" class="ajax-input-form" method="POST" action="{{ route('purchase-return.update', $mrn->id) }}"
        data-redirect="/purchase-return" enctype="multipart/form-data">
        @csrf
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="date" name="document_date" class="form-control"
                                                            value="{{ $mrn->document_date }}" readonly>
                                                    </div>
                                                </div>
                                                <div class="row align-items-center mb-1">
                                                    <div class="col-md-3">
...
@section('scripts')
    ...
    <script>
        ...
        function getItemAttribute(itemId, rowCount, selectedAttr, tr) {
            let actionUrl = '{{ route('purchase-return.item.attr') }}' + '?item_id=' + itemId +
        ...
        function onPostVoucherOpen(type = "not_posted") {
            // resetPostVoucher();
            const apiURL = "{{ route('purchase-return.posting.get-history') }}";
            let urlType = 'view';
