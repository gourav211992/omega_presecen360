<div class="modal fade" id="approveModal" tabindex="-1" aria-labelledby="shareProjectTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
       <div class="modal-content">
          <form class="ajax-input-form" method="POST" action="{{ route('document.approval.purchase-return') }}" enctype='multipart/form-data'>
             @csrf
                ...
                <div class="row mt-1">
                   <div class="col-md-12">
                      ...
                      <div class="mb-2">
                         ...
                         <input id="attachments" type="file" name="attachment[]" class="form-control" onchange="addFiles(this, 'pr_popup_file_preview')" multiple>
