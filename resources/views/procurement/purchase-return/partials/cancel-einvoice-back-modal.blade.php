        ...
        <div class="modal-content">
            <form class="ajax-submit-2" method="POST" action="{{ route('purchase-return.cancel-ewaybill') }}" data-redirect="{{ route('purchase-return.index') }}" enctype='multipart/form-data'>
                ...
                <div class="modal-header">
                    <div>
                        <h4 class="modal-title fw-bolder text-dark namefont-sizenewmodal" id="popupTitle">Approve
                            Application</h4>
                    </div>
                    ...
                    <div class="row mt-1">
                        <div class="col-md-12">
                            <div class="mb-1">
                                ...
                                <select class="form-select cannot_disable" name="cancel_reason" id="reasonSelect" disabled="">
