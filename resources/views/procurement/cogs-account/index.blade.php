                                                    ...
                                                    <tbody id="cogsAccountsTable">
                                                        @if($cogsAccounts->isEmpty())
                                                            <tr data-index="0" data-id="">
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <input type="text" class="form-control  mw-100 autocomplete sub_category_name" name="stock_accounts[0][sub_category_name]" placeholder="Enter Group">
                                                        ...
                                                        @foreach($cogsAccounts as $index => $item)
                                                            <tr data-index="{{ $index }}" data-id="{{ $item->id }}">
                                                                ...
                                                                <td>
                                                                    <div class="setup-td-width">
                                                                        <input type="text" class="form-control  mw-100 autocomplete sub_category_name" name="cogs_accounts[{{ $index }}][sub_category_name]" value="{{ $item->subCategory->name ?? '' }}" placeholder="Enter Group">
...
function addRow(clickedRow) {
    ...
    newRow.innerHTML = `
        ...
        <td>
            <div class="setup-td-width">
                <input type="text" class="form-control  mw-100 autocomplete category_name" name="cogs_accounts[${rowIndex}][sub_category_name]" placeholder="Enter Group">  <!-- Changed to cogs_accounts -->
