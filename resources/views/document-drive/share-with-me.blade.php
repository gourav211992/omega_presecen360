        ...
        <div class="content-header row">
            <div class="content-header-left col-md-5 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Shared with me</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('document-drive.shared-with-me') }}">Home</a>
                                </li>
                                @isset($parentFolders)
                                    @foreach ($parentFolders as $parentFolder)
                                        <li class="breadcrumb-item">
                                            <a
                                                href="{{ route('document-drive.shared-with-me', $parentFolder->id) }}">{{ $parentFolder->name }}</a>
                                        </li>
                                    @endforeach
                                @endisset
                                        ...
                                        @forelse ($folders as $folder)
                                            <div class="col-md-3 mngfolder">
                                                <div class="doc-drivebocfolder">
                                                    ...
                                                    <h6
                                                        onclick="window.location.href='{{ route('document-drive.shared-with-me', $folder->id) }}'">
                                                        {{ $folder->name }}</h6>
                                            ...
                                            <tr class="cursor-pointer">
                                                ...
                                                <td class="fw-bolder text-dark">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        @endif
                                                        <span
                                                            onclick="window.location.href='{{ $item->type === 'folder' ? route('document-drive.shared-with-me', $item->id) : route('document-drive.file.show', $item->id) }}'"
    ...
    <div class="modal modal-slide-in fade filterpopuplabel" id="filter">
        <div class="modal-dialog sidebar-sm">
            ...
            <form class="add-new-record modal-content pt-0" method="GET"
                action="{{ route('document-drive.shared-with-me') }}">
