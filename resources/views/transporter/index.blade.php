            ...
            <div class="content-header row">
                ...
                <div class="content-header-right text-sm-end col-md-7 mb-50 mb-sm-0">
                    <div class="form-group breadcrumb-right">
						...
						<a class="btn btn-primary btn-sm mb-50 mb-sm-0" href="{{route('transporter.create', ['type' => request() -> type ? request() -> type : 'tr'])}}"><i data-feather="plus-circle"></i>
                        {{'New Request'}}
                        </a> 
                    </div>
                </div>
...
<script>
    ...
    var columns = [
        ...
        { data: 'pick_up', name: 'pick_up', render: renderData, createdCell: function(td, cellData, rowData, row, col) {
               $(td).addClass('no-wrap');
            }
        },
        { data: 'drop_off', name: 'drop_off', render: renderData, createdCell: function(td, cellData, rowData, row, col) {
               $(td).addClass('no-wrap');
            }
        },
        
        { data: 'bid_end', name: 'bid_end', render: renderData, createdCell: function(td, cellData, rowData, row, col) {
               $(td).addClass('no-wrap');
            }
        },
        { data: 'vehicle_type', name: 'vehicle_type', render: renderData, createdCell: function(td, cellData, rowData, row, col) {
               $(td).addClass('no-wrap');
            }
        },
        { data: 'weight', name: 'weight', render: renderData, createdCell: function(td, cellData, rowData, row, col) {
               $(td).addClass('no-wrap');
            }
        },
        { data: 'loading_time', name: 'loading_time', render: renderData, createdCell: function(td, cellData, rowData, row, col) {
               $(td).addClass('no-wrap');
            }
        },
        { data: 'bid_submitted', name: 'bid_submitted', render: renderData, createdCell: function(td, cellData, rowData, row, col) {
               $(td).addClass('no-wrap');
            }
        },
