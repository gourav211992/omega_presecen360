				...
				<div class="row">
					<div class="content-header-left col-md-6 col-6 mb-2">
						<div class="row breadcrumbs-top">
							<div class="col-12">
								<h2 class="content-header-title float-start mb-0">New Vendor</h2>
								 ...
								 <div class="card-body customernewsection-form"> 
                                                    ...
                                                    <div class="row align-items-center mb-2">
                                                        <div class="col-md-12"> 
                                                            <label class="form-label text-primary"><strong>Stop Billing</strong></label>   
                                                             <div class="demo-inline-spacing">
                                                                <div class="form-check form-check-primary mt-25">
                                                                    <input type="radio" id="customColorRadio5" name="customColorRadio4" class="form-check-input" checked="">
                                                                    <label class="form-check-label fw-bolder" for="customColorRadio5">Yes</label>
                                                                </div> 
                                                                <div class="form-check form-check-primary mt-25">
                                                                    <input type="radio" id="customColorRadio6" name="customColorRadio4" class="form-check-input">
                                                                    <label class="form-check-label fw-bolder" for="customColorRadio6">No</label>
                                                                </div> 
                                                            </div> 
                                                        </div> 
                                                     </div> 
                                                    ...
                                                    <div class="row align-items-center mb-2">
                                                        <div class="col-md-12"> 
                                                            <label class="form-label text-primary"><strong>Stop Purchasing</strong></label>   
                                                             <div class="demo-inline-spacing">
                                                                <div class="form-check form-check-primary mt-25">
                                                                    <input type="radio" id="customColorRadio7" name="Purchasing" class="form-check-input" checked="">
                                                                    <label class="form-check-label fw-bolder" for="customColorRadio7">Yes</label>
                                                                </div> 
                                                                <div class="form-check form-check-primary mt-25">
                                                                    <input type="radio" id="customColorRadio8" name="Purchasing" class="form-check-input">
                                                                    <label class="form-check-label fw-bolder" for="customColorRadio8">No</label>
                                                                </div> 
                                                            </div> 
                                                        </div> 
                                                     </div> 
                                                    ...
                                                    <div class="row align-items-center mb-2">
                                                        <div class="col-md-12"> 
                                                            <label class="form-label text-primary"><strong>Stop Payment</strong></label>   
                                                             <div class="demo-inline-spacing">
                                                                <div class="form-check form-check-primary mt-25">
                                                                    <input type="radio" id="customColorRadio7" name="Payment" class="form-check-input" checked="">
                                                                    <label class="form-check-label fw-bolder" for="customColorRadio7">Yes</label>
                                                                </div> 
                                                                <div class="form-check form-check-primary mt-25">
                                                                    <input type="radio" id="customColorRadio8" name="Payment" class="form-check-input">
                                                                    <label class="form-check-label fw-bolder" for="customColorRadio8">No</label>
                                                                </div> 
                                                            </div> 
                                                        </div> 
											...
											<div class="mt-1">
												<ul class="nav nav-tabs border-bottom mt-25" role="tablist">
													<li class="nav-item">
														<a class="nav-link active" data-bs-toggle="tab" href="#payment">Other Details</a>
													</li>
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#attachment">Address</a>
													</li>
                                                    <li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#Shipping">Add Shipping Addresses</a>
													</li>
                                                    <li class="nav-item">
													...
													<li class="nav-item">
														<a class="nav-link" data-bs-toggle="tab" href="#schedule">India compliances</a>
													</li>
													<li class="nav-item">
												 ...
												 <div class="tab-content pb-1 px-1">
														<div class="tab-pane active" id="payment">
                                                                ...
                                                                <div class="row align-items-center mb-1">
                                                                    ...
                                                                    <div class="col-md-3"> 
                                                                        <div class="form-check form-check-primary mt-25 custom-checkbox">
                                                                            <input type="checkbox" class="form-check-input" id="Related" checked="">
                                                         ...
                                                         <div class="tab-pane" id="Shipping">
                                                            ...
                                                            <a href="#" class="text-primary add-contactpeontxt"><i data-feather='plus'></i> Add New Address</a>
														</div>
                                                     <div class="tab-pane" id="Financial">
														...
														<div class="tab-pane" id="amend">
                                                                ...
                                                                <table class="table myrequesttablecbox table-striped "> 
                                                                    ...
                                                                    <tbody>
                                                                         <tr valign="top">
                                                                            ...
                                                                            <td class="px-1">
                                                                                <a href="#" class="text-danger"><i data-feather="trash-2" class="me-50"></i></a>
                                                                             </td>
                                                                          </tr> 
                                                            ...
                                                            <a href="#" class="text-primary add-contactpeontxt"><i data-feather='plus'></i> Add Contact Person</a>
														</div>
                                                                ...
                                                                <table class="table myrequesttablecbox table-striped "> 
                                                                    ...
                                                                    <tbody>
                                                                         <tr valign="top">
                                                                            ...
                                                                            <td class="px-1">Vendor Info Upadated</td> 
                                                                          </tr> 
