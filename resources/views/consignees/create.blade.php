...
@section('content')
<!-- BEGIN: Content-->
<form class="ajax-input-form" method="POST" action="{{ route('consignees.store') }}" data-redirect="{{ url('/consignees') }}">
    @csrf
                ...
                <div class="row">
                    <div class="content-header-left col-md-6 mb-2">
                        <div class="row breadcrumbs-top">
                            <div class="col-12">
                                <h2 class="content-header-title float-start mb-0">Consignee</h2>
                                        ...
                                        <div class="col-md-9">
                                         <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-5">
                                                    <div class="demo-inline-spacing">
                                                        <div class="form-check form-check-primary mt-25">
                                                            ...
                                                            <input type="checkbox" id="is_vendor" name="is_vendor" value="1" class="form-check-input">
                                                            <label class="form-check-label fw-bolder" for="is_vendor">Vendor</label>
                                                        </div>
                                                        <div class="form-check form-check-primary mt-25">
                                                            <input type="hidden" name="is_customer" value="0">
                                                            <input type="checkbox" id="is_customer" name="is_customer" value="1" class="form-check-input">
                                                            <label class="form-check-label fw-bolder" for="is_customer">Customer</label>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="consignee_name" class="form-control" placeholder="Enter Consignee Name" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="consignee_code" class="form-control" placeholder="Enter Consignee Code" />
                                                </div>
                                            </div>
