...
<script>
   $(function() {
      // Initialize DataTable with proper configuration like book table
      $('#maint-wo-table').DataTable({
         processing: true,
         serverSide: true,
         ...
         columns: [
            ...
            { data: 'equipment_name', name: 'equipment_details', orderable: false },
            { data: 'equipment_category', name: 'equipment_details', orderable: false, className: 'text-nowrap' },
            { data: 'equipment_maintenance_type', name: 'equipment_details', orderable: false, className: 'text-nowrap' },
            { data: 'status', name: 'document_status', orderable: false, searchable: false, className: 'tableactionnew text-end' },
            { data: 'action', name: 'action', orderable: false, searchable: false, className: 'text-center' }
         ],
         order: [], // Let server-side handle default ordering by created_at
