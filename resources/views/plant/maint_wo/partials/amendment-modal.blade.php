            ...
            <div class="row mt-1">
               <div class="col-md-12">
                  ...
                  <div class="mb-2">
                     ...
                     <input type="file" onchange="addFiles(this, 'maint_wo_popup_file_preview')" name="amend_attachment[]" multiple class="form-control" />
                     <span class = "text-primary small">{{__("message.attachment_caption")}}</span>
                  </div>
                  <div class="mt-2">
                      <div class="row" id="maint_wo_popup_file_preview">
                      </div>
                  </div>
               </div>
            </div>
