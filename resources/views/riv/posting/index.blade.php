    ...
    <div class="content-wrapper container-xxl p-0">
        <div class="content-header row">
            ...
            <div class="content-header-right text-sm-end col-md-7 mb-50 mb-sm-0">
                <button class="btn btn-primary btn-sm mb-50 mb-sm-0" onclick ='BulkAction();' ><i data-feather = 'layers'></i> Bulk Posting</button> 
...
<div class="modal fade" id="bulkResultModal" tabindex="-1" aria-labelledby="bulkResultModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header" style="position: sticky; top: 0; z-index: 1055; background: #fff;">
                <h5 class="modal-title" id="bulkResultModalLabel">Bulk Action Result</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <ul class="nav nav-tabs" id="bulkResultTabs" role="tablist" style="position: sticky; top: 56px; z-index: 1054; background: #fff;">
                ...
                <div class="tab-content mt-2" id="bulkResultTabsContent">
                    <div class="tab-pane fade show active" id="success" role="tabpanel" aria-labelledby="success-tab">
                        <div style="max-height: 300px; overflow-y: auto;">
                            <table class="table table-bordered pomrnheadtffotsticky">
                                <thead>
                                    <tr>
                                        <th>Document Type</th>
                                        <th>Document ID</th>
...
function BulkAction() {
    ...
    let actionType = 'post'; // Set the action type for bulk posting
    $.ajax({
        url: "{{ route('bulk.postings') }}",
        type: "POST",
        data: {
            ids: selectedIds,
            actionType: "post",
        ...
        success: function(response) {
            ...
            $('#bulkResultBodySuccess').html(successRows || '<tr><td colspan="4" class="text-center">No Success Records</td></tr>');
            $('#bulkResultBodyFailure').html(failureRows || '<tr><td colspan="4" class="text-center">No Failure Records</td></tr>');
