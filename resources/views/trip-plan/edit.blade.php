                    ...
                    <table class="table myrequesttablecbox table-striped po-order-detail custnewpo-detail border newdesignerptable newdesignpomrnpad">
                        <thead>
                            <tr>
                                ...
                                <th class="numeric-alignment">planned Qty</th>
                            ...
                            @if (isset($order))
                                ...
                                @foreach ($order->items as $orderItemIndex => $orderItem)
                                    <tr id="item_row_{{$orderItemIndex}}" class="item_header_rows" onclick="onItemClick('{{$orderItemIndex}}');" data-detail-id="{{$orderItem->id}}" data-id="{{$orderItem->id}}">
                                        ...
                                        <td class="numeric-alignment">
                                            <input type="text" id="item_qty_{{$orderItemIndex}}" value="{{ $order->document_status !== 'approved' && $order->document_status !== 'approval_not_required' ? 0.00 : $orderItem->planned_qty }}" name="item_planned_qty[{{$orderItemIndex}}]" class="form-control mw-100 text-end" readonly>
                                        </td>
                                        <td class="numeric-alignment">
