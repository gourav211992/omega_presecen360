        ...
        <div class="content-header row">
            <div class="content-header-left col-md-5 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Service Master</h2>
                                ...
                                <table class="datatables-basic table myrequesttablecbox">
                                    ...
                                    <tbody>
                                        @foreach($services as $index => $service)
                                            <tr>
                                                <td>{{ $index + 1 }}</td>
                                                <td class="fw-bolder text-dark">{{ $service->company?->name}}</td>
                                                <td class="fw-bolder text-dark">{{ $service->organization?->alias ?? $service -> organization->name }}</td>
                                                <td class="fw-bolder text-dark">{{ $service->name }}</td>
                                                <td class="fw-bolder text-dark">{{ $service->alias }}</td>
                                                <td>
                                                    <span
                                                        class="badge rounded-pill badge-light-{{ strtolower($service->status) === 'active' ? 'success' : 'danger' }} badgeborder-radius">
                                                        {{ $service->status }}
                                                    </span>
                                                </td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item"
                                                                href="{{ route('org-service.edit',$service->id)}}">
