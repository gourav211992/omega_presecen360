<div class="modal fade" id="approveModal" tabindex="-1" aria-labelledby="shareProjectTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form class="ajax-input-form" id="approve-scrap" method="POST" action="{{ route('document.approval.scrap') }}" data-redirect="{{ route('scrap.index') }}" enctype='multipart/form-data'>
                @csrf
                    ...
                    <div class="row mt-1">
                        <div class="col-md-12">
                            ...
                            <div class="mb-2">
                                ...
                                <input id="attachments" type="file" name="attachment[]" class="form-control" onchange="addFiles(this, 'scrap_popup_file_preview')" multiple>
                                <span class = "text-primary small">{{ __('message.attachment_caption') }}</span>
                            </div>
                            <div class="mt-2">
                                <div class="row" id="scrap_popup_file_preview">
                                </div>
                            </div>
                        </div>
                    </div>
