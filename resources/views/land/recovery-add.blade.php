                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" id="khasara-no" name="khasara_no"
                                                            value="{{ old('khasara_no') }}" class="form-control" readonly>
                                                        @error('khasara_no')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" id="area-sqft" name="area_sqft"
                                                            value="{{ old('area_sqft') }}" class="form-control" readonly>
                                                        @error('area_sqft')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" id="plot-details" name="plot_details"
                                                            value="{{ old('plot_details') }}" class="form-control"
                                                            readonly>
                                                        @error('plot_details')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" id="pincode" name="pincode"
                                                            value="{{ old('pincode') }}" class="form-control" readonly>
                                                        @error('pincode')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" id="cost" name="cost"
                                                            value="{{ old('cost') }}" class="form-control" readonly>
                                                        @error('cost')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" id="lease_time" name="lease_time"
                                                            value="{{ old('lease_time') }}" class="form-control"
                                                            readonly>
                                                        @error('lease_time')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" id="lease_cost" name="lease_cost"
                                                            value="{{ old('lease_cost') }}" class="form-control"
                                                            readonly>
                                                        @error('lease_cost')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" id="bal_lease_cost" name="bal_lease_cost"
                                                            value="{{ old('bal_lease_cost') }}" class="form-control"
                                                            readonly>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="number" name="received_amount" required
                                                            value="{{ old('received_amount') }}" class="form-control"
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" name="reference_no"
                                                            value="{{ old('reference_no') }}" onchange="cleanInput(this)"
                                                ...
                                                <div class="row align-items-center mb-1 bankdetail">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" name="bank_name"
                                                            value="{{ old('bank_name') }}" onchange="cleanInput(this)"
                                                ...
                                                <div class="row  mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" name="remarks"
                                                            value="{{ old('remarks') }}" class="form-control"
                                                            maxlength="250">
                                                        @error('remarks')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
