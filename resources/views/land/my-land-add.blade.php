...
@endif
    ...
    <form id="land-form" method="POST" action="{{ route('save.land') }}">
    @csrf
    <div class="row">
        <!-- Left Column -->
        <div class="col-md-5">
            ...
            <div class="row align-items-center mb-1">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control" name="land_no" value="{{ old('land_no') }}" onchange="cleanInput(this)" required>
                    @error('land_no')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row align-items-center mb-1">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control" name="plot_no" value="{{ old('plot_no') }}" onchange="cleanInput(this)" required>
                    @error('plot_no')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row align-items-center mb-1">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control" name="area" value="{{ old('area') }}" onchange="cleanInput(this)" required>
                    @error('area')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row align-items-center mb-1">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control" name="address" id="address" placeholder=" " value="{{ old('address') }}" onchange="cleanInput(this)" required>
                    @error('address')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row align-items-center mb-1">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control" name="pincode" id="pincode" value="{{ old('pincode') }}" onchange="validatePincode(this)" required min="6" max="7">
                    @error('pincode')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row align-items-center mb-1">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control" name="latitude" id="latitude" value="{{ old('latitude') }}" readonly required tabindex="0">
                    @error('latitude')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row align-items-center mb-1">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control" name="longitude" id="longitude" value="{{ old('longitude') }}" readonly required tabindex="0">
                    @error('longitude')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row align-items-center mb-1">
                ...
                <div class="col-md-8">
                    <input type="text" class="form-control" name="cost" value="{{ old('cost') }}" onchange="cleanInputNumber(this)" >
                    @error('cost')
                        <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-1">
                ...
                <div class="col-md-8">
                    <textarea class="form-control" name="remarks" rows="4" maxlength="250" placeholder="Enter Remarks here...">{{ old('remarks') }}</textarea>
                </div>
            </div>
        </div>
                ...
                <div class="demo-inline-spacing">
                    <div class="form-check form-check-primary mt-25">
                        <input type="radio" id="active" name="status" class="form-check-input" value="active" 
                            {{ old('status') == 'active' ? 'checked' : '' }} required checked>
...
@section('scripts')
    ...
    if (pincode.length < 6 || pincode.length > 7 || !/^\d+$/.test(pincode)) {
        alert("Pincode must be between 6 and 7 digits and contain only numbers.");
...
window.addEventListener('load', function() {
    var map = new google.maps.Map(document.getElementById('map'), {
        zoom: 8,
        center: { lat: 28.501851443923478, lng: 77.39757531317296 },
    });
    ...
    var marker = new google.maps.Marker({
        position: { lat: 28.501851443923478, lng: 77.39757531317296 }, // Initial position
        map: map,
