                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <select class="form-select" name="book_id" onchange="getDocNumberByBookId()" id="series">
                                                            <option value="">Select</option>
                                                            @foreach ($book_type as $data)
                                                                <option value="{{ $data->id }}" {{ old('book_id') == $data->id ? 'selected' : '' }}>
                                                                    {{ $data->book_name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="text" class="form-control" name="document_no" id="document_no" 
                                                            value="{{ old('document_no') }}" readonly>
                                                        @error('document_no')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="date" onchange="getDocNumberByBookId()" class="form-control" 
                                                            name="document_date" id="document_date" 
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="mb-1">
                                                            ...
                                                            <select class="form-select select2 customer" name="customer_id" id="customer">
                                                                <option value="">Select</option>
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="mb-1">
                                                            ...
                                                            <input type="hidden" name="currency_id" id="currency" value="{{ old('currency_id') }}" />
                                                            <input type="text" class="form-control" id="currency_name" readonly 
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="mb-1">
                                                            ...
                                                            <input type="text" class="form-control" readonly id="exchange_rate_amount" 
                                                                value="{{ old('exchange_rate_amount') }}" />
                                                        </div>
                                                        @error('exchage_rate')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="mb-1">
                                                            <label class="form-label w-100">Billing Address <span class="text-danger">*</span> 
                                                                <a href="#edit_address_model" data-bs-toggle="modal" class="float-end font-small-2">
                                                                    <i data-feather='edit-3'></i> Edit
                                                                </a>
                                                            </label>
                                                            <input type="text" class="form-control" readonly id="billing_address" 
                                        ...
                                        <div class="card quation-card">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="mb-1">
                                                            <label class="form-label">Select Land Parcel <span class="text-danger">*</span></label>
                                                            <select class="form-select select2" name="land" id="land">
                                                                <option value="">Select</option>
                                                                @foreach ($lands as $land)
                                                                    <option value="{{ $land->id }}" 
                                                                        data-sizeland="{{ $land->plot_area }}" 
                                                                        data-landaddress="{{ $land->address . ', ' . $land->district . ', ' . $land->state . ', ' . $land->pincode }}"
                                                                        {{ old('land') == $land->id ? 'selected' : '' }}>
                                                                        {{ $land->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-md-2 action-button mt-25">
                                                        <button data-bs-toggle="modal" type="button" data-bs-target="#land_details_model"
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="mb-1">
                                                            ...
                                                            <input type="text" readonly class="form-control" id="land_size" 
                                                                name="land_size" value="{{ old('land_size') }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="mb-1">
                                                            ...
                                                            <input type="text" readonly class="form-control" id="land_location" 
                                                                name="land_location" value="{{ old('land_location') }}">
                                                        </div>
                                                    </div>
                                                                            ...
                                                                            <td class="agreemformlease">
                                                                                <div class="row">
                                                                                    <div class="col-md-3 mb-1">
                                                                                        <label class="form-label">Agreement No <span class="text-danger">*</span></label>
                                                                                        <input type="text" name="agreement_no" class="form-control" required value="{{ old('agreement_no') }}">
                                                                                    </div>
                                                                    
                                                                                    <div class="col-md-3 mb-1">
                                                                                        <label class="form-label">Lease Time (Yrs) <span class="text-danger">*</span></label>
                                                                                        <input type="number" id="leaseTime" name="lease_time" class="form-control" 
                                                                                            placeholder="Enter lease time in years" required value="{{ old('lease_time') }}">
                                                                                    </div>
                                                                    
                                                                                    <div class="col-md-3 mb-1">
                                                                                        <label class="form-label">Lease Start Date <span class="text-danger">*</span></label>
                                                                                        <input type="date" id="leaseStartDate" name="lease_start_date" class="form-control" 
                                                                                            value="{{ old('lease_start_date', date('Y-m-d')) }}" required>
                                                                                    </div>
                                                                    
                                                                                    <div class="col-md-3 mb-1">
                                                                                        <label class="form-label">Lease End Date</label>
                                                                                        <input type="date" id="leaseEndDate" name="lease_end_date" readonly class="form-control"
                                                                                            value="{{ old('lease_end_date') }}">
                                                                                    </div>
                                                                    
                                                                                    <div class="col-md-3 mb-1">
                                                                                        <label class="form-label">Repayment Period Type <span class="text-danger">*</span></label>
                                                                                        <select class="form-select" name="repayment_period_type" id="repayment_period_type" required>
                                                                                            <option disabled selected>Select</option>
                                                                                            <option value="monthly" {{ old('repayment_period_type') == 'monthly' ? 'selected' : '' }}>Monthly</option>
                                                                                            <option value="quarterly" {{ old('repayment_period_type') == 'quarterly' ? 'selected' : '' }}>Quarterly</option>
                                                                                            <option value="yearly" {{ old('repayment_period_type') == 'yearly' ? 'selected' : '' }}>Yearly</option>
                                                                                        </select>
                                                                                    </div>
                                                                    
                                                                                    <div class="col-md-3 mb-1">
                                                                                        <label class="form-label">Repayment Period <span class="text-danger">*</span></label>
                                                                                        <input type="number" readonly id="repaymentPeriod" name="repayment_period" class="form-control"
                                                                                    ...
                                                                                    <div class="col-md-3 mb-1">
                                                                                        ...
                                                                                        <div class="demo-inline-spacing">
                                                                                            <div class="form-check form-check-primary mt-25">
                                                                                                <input type="radio" id="customColorRadio3" name="deposit_refundable"
                                                                                                    class="form-check-input" value="1"
                                                                                                    {{ old('deposit_refundable', '1') == '1' ? 'checked' : '' }}>
                                                                                                <label class="form-check-label fw-bolder" for="customColorRadio3">Yes</label>
                                                                                            </div>
                                                                                            <div class="form-check form-check-primary mt-25">
                                                                                                <input type="radio" id="customColorRadio4" name="deposit_refundable"
                                                                                                    class="form-check-input" value="0"
                                                                                                    {{ old('deposit_refundable') == '0' ? 'checked' : '' }}>
                                                                                                <label class="form-check-label fw-bolder" for="customColorRadio4">No</label>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="col-md-3 mb-1">
                                                                                        <label class="form-label">Lease Increment %</label>
                                                                                        <input type="text" class="form-control" name="lease_increment"
                                                                                            value="{{ old('lease_increment') }}">
                                                                                    </div>
                                                                    
                                                                                    <div class="col-md-3 mb-1">
                                                                                        <label class="form-label">Lease Increment Duration (Yrs)</label>
                                                                                        <input type="text" class="form-control" name="lease_increment_duration"
                                                                                            value="{{ old('lease_increment_duration') }}">
                                                                                    </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-3 mb-1">
                                                                                        ...
                                                                                        <input type="text" class="form-control" id="lateFeePercentage" name="late_fee"
                                                                                            value="{{ old('late_fee') }}">
                                                                                    </div>
                                                                    
                                                                                    <div class="col-md-3 mb-1">
                                                                                        <label class="form-label">Late Fee Value</label>
                                                                                        <input type="text" class="form-control" id="lateFeeValue" name="late_fee_value"
                                                                                            value="{{ old('late_fee_value') }}">
                                                                                    </div>
                                                                    
                                                                                    <div class="col-md-3 mb-1">
                                                                                        <label class="form-label">Late Fee Duration (Days)</label>
                                                                                        <input type="text" class="form-control" name="late_fee_duration"
                                                                                            value="{{ old('late_fee_duration') }}">
                                                                                        <input type="hidden" class="form-control" id="lease_sub_total" name="sub_total_amount"
                                                                                            value="{{ old('sub_total_amount') }}">
                                                                                        <input type="hidden" class="form-control" id="lease_other_charges" name="lease_other_charges"
                                                                                            value="{{ old('lease_other_charges') }}">
                                                                                        <input type="hidden" class="form-control" id="lease_extra_charges" name="lease_extra_charges"
                                                                                            value="{{ old('lease_extra_charges') }}">
                                                                                        <input type="hidden" class="form-control" id="lease_extra_charges_json" name="lease_extra_charges_json"
                                                                                            value="{{ old('lease_extra_charges_json') }}">
                                                                                        <input type="hidden" class="form-control" id="tax_amount" name="tax_amount"
                                                                                            value="{{ old('tax_amount') }}">
                                                                                        <input type="hidden" class="form-control" id="lease_installment_cost" name="lease_installment_cost"
                                                                                            value="{{ old('lease_installment_cost') }}">
                                                                                        <input type="hidden" class="form-control" id="lease_total_installment" name="total_amount"
