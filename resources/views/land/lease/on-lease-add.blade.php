                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body customernewsection-form">
                                    ...
                                    <form action="{{ route('save.lease') }}" id="lease-form" method="POST"
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" class="form-control" id="leaseno"
                                                            name="lease_no" required readonly onchange="cleanInput(this)"
                                                            value="{{ old('lease_no') }}">
                                                        @error('lease_no')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <select class="form-select select2" name="land_no" id="land-no"
                                                            required>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" id="cost" name="cost"
                                                            class="form-control" readonly value="{{ old('cost') }}">
                                                        @error('cost')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="number" name="lease_time" class="form-control"
                                                            required id="lease_time" value="{{ old('lease_time') }}"
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" name="lease_cost" id="lease_cost"
                                                            class="form-control" required value="{{ old('lease_cost') }}"
                                                            onchange="cleanInputNumber(this)"
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="number" name="repayment_period"
                                                            id="repayment_period" class="form-control" required readonly
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" name="installment_cost"
                                                            id="installment_cost" onchange="cleanInputNumber(this)"
                                                ...
                                                <div class="row mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" name="agreement_no" class="form-control"
                                                            maxlength="250" required value="{{ old('agreement_no') }}">
                                                        @error('agreement_no')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
                                                ...
                                                <div class="row mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="date" name="date_of_agreement"
                                                            value="{{ old('date_of_payment') }}" required
                                                            class="form-control">
                                                ...
                                                <div class="row mb-1">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" name="remarks" class="form-control"
                                                            maxlength="250" value="{{ old('remarks') }}">
                                                        @error('remarks')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 1000px">
            <div class="modal-content">
                <div class="modal-header">
                    <div>
                        <h4 class="modal-title fw-bolder text-dark namefont-sizenewmodal" id="myModalLabel17">Land Details</h4>
