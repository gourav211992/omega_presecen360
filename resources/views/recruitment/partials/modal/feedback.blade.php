<div class="modal fade" id="feedback" tabindex="-1" aria-labelledby="shareProjectTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form role="feedback" method="POST" id="status-form" action="{{ route('recruitment.jobs-interviews.feedback') }}" reload="true">
                <div class="modal-body px-sm-4 mx-50 pb-2">
                    ...
                    <div class="row mt-2"> 
                        ...
                        <div class="col-md-12 mb-1">
                            <label class="form-label" for="select2-basic">Rating <span class="text-danger">*</span></label>
                            <select class="select2 form-select" id="select2-basic" name="rating">
                        ...
                        <div class="col-md-12 mb-1">
                            <label class="form-label" for="select2-basic">Behavior <span class="text-danger">*</span></label>
                            <select class="select2 form-select" id="select2-basic" name="behavior">
                                <option value="">Select</option>
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
                        ...
                        <div class="col-md-12 mb-1">
                            <label class="form-label" for="select2-basic">Skills <span class="text-danger">*</span></label>
                            <select class="select2 form-select" id="select2-basic" name="skills">
                                <option value="">Select</option>
                                <option value="1">1</option>
                                <option value="2">2</option>
                                <option value="3">3</option>
