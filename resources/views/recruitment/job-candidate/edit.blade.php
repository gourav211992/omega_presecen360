    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
            <form class="form" role="post-data" method="POST"
                action="{{ url('recruitment/job-candidates/' . $jobCandidate->id) }}"
                redirect="{{ route('recruitment.job-candidates') }}">
                @csrf
                @method('PUT')
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <select class="form-select select2" name="education_id">
                                                            <option value=""
                                                                {{ $jobCandidate->education_id == '' ? 'selected' : '' }}>
                                                                Select</option>
                                                            @forelse ($educations as $education)
                                                                <option value="{{ $education->id }}"
                                                                    {{ $jobCandidate->education_id == $education->id ? 'selected' : '' }}>
                                                                    {{ $education->name }}
                                                                </option>
                                                            @empty
                                                            @endforelse
                                                        ...
                                                        <select class="form-select select2" id="skill" name="skill[]"
                                                            ...
                                                            @foreach ($skills as $skill)
                                                                <option value="{{ $skill->name }}"
                                                                    {{ in_array($skill->id, $candidateSkills) ? 'selected' : '' }}>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="text" class="form-control numberonly-v2"
                                                            name="work_exp" value="{{ $jobCandidate->work_exp }}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="text" class="form-control"
                                                            ...
                                                            value="{{ $jobCandidate->current_organization }}" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <select class="form-control select2" id="location_id"
                                                            name="location_id">
                                                            <option value=""
                                                                {{ $jobCandidate->location_id == '' ? 'selected' : '' }}>
                                                                Select Experience</option>
                                                            @foreach ($locations as $location)
                                                                <option value="{{ $location->id }}"
                                                                    {{ $jobCandidate->location_id == $location->id ? 'selected' : '' }}>
                                                        ...
                                                        <div class="demo-inline-spacing">
                                                            <div class="form-check form-check-primary mt-25">
                                                                <input type="radio" id="customColorRadio3"
                                                                    ...
                                                                    {{ $jobCandidate->status == 'active' ? 'selected' : '' }}>
                                                            ...
                                                            <div class="form-check form-check-primary mt-25">
                                                                <input type="radio" id="customColorRadio4"
                                                                    ...
                                                                    {{ $jobCandidate->status == 'inactive' ? 'selected' : '' }}>
                                                                <label class="form-check-label fw-bolder"
                                                        ...
                                                        <div class="demo-inline-spacing">
                                                            <div class="form-check form-check-primary mt-25">
                                                                <input type="radio" id="Yes"
                                                                    ...
                                                                    value="high"
                                                                    {{ $jobCandidate->potential_type == 'high' ? 'checked' : '' }}>
                                                                <label class="form-check-label fw-bolder"
                                                                    for="Yes">High</label>
                                                            </div>
                                                            <div class="form-check form-check-primary mt-25">
                                                                <input type="radio" id="No"
                                                                    ...
                                                                    {{ $jobCandidate->potential_type == 'medium' ? 'checked' : '' }}>
                                                                <label class="form-check-label fw-bolder"
                                                                    for="No">Medium</label>
                                                            </div>
                                                            <div class="form-check form-check-primary mt-25">
                                                                <input type="radio" id="Low"
                                                                    name="potential_type" class="form-check-input"
                                                                    value="low"
                                                                    {{ $jobCandidate->potential_type == 'low' ? 'checked' : '' }}>
                                                                <label class="form-check-label fw-bolder"
                                                                    for="Low">Low</label>
                                                            </div>
                                                        </div>
