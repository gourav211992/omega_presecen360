            ...
            <div class="row">
                <div class="content-header-left col-md-6 col-6 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">New Shelf</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('/') }}">Home</a></li>
                                    <li class="breadcrumb-item"><a href="{{ route('shelves') }}">Shelf</a></li>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body customernewsection-form">
                                <form id="rack-form" method="POST" action="{{ route('shelves.store') }}">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="shelf_code"  value="{{ old('shelf_code') }}"   class="form-control" required />
                                                    @error('shelf_code')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="row align-items-center mb-1">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="shelf_name"  value="{{ old('shelf_name') }}"  class="form-control" required />
                                                    @error('shelf_name')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
