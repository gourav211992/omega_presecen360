<div class="modal fade" id="canceEInvoiceModal" tabindex="-1" aria-labelledby="shareProjectTitle" aria-hidden="true">
   <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <form class="ajax-submit-2" method="POST" action="{{ route('sales.cancel.e-invoice') }}" data-redirect="{{ $redirect_url }}" enctype='multipart/form-data'>
          @csrf
          <input type="hidden" name="id" id="si_cancel_invoice_id">
         ...
         <div class="modal-body pb-2">
            <div class="row mt-1">
               <div class="col-md-12">
                  ...
                  <span class = "text-primary small"><strong>Note: </strong>E-Way Bill will be auto-cancelled if not already cancelled</span>
               </div>
            </div>
         </div>
