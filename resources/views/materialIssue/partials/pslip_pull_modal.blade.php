<div class="modal fade text-start" id="rescdulePslip" tabindex="-1" aria-labelledby="header_pull_label" aria-hidden="true">
                ...
                <div class="col">
                    ...
                    <div class="col">
                        <div class="mb-1">
                            ...
                            <input type="text" id="so_no_input_pslip" placeholder="Select"
                                class="form-control mw-100 ledgerselecct ui-autocomplete-input" autocomplete="off"
                                value="">
                            <input type="hidden" id="so_id_pslip_val"></input>
                        </div>
                    </div>
                    <div class="col">
                        <div class="mb-1">
                            <label class="form-label">Item Name/Code </label>
                            <input type="text" id="item_name_input_pslip" placeholder="Select"
                                class="form-control mw-100 ledgerselecct ui-autocomplete-input" autocomplete="off"
                                value="">
                            <input type="hidden" id="item_id_pslip_val"></input>
                        </div>
                    </div>
                    <div class="col">
                        <div class="mb-1">
                    ...
                    <div class="col  mb-1">
                        ...
                        <button onclick="clearFilters('pslip');" type="button" class="btn btn-danger btn-sm"><i
                                data-feather="trash"></i> Clear</button>
                    </div>
                    <div class="col-md-12">
                        <div class="table-responsive">
                            <table class="dataTables_scroll datatables-basic table-sm table-bordered table myrequesttablecbox pomrnheadtffotsticky" id="pslip_orders_table"> 
                                <thead>
                                    <tr>
                                        <th>
