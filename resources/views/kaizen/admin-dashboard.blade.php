                    ...
                    <div class="row match-height">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col-md-12">
                                            <canvas id="myChart" class="chartjs" data-height="265"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                <table class="table border payrollconfigured customerdataapp text-center" id="statausWiseKaizen">
                                        <thead>
                                            <tr>
                                                <th>UNIT</th>
                                                <th>PENDING</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            function initializeAutocomplete(from_date = null, to_date = null) {
                const url = "{{ route('kaizen.get-admin-dashboard') }}";
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        let kaizenStats = data.kaizenStats;
                        $("#statausWiseKaizen tbody").empty();
                        $.each(kaizenStats, function(i, unitKaizen) {
                            let newRow = `
                            <tr>
                                <td>${i}</td>
                                <td>${unitKaizen.pending}</td>
                                <td>${unitKaizen.approved}</td>
                            </tr>
                            `;
                            $("#statausWiseKaizen tbody").append(newRow);
                        });

                        barchart(data);
                        // const chartData = {
                        //         organiation: ['GNA','KLM','SIP','ERD','HYD','C','BBSR','D3','GWL','NGM','TWD'],
                        //         kaizen_count: [10,6,8,4,8,3,8,5,8,5,5],
                        //         sumValue: [10000,12000,15000,8000,10000,12000,15000,8000,12000,10000,15000]
                        //     };
                        const chartData=data.secondChart;
                        SecondBarChart(chartData);
        ...
        function SecondBarChart(chartData) {
            console.log(chartData);
            const data = {
                labels: chartData.organiation, // example: ['GNA','KLM','SIP',...]
                datasets: [
                    {
                        label: 'Kaizen',
                        type: 'bar',
                        data: chartData.kaizen_count, // example: [10,6,8,...]
                    ...
                    },
                    {
                        label: 'Amount',
                        type: 'line',
                        data: chartData.sumValue, // example: [10000,12000,15000,...]
                    ...
                    yAxes: [
                        {
                            ...
                            scaleLabel: { display: true, labelString: 'No of Kaizen' }
                        },
                        {
                            id: 'y-right',
                            type: 'linear',
                            ...
                            gridLines: { drawOnChartArea: false } // avoid grid overlap
                        }
                    ]
                },
