            ...
            <div class="content-header">
                <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <div class="breadcrumb-wrapper">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active">Public Outreach List</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="content-header-right text-end col-md-6 col-6 mb-2 mb-sm-0">
                        ...
                        <a class="btn btn-primary btn-sm" href="{{ route('public-outreach.create') }}"><i data-feather="plus-circle"></i> Add New</a>
                    </div>
                </div>
            </div>
        ...
        $(document).ready(function() {
            ...
            if (dt_basic_table.length) {
                var dt_basic = dt_basic_table.DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('public-outreach.index') }}",  // Ajax route to fetch data
                    columns: [
            ...
            $(".apply-filter").on("click", function () {
                ...
                dt_basic.ajax.url("{{ route('public-outreach.index') }}?date_range=" + dateRange + "&customer_name=" + customerName + "&interaction_type=" + interactionType).load();
                $(".modal").modal("hide");
            });
        });
    </script>
