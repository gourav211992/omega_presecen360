...
@section('content')
    <!-- BEGIN: Content-->
    <form class="ajax-input-form" method="POST" action="{{ route('public-outreach.store') }}" data-redirect="{{ url('/public-outreach') }}">
        @csrf
                    ...
                    <div class="row">
                        <div class="content-header-left col-md-6 col-6 mb-2">
                            <div class="row breadcrumbs-top">
                                <div class="col-12">
                                    <h2 class="content-header-title float-start mb-0">Public Outreach And Communication</h2>
                                    <div class="breadcrumb-wrapper">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="{{ route('public-outreach.index') }}">Home</a></li>
                                            <li class="breadcrumb-item active">Public Outreach</li>
                                        </ol>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center mb-1">
                                            ...
                                            <div class="col-md-5">
                                                <textarea class="form-control" name="outcomes" placeholder=""></textarea>
                                            </div>
                                            @error('outcomes')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
