        ...
        <div class="content-header row">
            <div class="content-header-left col-md-6 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Application for Sansaction Letter</h2>
        ...
        if (dt_basic_table.length) {
            var dt_basic = dt_basic_table.DataTable({
                processing: true,
                    serverSide: true,
                    ajax: {
                        url: "{{ route('loanSanctionLetter.index') }}",
                        data: function(d) {
                            d.date = $("#fp-range").val(),
                ...
                buttons: [{
                        ...
                        buttons: [{
                            ...
                            },
                            {
                                    ...
                                    filename: 'Loan Sancation Letter Report',
                                    title: 'Loan Sancation Letter Report'
                                },
                                {
                                    extend: 'excel',
