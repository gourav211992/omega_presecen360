            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Application for Legal Doc</h2>
        ...
        $(function() {
            ...
            if (dt_basic_table.length) {
                var dt_basic = dt_basic_table.DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('loanLegalDocumentation.index') }}",
                        data: function(d) {
                            d.date = $("#fp-range").val(),
                    ...
                    buttons: [{
                            ...
                            buttons: [{
                                ...
                                },
                                {
                                    ...
                                    filename: 'Loan Legal Documentation Report',
                                    title: 'Loan Legal Documentation Report'
                                },
                                {
                                    extend: 'excel',
