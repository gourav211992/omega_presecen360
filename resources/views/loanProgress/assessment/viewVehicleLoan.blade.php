                                    ...
                                    <div class="card-body customernewsection-form">
                                        ...
                                        <div class="text-center new-applicayion-help-txt  mb-1 pb-25">
                                            ...
                                            <h6 class="mt-2">({{ $vehicleLoan->name ?? 'N/A' }} |
                                                ...
                                                {{ $overview->created_at->format('d-m-Y') ?? $vehicleLoan->created_at->format('d-m-Y') }})
                                            </h6>
                                        </div>
...
<div class="modal fade" id="reject" tabindex="-1" aria-labelledby="shareProjectTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <div>
                    <h4 class="modal-title fw-bolder text-dark namefont-sizenewmodal" id="myModalLabel17">Reject Vehicle
                        Loan Application</h4>
                    <p class="mb-0 fw-bold voucehrinvocetxt mt-0">
                                            ({{ $vehicleLoan->name ?? 'N/A' }} |
                                                {{ $overview->term_loan ?? 'N/A' }} |
                                                {{ $overview->created_at->format('d-m-Y') ?? $vehicleLoan->created_at->format('d-m-Y') }})
                                            </p>
                </div>
...
<div class="modal fade" id="return" tabindex="-1" aria-labelledby="shareProjectTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <div>
                    <h4 class="modal-title fw-bolder text-dark namefont-sizenewmodal" id="myModalLabel17">Return Vehicle
                        Loan Application</h4>
                    <p class="mb-0 fw-bold voucehrinvocetxt mt-0">({{ $vehicleLoan->name ?? 'N/A' }} |
                                                {{ $overview->term_loan ?? 'N/A' }} |
                                                {{ $overview->created_at->format('d-m-Y') ?? $vehicleLoan->created_at->format('d-m-Y') }})
