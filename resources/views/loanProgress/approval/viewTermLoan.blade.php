                    ...
                    <div class="content-header-right text-sm-end col-md-6 mb-50 mb-sm-0">
                        <div class="form-group breadcrumb-right">
                            <button onClick="javascript: history.go(-1)"
                                ...
                                class="btn btn-danger btn-sm mb-50 mb-sm-0"><i data-feather="refresh-cw"></i>
                                Reject</button>
                                @endif
                                @if ($buttons['approve'])
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>1</td>
                                                        <td>Date</td>
                                                        <td>{{$overview?explode(' ',$overview->created_at)[0]:'N/A'}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>2</td>
                                                        <td>Name of Unit</td>
                                        ...
                                        <div class="row">
                                            <div class="col-md-9">
                                                ...
                                                <div class="row align-items-center mb-1">
                                                    ...
                                                    <div class="col-md-5">
                                                        <input type="number" name="loan_amount" value="{{ old('loan_amount', $termLoan->loan_amount ?? '') }}" class="form-control" />
                                                        @error('loan_amount')
                                                            <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="number" name="Address[registered_offc_tele]"
                                                                        value="{{ old('Address.registered_offc_tele', $termLoan->termLoanAddress->registered_offc_tele ?? '') }}" class="form-control" />
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="number" name="Address[factory_tele]"
                                                                        value="{{ old('Address.factory_tele', $termLoan->termLoanAddress->factory_tele ?? '') }}" class="form-control" />
                                                            ...
                                                            <div class="row align-items-center mb-1">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <input type="number" name="Address[factory_mobile]"
                                                                        value="{{ old('Address.factory_mobile', $termLoan->termLoanAddress->factory_mobile ?? '') }}" class="form-control" />
                ...
                <div class="modal-header">
                    <div>
                        ...
                        <p class="mb-0 fw-bold voucehrinvocetxt mt-0">({{ $termLoan->name ?? 'N/A' }} |
                                                {{ $overview->term_loan ?? $termLoan->loan_amount }} |
                                                {{ $overview->update_at ?? $termLoan->created_at ? $termLoan->created_at->format('d-m-Y') : 'N/A' }})
                                            </p>
                    </div>
                            ...
                            <div class="mb-1">
                                ...
                                @foreach ($behalf_users as $behalf_user)
                                    <option value="{{ $behalf_user->name }}" 
                                        @if ($behalf_user->id === $loggedInUser) selected @endif>
                                        {{ $behalf_user->name }}
                                    </option>
                                @endforeach
                                </select>
...
<div class="modal fade" id="return" tabindex="-1" aria-labelledby="shareProjectTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('loanApproval.loan-return') }}" method="POST" enctype="multipart/form-data">
                @csrf
            <div class="modal-header">
                <div>
...
<div class="modal fade" id="reject" tabindex="-1" aria-labelledby="shareProjectTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('loanApproval.loan-reject') }}" method="POST" enctype="multipart/form-data">
                @csrf
            <div class="modal-header">
                <div>
