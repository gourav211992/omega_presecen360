            ...
            <div class="row">
                ...
                <div class="content-header-right text-sm-end col-md-6 mb-50 mb-sm-0">
                    <div class="form-group breadcrumb-right">
                        ...
                        <a href="updat-dpr.html" class="btn btn-success btn-sm mb-50 mb-sm-0"><i
                                            ...
                                            <div class="step-custhomapp bg-light mb-0">
                                                <ul class="nav nav-tabs mb-0 mt-25 custapploannav customrapplicationstatus"
                                                    ...
                                                    <li class="nav-item">
                                                        ...
                                                        <a class="nav-link" href="#Assessmentschdule">
                                                            Assessment
                                                        </a>
                                                    </li>
                                                    <li class="nav-item">
                                                                ...
                                                                <table
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><a href="#"><i data-feather="download"
                                                                                        class="me-50"></i></a>
                                ...
                                <div class="mt-3">
                                    ...
                                    <div class="tab-content pb-1 px-1">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="row align-items-center mb-1">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="demo-inline-spacing">
                                                                <div class="form-check form-check-primary mt-25">
                                                                    <input type="radio" id="Guarantor" name="Guarantor"
                                                                        class="form-check-input" checked="">
                                                                    <label class="form-check-label fw-bolder"
                                                                        for="Guarantor">Yes</label>
                                                                </div>
                                                                <div class="form-check form-check-primary mt-25">
                                                                    <input type="radio" id="applicant" name="Guarantor"
                                                                        class="form-check-input">
                                                                    <label class="form-check-label fw-bolder"
                                        ...
                                        <div class="tab-pane" id="Employer">
                                            ...
                                            <p class="mt-2  text-dark customapplsmallhead"><strong>Other Assets</strong>
                                            </p>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div
                                                                ...
                                                                <input type="checkbox" class="form-check-input"
                                                                    id="Cellular">
                                                                <label class="form-check-label" for="Cellular">Cellular
                                                                    Phone</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="row align-items-center mb-1">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="demo-inline-spacing">
                                                                <div class="form-check form-check-primary mt-25">
                                                                    <input type="radio" id="Single" name="Encumbered"
                                                                        class="form-check-input">
                                                                    <label class="form-check-label fw-bolder"
                                                                        for="Single">Yes</label>
                                                                </div>
                                                                <div class="form-check form-check-primary mt-25">
                                                                    <input type="radio" id="Married" name="Encumbered"
                                                                        class="form-check-input" checked="">
                                                                    <label class="form-check-label fw-bolder"
                                                                        for="Married">No</label>
                                                                </div>
                                        ...
                                        <div class="tab-pane" id="Guarantorapp">
                                                ...
                                                <div class="col-md-3 border-start">
                                                    ...
                                                    <div class="mt-2 text-center">
                                                        <div class="image-uploadhide">
                                                            <a href="attribute.html"
                                                                class="btn btn-outline-primary btn-sm waves-effect"> <i
                                                                    data-feather="upload"></i> Upload Profile Image</a>
                                                            <input type="file" class="">
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="row align-items-center mb-1">
                                                        <div class="col-md-3">
                                                            <label class="form-label">Name of the Person on whose behalf
                                            ...
                                            <p class="mt-2  text-dark customapplsmallhead"><strong>Particulars of Legal
                                                    Heirs</strong></p>
                                        ...
                                        <div class="tab-pane" id="Proposed">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="row align-items-center mb-1">
                                                        <div class="col-md-3">
                                                            <label class="form-label">Name of Bank/Institution and it's
                                                                Branch</label>
                                                        </div>
                                                    ...
                                                    <div class="row align-items-center mb-1">
                                                        <div class="col-md-3">
                                                            <label class="form-label">Purpose and amount of loan/credit
                                                                facilities</label>
                                                        </div>
                                                    ...
                                                    <div class="row align-items-center mb-1">
                                                        <div class="col-md-3">
                                                            <label class="form-label">Liabilities other than to Bank and
