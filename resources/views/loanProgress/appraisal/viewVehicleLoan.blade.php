                        ...
                        <div class="form-group breadcrumb-right">
                            ...
                            <button onClick="javascript: history.go(-1)" class="btn btn-secondary btn-sm mb-50 mb-sm-0"><i
                                data-feather="arrow-left-circle"></i> Back</button>
                                                            ...
                                                            @if ($buttons['return'])
                                                            <button class="btn btn-danger btn-sm mb-50 mb-sm-0" data-bs-target="#return"
                                                            data-bs-toggle="modal"><i data-feather="refresh-cw"></i> Return</button>
                                                            @endif

                                                            @if (isset($module) && $module == 'appraisal')
                                                            <a href="{{ route('loanAppraisal.create', $vehicleLoan->id) }}" class="btn btn-success btn-sm mb-50 mb-sm-0"><i
                                                        ...
                                                        @else
                                                            @if (!isset($view_detail))
                                                                <button class="btn btn-outline-primary btn-sm submission_val" data-val="draft" form="home-loan-createUpdate"><i data-feather="save"></i> Save as Draft</button>
                                                                <button data-bs-toggle="modal" data-bs-target="#disclaimer" data-val="submitted" class="btn btn-primary btn-sm submission_val" form="home-loan-createUpdate"><i
                                                                        data-feather="check-circle"></i> Proceed</button>
                                                            @endif
                                                        @endif
                                    ...
                                    <div class="card-body customernewsection-form">
                                        ...
                                        <div class="text-center new-applicayion-help-txt  mb-1 pb-25">
                                            ...
                                            <h6 class="mt-2">({{ $vehicleLoan->name ?? 'N/A' }} |
                                                {{ $loanAppraisal->term_loan ?? $vehicleLoan->loan_amount }} |
                                                {{ $loanAppraisal->update_at ?? $vehicleLoan->created_at ? $vehicleLoan->created_at->format('d-m-Y') : 'N/A' }})
                                            </h6>
                                        </div>

                                        @if (!empty($loanAppraisal))
                                                                                        ...
                                                                                        <table
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td>1</td>
                                                                                                    <td>Date</td>
                                                                                                    <td>{{ $loanAppraisal->updated_at ? $loanAppraisal->updated_at->format('d-m-Y') : 'N/A' }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>2</td>
                                                                                                    <td>Name of Unit</td>
                                                                                                    <td>{{ $loanAppraisal->unit_name ?? 'N/A' }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>3</td>
                                                                                                    ...
                                                                                                    <td>{{ $loanAppraisal->proprietor_name ?? 'N/A' }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>4</td>
                                                                                                    <td>Address</td>
                                                                                                    <td>{{ $loanAppraisal->address ?? 'N/A' }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>5</td>
                                                                                                    <td>CIBIL Score</td>
                                                                                                    <td>{{ $loanAppraisal->cibil_score ?? 'N/A' }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>6</td>
                                                                                                    <td>Project Cost</td>
                                                                                                    <td>{{ $loanAppraisal->project_cost ?? 'N/A' }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>7</td>
                                                                                                    <td>Term Loan</td>
                                                                                                    <td>{{ $loanAppraisal->term_loan ?? 'N/A' }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>8</td>
                                                                                                    <td>Promotor's
                                                                                                        Contribution</td>
                                                                                                    <td>{{ $loanAppraisal->promotor_contribution ?? 'N/A' }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>9</td>
                                                                                                    ...
                                                                                                    <td>{{ $loanAppraisal->interest_rate ?? 'N/A' }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>10</td>
                                                                                                    <td>Loan Period</td>
                                                                                                    <td>{{ $loanAppraisal->loan_period ?? 'N/A' }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>11</td>
                                                                                                    <td>Repayment Type</td>
                                                                                                    <td>{{ $loanAppraisal->repayment_type ?? 'N/A' }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>12</td>
                                                                                                    <td>No. of
                                                                                                        Installment(s)</td>
                                                                                                    <td>{{ $loanAppraisal->no_of_installments ?? 'N/A' }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>13</td>
                                                                                                    <td>Repayment Start
                                                                                                        After</td>
                                                                                                    <td>{{ $loanAppraisal->repayment_start_after ?? 'N/A' }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td>14</td>
                                                                                                    <td>Repayment Start
                                                                                                        Period</td>
                                                                                                    <td>{{ $loanAppraisal->repayment_start_period ?? 'N/A' }}
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
