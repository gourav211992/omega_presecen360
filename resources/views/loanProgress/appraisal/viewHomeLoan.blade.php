                    ...
                    <div class="content-header-right text-sm-end col-md-6 mb-50 mb-sm-0">
                        <div class="form-group breadcrumb-right">
                            ...
                            @if ($buttons['update_appraisal'])
                                <a href="{{ route('loanAppraisal.create', $homeLoan->id) }}"
                                    ...
                                    <div class="card-body customernewsection-form">
                                        ...
                                        <div class="text-center new-applicayion-help-txt  mb-1 pb-25">
                                            ...
                                            <h6 class="mt-2">({{ $homeLoan->name ?? 'N/A' }} |
                                                {{ $loanAppraisal->term_loan ?? $homeLoan->loan_amount }} |
                                                {{ $loanAppraisal->updated_at ?? $homeLoan->created_at ? $homeLoan->created_at->format('d-m-Y') : 'N/A' }})
                                            </h6>
                                        </div>
