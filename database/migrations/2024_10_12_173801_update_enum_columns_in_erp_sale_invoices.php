...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE `erp_sale_invoices` MODIFY COLUMN `document_type` ENUM('dn', 'si', 'sidn')");
    }
    ...
    {
        DB::statement("ALTER TABLE `erp_sale_invoices` MODIFY COLUMN `document_type` ENUM('din', 'si', 'sidn')");
        if (Schema::hasColumn('erp_sale_invoices', 'document_type')) {
            Schema::table('erp_sale_invoices', function (Blueprint $table) {
