...
return new class extends Migration
{
    public function up()
    {
        Schema::table('erp_loan_disbursements', function (Blueprint $table) {
            ...
            $table->date('document_date')->nullable()->after('disbursal_no');
            $table->enum('doc_number_type', ConstantHelper::DOC_NO_TYPES)->default(ConstantHelper::DOC_NO_TYPE_MANUAL)->after('disbursal_no');
