...
return new class extends Migration
{
    ...
    {
        Schema::create('erp_pb_headers', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('erp_pb_details', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('erp_pb_item_attributes', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('header_id')->nullable();
        ...
        Schema::create('erp_pb_ted', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('header_id')->nullable();
            $table->unsignedBigInteger('detail_id')->nullable();
    ...
    {
        Schema::dropIfExists('erp_pb_ted');
        Schema::dropIfExists('erp_pb_item_attributes');
        Schema::dropIfExists('erp_pb_details');
        Schema::dropIfExists('erp_pb_headers');
    }
};
