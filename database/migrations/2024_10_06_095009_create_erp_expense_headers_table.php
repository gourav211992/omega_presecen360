...
return new class extends Migration
{
    ...
    {
        Schema::create('erp_expense_headers', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('erp_expense_details', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('erp_expense_item_attributes', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('expense_header_id')->nullable();
        ...
        Schema::create('erp_expense_ted', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('expense_header_id')->nullable();
            $table->unsignedBigInteger('expense_detail_id')->nullable();
    ...
    {
        Schema::dropIfExists('erp_expense_ted');
        Schema::dropIfExists('erp_expense_item_attributes');
        Schema::dropIfExists('erp_expense_details');
        Schema::dropIfExists('erp_expense_headers');
    }
};
