...
return new class extends Migration
{
    ...
    {
        Schema::create('erp_loan_guarantor_co_applicant_insurance_policies', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('erp_loan_guarantor_co_applicant_insurance_policies');
    }
};
