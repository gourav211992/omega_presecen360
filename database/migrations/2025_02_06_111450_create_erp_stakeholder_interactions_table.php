...
return new class extends Migration
{
    ...
    {
        Schema::create('erp_stakeholder_interactions', function (Blueprint $table) {
            $table->id();
...
//            $table->unsignedBigInteger('user_id');
            ...
            $table->foreign('user_type_id')->references('id')->on('erp_stakeholder_user_types')->onDelete('cascade');
//            $table->foreign('user_id')->references('id')->on('users')->onDelete('cascade');
            $table->foreign('interaction_type_id')->references('id')->on('erp_interaction_types')->onDelete('cascade');
            $table->timestamps();
            $table->softDeletes();
        });
    }
    ...
    {
        Schema::dropIfExists('erp_stakeholder_interactions');
    }
};
