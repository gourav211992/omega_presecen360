...
return new class extends Migration
{
    ...
    {
        Schema::create('erp_expense_media', function (Blueprint $table) {
            $table->id();
        ...
        if (Schema::hasColumn('erp_expense_header_histories', 'attachment')) {
    ...
    {
        Schema::dropIfExists('erp_expense_media');
        if (!Schema::hasColumn('erp_expense_headers', 'attachment')) {
            Schema::table('erp_expense_headers', function (Blueprint $table) {
