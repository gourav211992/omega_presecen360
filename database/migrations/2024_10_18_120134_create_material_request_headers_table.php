...
return new class extends Migration
{
    ...
    {
        Schema::create('erp_mr_headers', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('erp_mr_details', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('erp_mr_ted', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('header_id')->nullable();
            $table->unsignedBigInteger('detail_id')->nullable();
    ...
    {
        Schema::dropIfExists('erp_mr_ted');
        Schema::dropIfExists('erp_mr_item_attributes');
        Schema::dropIfExists('erp_mr_details');
        Schema::dropIfExists('erp_mr_headers');
    }
};
