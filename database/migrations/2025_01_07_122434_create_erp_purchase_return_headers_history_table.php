...
return new class extends Migration
{
    ...
    {
        Schema::create('erp_purchase_return_headers_history', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('erp_purchase_return_details_history', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('header_id')->nullable();
        ...
        Schema::create('erp_purchase_return_item_attributes_history', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('header_id')->nullable();
            $table->unsignedBigInteger('header_history_id')->nullable();
            $table->unsignedBigInteger('detail_id')->nullable();
        ...
        Schema::create('erp_purchase_return_ted_history', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('header_id')->nullable();
            $table->unsignedBigInteger('header_history_id')->nullable();
            $table->unsignedBigInteger('detail_id')->nullable();
            $table->unsignedBigInteger('detail_history_id')->nullable();
            $table->unsignedBigInteger('pr_ted_id')->nullable();
    ...
    {
        Schema::dropIfExists('erp_purchase_return_ted_history');
        Schema::dropIfExists('erp_purchase_return_item_attributes_history');
        Schema::dropIfExists('erp_purchase_return_details_history');
        Schema::dropIfExists('erp_purchase_return_headers_history');
    }
};
