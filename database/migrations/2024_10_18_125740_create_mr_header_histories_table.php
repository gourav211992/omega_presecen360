...
return new class extends Migration
{
    ...
    {
        Schema::create('erp_mr_header_histories', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('erp_mr_detail_histories', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('header_id')->nullable();
        ...
        Schema::create('erp_mr_item_attribute_histories', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('header_id')->nullable();
            $table->unsignedBigInteger('header_history_id')->nullable();
            $table->unsignedBigInteger('detail_id')->nullable();
        ...
        Schema::create('erp_mr_ted_histories', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('header_id')->nullable();
            $table->unsignedBigInteger('header_history_id')->nullable();
            $table->unsignedBigInteger('detail_id')->nullable();
    ...
    {
        Schema::dropIfExists('erp_mr_ted_histories');
        Schema::dropIfExists('erp_mr_item_attribute_histories');
        Schema::dropIfExists('erp_mr_detail_histories');
        Schema::dropIfExists('erp_mr_header_histories');
    }
};
