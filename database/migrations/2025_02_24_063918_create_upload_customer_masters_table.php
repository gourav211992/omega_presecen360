...
class CreateUploadCustomerMastersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('upload_customer_masters', function (Blueprint $table) {
            $table->id(); 
            ...
            $table->string('customer_code_type')->nullable();  
    ...
    {
        Schema::dropIfExists('upload_customer_masters');
    }
}
