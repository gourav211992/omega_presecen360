...
return new class extends Migration
{
    ...
    {
        Schema::create('erp_mi_headers', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('erp_mi_details', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('erp_mi_ted', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('header_id')->nullable();
            $table->unsignedBigInteger('detail_id')->nullable();
    ...
    {
        Schema::dropIfExists('erp_mi_ted');
        Schema::dropIfExists('erp_mi_item_attributes');
        Schema::dropIfExists('erp_mi_details');
        Schema::dropIfExists('erp_mi_headers');
    }
};
