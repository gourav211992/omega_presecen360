...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('erp_mr_items', function (Blueprint $table) {
            ...
            // Foreign key
            $table->foreign('material_return_id')->references('id')->on('erp_material_return_header')->onDelete('cascade');
        ...
        Schema::create('erp_mr_item_attributes', function (Blueprint $table) {
            ...
            // Foreign keys
            $table->foreign('mr_item_id')->references('id')->on('erp_mr_items')->onDelete('cascade');
            $table->foreign('material_return_id')->references('id')->on('erp_material_return_header')->onDelete('cascade');
        ...
        // Schema::create('erp_material_return_ted', function (Blueprint $table) {
        //     $table->id();
        ...
        Schema::create('erp_material_return_header_history', function (Blueprint $table) {
            ...
            $table->string('doc_prefix', 20)->nullable();
            $table->string('doc_suffix', 20)->nullable();
            $table->integer('doc_no')->nullable();
            ...
            $table->string('department_code',100)->nullable()->index();
        
            $table->unsignedBigInteger('from_store_id')->index();
            $table->string('from_store_code', 50)->nullable();
            ...
            $table->unsignedTinyInteger('approval_level')->default(1)->comment('current approval level');
        ...
        Schema::create('erp_mr_items_history', function (Blueprint $table) {
            ...
            $table->decimal('qty', 20, 6)->default(0.00);
        
            $table->unsignedBigInteger('inventory_uom_id')->nullable();
            $table->string('inventory_uom_code', 20)->nullable();
            $table->decimal('inventory_uom_qty', 15, 2)->default(0.00);
        
            $table->decimal('rate', 20, 6)->default(0.00);
            $table->decimal('item_discount_amount', 15, 2)->default(0.00);
            $table->decimal('header_discount_amount', 15, 2)->default(0.00);
            $table->decimal('tax_amount', 15, 2)->default(0.00);
            $table->decimal('item_expense_amount', 15, 2)->default(0.00);
            ...
            $table->foreign('material_return_id')->references('id')->on('erp_material_return_header_history')->onDelete('cascade');
        ...
        Schema::create('erp_mr_item_attributes_history', function (Blueprint $table) {
            ...
            $table->foreign('mr_item_id')->references('id')->on('erp_mr_items_history')->onDelete('cascade');
            $table->foreign('material_return_id')->references('id')->on('erp_material_return_header_history')->onDelete('cascade');
        ...
        Schema::create('erp_mr_item_locations_history', function (Blueprint $table) {
            ...
            $table->double('qty', 20, 6)->default(0.00);
        ...
        // Schema::create('erp_material_return_ted_history', function (Blueprint $table) {
        //     $table->id();
    ...
    public function down(): void
    {
        ...
        // Schema::dropIfExists('erp_material_return_ted');
        // Schema::dropIfExists('erp_material_return_ted_history');
