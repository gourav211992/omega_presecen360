...
<form class="ajax-input-form" method="POST" action="<?php echo e(route('logistics.freight-charges.store')); ?>" data-redirect="<?php echo e(url('/logistics/freight-charges')); ?>">
    <?php echo csrf_field(); ?>
    <!-- BEGIN: Content-->
                                            ...
                                            <div class="table-responsive-md">
                                                <table class="table myrequesttablecbox table-striped po-order-detail custnewpo-detail border newdesignerptable newdesignpomrnpad"> 
                                                   ...
                                                   <tbody class="mrntableselectexcel" id="freight-charges-table tbody tr">
                                                      <?php $rowIndex = count($freightCharges);  ?>
                                                        <?php $__currentLoopData = $freightCharges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $charges): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td>
                                                                    <div class="form-check form-check-primary custom-checkbox">
                                                                        <input type="checkbox" class="form-check-input row-checkbox" name="row_checkbox[]" value="<?php echo e($rowIndex); ?>">
                                                                        <label class="form-check-label"></label>
                                                                    </div>

                                                                </td>
                                                                <td>
                                                                    <input type="hidden" name="freight_charges[<?php echo e($rowIndex); ?>][id]" value="<?php echo e($charges->id ?? ''); ?>">
                                                                   <input type="text"
                                                                    name="freight_charges[<?php echo e($rowIndex); ?>][source_route_name]"
                                                                    class="form-control mw-100 route-master-autocomplete"
                                                                    placeholder="Search locations"
                                                                    data-type="source"
                                                                    value="<?php echo e(optional($charges->sourceRoute)->name ?? ''); ?>" />

                                                                <input type="hidden"
                                                                    name="freight_charges[<?php echo e($rowIndex); ?>][source_route_id]"
                                                                    class="route-master-id"
                                                                    data-type="source"
                                                                    value="<?php echo e($charges->source_route_id ?? ''); ?>" />
                                                                 </td>
                                                               
                                                                <td>
                                                                <!-- Destination State Autocomplete -->
                                                                    <input type="text"
                                                                        name="freight_charges[<?php echo e($rowIndex); ?>][destination_route_name]"
                                                                        class="form-control mw-100 route-master-autocomplete"
                                                                        placeholder="Search locations"
                                                                        data-type="destination"
                                                                        value="<?php echo e(optional($charges->destinationRoute)->name ?? ''); ?>" />

                                                                    <input type="hidden"
                                                                        name="freight_charges[<?php echo e($rowIndex); ?>][destination_route_id]"
                                                                        class="route-master-id"
                                                                        data-type="destination"
                                                                        value="<?php echo e($charges->destination_route_id ?? ''); ?>" />

                                                               </td>
                                                               
                                                                <td>
                                                                    <input type="text" name="freight_charges[<?php echo e($rowIndex); ?>][distance]" class="form-control mw-100" value="<?php echo e($charges->distance ?? 0); ?>">
                                                                </td>
                                                                <td>
                                                                    <input type="text" 
                                                                        name="freight_charges[<?php echo e($rowIndex); ?>][vehicle_type_name]" 
                                                                        class="form-control mw-100 vehicle-type-autocomplete" 
                                                                        placeholder="Start typing vehicle type..." 
                                                                        value="<?php echo e(optional($charges->vehicleType)->name ?? ''); ?> (<?php echo e(optional($charges->vehicleType)->capacity ?? ''); ?> <?php echo e(optional($charges->vehicleType->unit)->name ?? ''); ?>)">

                                                                    <input type="hidden" 
                                                                        name="freight_charges[<?php echo e($rowIndex); ?>][vehicle_type_id]" 
                                                                        class="vehicle-type-id" 
                                                                        value="<?php echo e($charges->vehicle_type_id); ?>">

                                                                </td>
                                                                <td>
                                                                    <input type="text" name="freight_charges[<?php echo e($rowIndex); ?>][no_bundle]" class="form-control mw-100" value="<?php echo e($charges->no_bundle ?? 0); ?>">
                                                                </td>
                                                                <td>
                                                                    <input type="text" name="freight_charges[<?php echo e($rowIndex); ?>][amount]" class="form-control mw-100" value="<?php echo e($charges->amount ?? 0); ?>">
                                                                </td>
                                                                 <td>
                                                                    <input type="text" name="freight_charges[<?php echo e($rowIndex); ?>][per_bundle]" class="form-control mw-100" value="<?php echo e($charges->per_bundle ?? 0); ?>">
                                                                </td>
                                                                <td>
                                                                   <input type="text"
                                                                    name="freight_charges[<?php echo e($rowIndex); ?>][customer_name]"
                                                                    class="form-control mw-100 customer-autocomplete"
                                                                    placeholder="Start typing customer..."
                                                                    value="<?php echo e(optional($charges->customer)->company_name ?? ''); ?>" />

                                                                <input type="hidden"
                                                                    name="freight_charges[<?php echo e($rowIndex); ?>][customer_id]"
                                                                    class="customer-id"
                                                                    value="<?php echo e($charges->customer_id ?? ''); ?>" />

                                                              </td>
                                                            </tr>
                                                       <?php $rowIndex++; ?>
                                                       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                       <?php if($freightCharges->isEmpty()): ?>
                                                           <tr>
                                                                <td>
                                                                    <div class="form-check form-check-primary custom-checkbox">
...
<script>
    let freightRowIndex = <?php echo e($rowIndex); ?>;
...
<script>
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            if (idsToDelete.length > 0) {
                fetch("<?php echo e(route('logistics.freight-charges.delete-multiple')); ?>", {
                    method: "DELETE",
                    headers: {
 ...
 const vehicleTypes = [
    <?php if($vehicleTypes->isNotEmpty()): ?>
        <?php $__currentLoopData = $vehicleTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            {
                label: "<?php echo e($vt->name); ?> (<?php echo e($vt->capacity); ?> <?php echo e($vt->unit->name ?? ''); ?>)",
                value: "<?php echo e($vt->name); ?> (<?php echo e($vt->capacity); ?> <?php echo e($vt->unit->name ?? ''); ?>)",
                id: <?php echo e($vt->id); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/omega_presecen360/resources/views/logistics/freight-charges/index.blade.php ENDPATH**/ ?>