    ...
    <script src="<?php echo e(url('/app-assets/vendors/js/tables/datatable/dataTables.responsive.min.js')); ?>"></script>
    <script src="<?php echo e(url('/app-assets/vendors/js/tables/datatable/responsive.bootstrap5.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(url('/app-assets/vendors/js/tables/datatable/jszip.min.js')); ?>"></script>
    <script src="<?php echo e(url('/app-assets/vendors/js/tables/datatable/pdfmake.min.js')); ?>"></script>
    <script src="<?php echo e(url('/app-assets/vendors/js/tables/datatable/vfs_fonts.js')); ?>"></script>
    ...
    <script src="<?php echo e(url('/app-assets/vendors/js/tables/datatable/dataTables.rowGroup.min.js')); ?>"></script>
    <script src="<?php echo e(url('/app-assets/vendors/js/pickers/flatpickr/flatpickr.min.js')); ?>"></script>
    <script src="<?php echo e(url('/app-assets/vendors/js/editors/quill/katex.min.js')); ?>"></script>
    <script src="<?php echo e(url('/app-assets/vendors/js/editors/quill/highlight.min.js')); ?>"></script>
    <script src="<?php echo e(url('/app-assets/vendors/js/editors/quill/quill.min.js')); ?>"></script>
    <script src="<?php echo e(asset('app-assets/js/moment.js')); ?>"></script>
    <!-- END: Page Vendor JS-->
    ...
    <script src="<?php echo e(url('/app-assets/js/ajax-script.js')); ?>"></script>
    <script src="<?php echo e(url('/app-assets/js/vendor-customer-script.js')); ?>"></script>
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?php echo e(url('/app-assets/js/scripts/forms/form-quill-editor.js')); ?>"></script>

    <script src="<?php echo e(url('/app-assets/js/scripts/pages/app-email.js')); ?>"></script>
    <!-- END: Page JS-->


    <script src="<?php echo e(url('/app-assets/js/scripts/forms/pickers/form-pickers.js')); ?>"></script>
    ...
    <script src="<?php echo e(url('/app-assets/js/common-script.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('app-assets/summernote/summernote-lite.min.js')); ?>"></script>
...
<?php /**PATH /var/www/html/omega_presecen360/resources/views/layouts/partials/js.blade.php ENDPATH**/ ?>