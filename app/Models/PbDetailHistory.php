...
class PbDetailHistory extends Model
{
    ...
    public function item_attributes_array()
    {
        ...
        foreach ($itemAttributes as $attribute) {
            $existingAttribute = PbItemAttributeHistory::where('detail_history_id', $this -> getAttribute('id')) -> where('item_attribute_id', $attribute -> id) -> first();
            ...
            foreach ($attribute_ids as $attributeValue) {
                    ...
                    {
                        $isSelected = PbItemAttributeHistory::where('detail_history_id', $this -> getAttribute('id')) -> where('item_attribute_id', $attribute -> id) -> where('attr_value', $attributeValueData -> id) -> first();
