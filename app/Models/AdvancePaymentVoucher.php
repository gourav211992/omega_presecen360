...
class AdvancePaymentVoucher extends Model
{
...
protected static function booted()
{
    ...
    protected $table = 'erp_advance_payment_vouchers';
    ...
    {
        return $this->hasMany(AdvancePaymentVoucherDetails::class,'payment_voucher_id');
    }
    ...
    {
        return $this->hasMany(AdvanceVoucherReference::class,'payment_voucher_id');
    }
}
