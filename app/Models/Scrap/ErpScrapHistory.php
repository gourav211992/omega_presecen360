...
class ErpScrapHistory extends Model
{
    ...
    {
        return $this->hasMany(ErpScrapItemHistory::class, 'erp_scrap_id');
    }
    ...
    public function pslipItems()
    {
        return $this->belongsToMany(
            ErpPslipItem::class,
            'erp_scrap_pslip_item_mappings_history',
            'erp_scrap_id',
            'erp_pslip_item_id',
            'id',
            'id'
    ...
    {
        return $this->hasMany(ErpScrapDynamicFieldHistory::class, 'header_id');
    }
