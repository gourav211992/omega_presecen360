...
class ErpScrapItemAttributeHistory extends Model
{
    use HasFactory, SoftDeletes, DateFormatTrait;

    protected $table = 'erp_scrap_item_attributes_history';
    ...
    {
        return $this->belongsTo(ErpScrapHistory::class);
    }

    public function header()
    {
        return $this->belongsTo(ErpScrapItemHistory::class, 'scrap_item_id');
    }
