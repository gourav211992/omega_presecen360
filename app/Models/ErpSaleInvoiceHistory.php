...
class ErpSaleInvoiceHistory extends Model
{
    use HasFactory, SoftDeletes, DefaultGroupCompanyOrg, FileUploadTrait, DateFormatTrait;

    protected $table = 'erp_sale_invoices_history';
    ...
    {
        return $this -> hasMany(ErpSaleInvoiceTedHistory::class, 'sale_invoice_id') -> where('ted_level', 'H') -> where('ted_type', 'Discount');
    }
    ...
    {
        return $this -> hasMany(ErpInvoiceItemLocationHistory::class, 'sale_invoice_id');
    }
