...
class AdvanceVoucherReference extends Model
{
    use HasFactory;
    protected $table = 'erp_advance_voucher_references';
    ...
    {
        return $this->belongsTo(AdvancePaymentVoucherDetails::class,'voucher_details_id');
    }
