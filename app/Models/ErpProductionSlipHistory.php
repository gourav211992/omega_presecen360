...
class ErpProductionSlipHistory extends Model
{
    protected $table="erp_production_slips_history";
    ...
    {
        return $this -> hasMany(ErpPslipItemHistory::class, 'pslip_id');
    }
    ...
    {
        return $this -> hasMany(PslipBomConsumptionHistory::class, 'pslip_id');
    }
