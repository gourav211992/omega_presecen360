...
class ErpRateContractItem extends Model
{
    use HasFactory;
        ...
        foreach ($itemAttributes as $attribute) {
            ...
            foreach ($attributeIds as $attributeValueId) {
                ...
                if ($attributeValueData) {
                    $group = ErpAttributeGroup::select('id', 'name','short_name')->find($attributeValueData->attribute_group_id);
                    ...
                    $attributeValueData->short_name = $group?->short_name;
            ...
            if (!empty($valuesData)) {
                $processedData[] = [
                    ...
                    'short_name' => $attribute->group?->short_name ?? '',
