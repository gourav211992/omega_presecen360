...
class ErpPslipItemLocationHistory extends Model
{
    use HasFactory;


    protected $table = 'erp_pslip_item_locations_history';
    ...
    {
        return $this -> belongsTo(ErpProductionSlipHistory::class, 'psip_id');
    }

    public function detail()
    {
        return $this -> belongsTo(ErpPslipItemHistory::class, 'pslip_item_id');
    }
