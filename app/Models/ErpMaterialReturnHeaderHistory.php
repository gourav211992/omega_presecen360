...
class ErpMaterialReturnHeaderHistory extends Model
{
    use HasFactory, SoftDeletes, DefaultGroupCompanyOrg, FileUploadTrait, DateFormatTrait;

    protected $table = "erp_material_return_header_history";
    ...
    {
        return $this -> hasMany(ErpMrItemHistory::class, 'material_return_id');
    }
