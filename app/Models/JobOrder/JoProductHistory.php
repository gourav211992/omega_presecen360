...
class JoProductHistory extends Model
{
    use HasFactory, DateFormatTrait, UserStampTrait, SoftDeletes;
    protected $table = 'erp_jo_products_history';
    protected $fillable = [
        'jo_id',
        'pwo_so_mapping_id',
        'so_id',
    ...
    {
        return $this->hasMany(JoProductAttributeHistory::class,'jo_product_id')->with(['headerAttribute', 'headerAttributeValue']);
    }

    public function teds()
    {
        return $this->hasMany(JobOrderTedHistory::class,'jo_product_id');
    }

    public function ted_tax()
    {
        return $this->hasOne(JobOrderTedHistory::class,'jo_product_id')->where('ted_type','Tax')->latest();
    }
    ...
    {
        return $this->hasMany(JoProductDeliveryHistory::class,'jo_product_id');
    }

    /*Detail level*/
    public function itemDiscount()
    {
        return $this->hasMany(JobOrderTedHistory::class,'jo_product_id')->where('ted_level', 'D')->where('ted_type','Discount');
    }
    ...
    {
        return $this->hasMany(JobOrderTedHistory::class)->where('ted_level', 'H')->where('ted_type','Discount');
    }

    public function taxes()
    {
        return $this->hasMany(JobOrderTedHistory::class,'jo_product_id')->where('ted_type','Tax');
    }

    public function getCgstValueAttribute()
    {
        $tedRecords = JobOrderTedHistory::where('jo_product_id', $this->id)
        ...
        $tedRecord = JobOrderTedHistory::with(['taxDetail'])
    ...
    public function item_attributes_array()
    {
        ...
        $processedData = [];
        $mappingAttributes = JoProductAttributeHistory::where('jo_product_id', $this->getAttribute('id'))
