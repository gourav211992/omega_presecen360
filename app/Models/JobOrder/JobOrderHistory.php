...
{
    use HasFactory, DateFormatTrait, DynamicFieldsTrait, FileUploadTrait, DefaultGroupCompanyOrg, SoftDeletes, UserStampTrait;

    protected $table = 'erp_job_orders_history';
    ...
    {
        return $this->hasMany(JoProductHistory::class, 'jo_id');
    }
    ...
    {
        return $this->hasMany(JoItemHistory::class, 'jo_id');
    }
    public function terms()
    {
        return $this->hasMany(JoTermHistory::class, 'jo_id');
    }
    public function jo_items_delivery()
    {
        return $this->hasMany(JoProductDeliveryHistory::class, 'jo_id');
    }
    public function jo_ted()
    {
        return $this->hasMany(JobOrderTedHistory::class, 'jo_id');
    }
    public function jo_ted_tax()
    {
        return $this->hasMany(JobOrderTedHistory::class, 'jo_id')->where('ted_type', 'Tax');
    }
    ...
    {
        return $this->belongsTo(JoTermHistory::class, 'jo_id');
    }
    ...
    {
        return $this->hasOne(JoTermHistory::class, 'jo_id');
    }
    ...
    {
        return $this->hasMany(JobOrderTedHistory::class, 'jo_id')->where('ted_level', 'H')->where('ted_type', 'Discount');
    }
    ...
    {
        return $this->hasMany(JobOrderTedHistory::class, 'jo_id')->where('ted_level', 'D')->where('ted_type', 'Discount');
    }
    ...
    {
        return $this->hasMany(JobOrderTedHistory::class, 'jo_id')->where('ted_type', 'Expense')->where('ted_level', 'H');
    }
