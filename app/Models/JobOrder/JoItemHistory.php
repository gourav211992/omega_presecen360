...
class JoItemHistory extends Model
{
    use HasFactory, DateFormatTrait, UserStampTrait, SoftDeletes;
    protected $table = 'erp_jo_items_history';
    protected $fillable = [
        'jo_id',
        'source_id',
        'so_id',
    ...
    {
        return $this->hasMany(JoItemAttributeHistory::class, 'jo_item_id')->with(['headerAttribute', 'headerAttributeValue']);
    }
    public function item_attributes_array()
    {
        ...
        $processedData = [];
        $mappingAttributes = JoItemAttributeHistory::where('jo_item_id', $this->getAttribute('id'))
