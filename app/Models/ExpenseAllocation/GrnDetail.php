...
class GrnDetail extends Model
{
    ...
    protected $table = 'erp_exp_alc_grn_details';
    protected $fillable = [
        'header_id',
        'grn_header_id',
        'grn_detail_id',
    ...
    {
        return $this->hasOne(GrnDetailHistory::class, 'source_id');
    }

    public function mrnHeader()
    {
        return $this->belongsTo(MrnHeader::class, 'grn_header_id');
    }

    public function mrnDetail()
    {
        return $this->belongsTo(MrnDetail::class, 'grn_detail_id');
    }
    ...
    {
        return $this->hasMany(GrnAttribute::class, 'detail_id');
    }

    public function allocations()
    {
        return $this->hasMany(Allocation::class, 'grn_detail_id');
    }
    ...
    public function item_attributes_array()
    {
        ...
        $processedData = [];
        $mappingAttributes = GrnAttribute::where('detail_id', $this->getAttribute('id'))
