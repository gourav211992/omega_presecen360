...
class PoDetail extends Model
{
    ...
    protected $table = 'erp_exp_alc_po_details';
    protected $fillable = [
        'header_id',
        'po_header_id',
        'po_detail_id',
    ...
    {
        return $this->hasOne(PoDetailHistory::class, 'source_id');
    }
    ...
    {
        return $this->hasMany(Allocation::class, 'po_detail_id');
    }

    public function attributes()
    {
        return $this->hasMany(PoAttribute::class, 'detail_id');
    }
    ...
    public function item_attributes_array()
    {
        ...
        $processedData = [];
        $mappingAttributes = PoAttribute::where('detail_id', $this->getAttribute('id'))
