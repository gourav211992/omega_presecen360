...
class ErpRfqItemHistory extends Model
{
    ...
    public function item_attributes_array()
    {
        ...
        foreach ($rfqItemAttributes as $attribute) {
            $existingAttribute = ErpRfqItemAttributeHistory::where('rfq_item_id', $rfqItemId)
            ...
            foreach ($attribute_ids as $attributeValue) {
                ...
                if (isset($attributeValueData)) {
                    $isSelected = ErpRfqItemAttributeHistory::where('rfq_item_id', $rfqItemId)
                        ->where('item_attribute_id', $attribute->id)
    ...
    public function get_attributes_array()
    {
        ...
        $rfqItemAttributes = ErpRfqItemAttributeHistory::where('rfq_item_id', $rfqItemId)->get();
    ...
    {
        return $this -> belongsTo(ErpRfqHeaderHistory::class, 'rfq_header_id');
    }
    ...
    {
        return $this -> hasMany(ErpRfqItemAttributeHistory::class, 'rfq_item_id');
    }
}
