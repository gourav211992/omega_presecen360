...
class LoanReport extends Mailable
{
   ...
   *
   * @param LoanReportScheduler $scheduler
   * @param Carbon $startDate
   * @param Carbon $endDate
   */
  public function __construct(LoanReportScheduler $scheduler, Carbon $startDate, Carbon $endDate)
  {
  ...
  public function build()
  {
      ...
      try {
        ...
        $excelData = Excel::raw(new LoanReportExport(Carbon::parse($this->startDate), Carbon::parse($this->endDate)), \Maatwebsite\Excel\Excel::XLSX);
        ...
        return $this->view('emails.loan_report')
