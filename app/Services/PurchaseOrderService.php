...
class PurchaseOrderService
{
    public function createPurchaseOrder(PurchaseOrderRequest $request)
    {
        try {
            ...
            $purchaseOrder = PurchaseOrder::create([
                ...
                'payment_terms_id' => $validatedData['payment_terms_id'],
            ...
            if ($purchaseOrder->id) {
                $this->saveItems($purchaseOrder->id, $calculatedData['items_calculated_data']);
            }
    ...
    public function updatePurchaseOrder($id, PurchaseOrderRequest $request)
    {
        try {
    ...
    private function saveItems(int $purchaseOrderId, array $items)
    {
