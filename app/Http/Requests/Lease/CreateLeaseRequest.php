...
class CreateLeaseRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        if ($this->status == 'submitted') {
            ...
            // 'plot_details.*.land_other_charges' => 'required',
            // 'plot_details.*.plot_valuation' => 'required',
            // 'other_charges.*.*.land_parcel_id' => 'required',
            //     'other_charges.*.*.land_plot_id' => 'required',
            //     'other_charges.*.*.percentage' => 'nullable',
            //     'other_charges.*.*.value' => 'nullable',
    ...
    //         dd('test form', [
    //             'current_errorsf' => $validator->errors()->toArray(),
