...
class ItemRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'length_in_feet'  => ['nullable', 'numeric', 'gte:0', 'regex:/^\d{1,11}(\.\d{1,4})?$/'],
            'breadth_in_feet' => ['nullable', 'numeric', 'gte:0', 'regex:/^\d{1,11}(\.\d{1,4})?$/'],
            'height_in_feet'  => ['nullable', 'numeric', 'gte:0', 'regex:/^\d{1,11}(\.\d{1,4})?$/'],
            ...
            'mrp'        => 'nullable|regex:/^[0-9,]*(\.[0-9]{1,2})?$/|min:0',
           ...
           // Packaging Fields
            ...
            'packaging.*.id' => 'nullable',
            'packaging.*.pack_no' => 'nullable|integer|min:1',
            'packaging.*.pack_name' => 'nullable|string|max:255',
            'packaging.*.pack_length' => 'nullable|numeric|min:0',
            'packaging.*.pack_breadth' => 'nullable|numeric|min:0',
            'packaging.*.pack_height' => 'nullable|numeric|min:0',
            'packaging.*.pack_weight' => 'nullable|numeric|min:0',
            'packaging.*.pack_volume' => 'nullable|numeric|min:0',
    ...
    public function messages(): array
    {
        return [
            ...
            'length_in_feet.numeric' => 'Length (feet) must be a valid number.',
            'length_in_feet.gte'     => 'Length (feet) must be 0 or greater.',
            'length_in_feet.regex'   => 'Length (feet) must have up to 11 digits before decimal and up to 4 digits after decimal.',
            'breadth_in_feet.numeric' => 'Breadth (feet) must be a valid number.',
            'breadth_in_feet.gte'     => 'Breadth (feet) must be 0 or greater.',
            'breadth_in_feet.regex'   => 'Breadth (feet) must have up to 11 digits before decimal and up to 4 digits after decimal.',
            'height_in_feet.numeric' => 'Height (feet) must be a valid number.',
            'height_in_feet.gte'     => 'Height (feet) must be 0 or greater.',
            'height_in_feet.regex'   => 'Height (feet) must have up to 11 digits before decimal and up to 4 digits after decimal.',
            ...
            'safety_days.min' => 'The safety days must be at least 1.',
