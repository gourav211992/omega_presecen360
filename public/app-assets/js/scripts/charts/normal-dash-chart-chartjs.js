...
$(window).on('load', function () {
  ...
  if (leavebarChartEx.length) {
    var leavebarChartExample = new Chart(leavebarChartEx, {
      ...
      data: {
        labels: ['Total Loan', 'Disbursement', 'Recovery', 'Settlement'],
        datasets: [
          {
            data: [50, 30, 20, 5],
            barThickness: 25,
            backgroundColor: ['#7367F0', '#FF9F43', '#EA5455', '#28dac6'],
...
if (assignedtaskChartEx.length) {
    var assignedChartExample = new Chart(assignedtaskChartEx, {
      ...
      data: {
        labels: ['Assigned to me', 'Assigned by me',],
        datasets: [
          {
            data: [12, 15],
            barThickness: 50, 
            backgroundColor: [ '#DC1B54', '#6B12B7'],
            borderColor: 'transparent', 
          }
        ]
      }
  ...
  if (barChartEx.length) {
    var barChartExample = new Chart(barChartEx, {
      ...
      data: {
        labels: ['On Duty', 'WFO', 'WFH', 'Regular', 'CO', 'OT'],
        datasets: [
          {
            data: [12, 15, 5, 12, 15, 5],
            barThickness: 35,
  ...
  if (horizontalBarChartEx.length) {
    new Chart(horizontalBarChartEx, {
      ...
      data: {
        labels: ['Regular', 'WFH', 'WFO ', 'On Duty', 'OT', 'CO', 'Regular'],
        datasets: [
          {
