...
$(function () {
  ...
  // Check if leadLabels, leadCounts, or leadColors are empty
  var donutChartElroletaskapp = document.querySelector('#donut-apptask'),
    donutChartConfigroletaskapp = {
      ...
      labels: ['Test'],  // Use the status titles for labels
      series: 300,  // Use the status count for series
      colors: ['#fff'],
      dataLabels: {
        enabled: true,
        formatter: function (val, opt) {
          ...
          donut: {
            labels: {
              ...
              total: {
                ...
                label: 'Total Leads',
                formatter: function () {
                  return totalDiariesStatusCount;
                }
              }
            }
          }
  ...
  if (typeof ApexCharts !== 'undefined' && donutChartElroletaskapp) {
