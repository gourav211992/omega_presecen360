(function (window, document, jQuery) {
  ...
  var basicToast1 = document.querySelector('.basic-toast1');
  var basicToastBtn1 = document.querySelector('.toast-basic-toggler1');
  var showBasicToast1 = new bootstrap.Toast(basicToast1);

  basicToastBtn1.addEventListener('click', function () {
    showBasicToast1.show();
  });
