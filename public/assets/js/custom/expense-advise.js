// /*=========================================================================================
//     File Name: expense-advise.js
//     Description: Expense Advise report page content with filter
//     ----------------------------------------------------------------------------------------
...
function updateTable(ge_reports = [], columnVisibility = []) {
    ...
    const tableHeaders = [
        `<th>S No</th>`, // Index
        `<th>Series</th>`, // Series
        `<th>Expense Advise No</th>`, // Expense Advise No
        `<th>Expense Advise Date</th>`, // Expense Advise Date
        `<th>PO No</th>`, // PO No
        `<th>SO No</th>`, // SO No
        `<th>Vendor</th>`, // Vendor
    ...
    ge_reports.forEach((report) => {
        report.items.forEach((ge_item) => {
            ...
            const cells = [
                ...
                `<td class="fw-bolder text-dark">${report.document_number}</td>`, // Expense Advise No
                `<td>${formatDate(report.document_date)}</td>`, // Expense Advise Date
                ...
                `<td class="no-wrap">
                    ...
                    <a href="/expense-advice/edit/${report?.id}">
